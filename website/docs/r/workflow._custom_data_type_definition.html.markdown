---
layout: "intersight"
page_title: "Intersight: intersight_workflow._custom_data_type_definition"
sidebar_current: "docs-intersight-resource-workflow.CustomDataTypeDefinition"
description: |-
...
# Resource: intersight_workflow._custom_data_type_definition
Captures a customized data type definition that can be used for task or workflow input/output.  This can be reused across multiple tasks and workflow definitions.
## Argument Reference
