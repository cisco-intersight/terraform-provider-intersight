...
* `config_context`:(Array with Maximum of one item) - This provides consolidated configuration context of all the switch profiles referred by Switch Cluster Profile. 
