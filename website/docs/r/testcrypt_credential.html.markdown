...
sidebar_current: "docs-intersight-resource-testcryptCredential"
description: |-
  Basic Mo with secure property.

---

# Resource: intersight_testcrypt_credential
Basic Mo with secure property.

## Argument Reference
The following arguments are supported:
* `account`:(Array with Maximum of one item) -The account linked to Credential.
