...
func (m *AdapterConfigPolicy) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m AdapterConfigPolicy) MarshalJSON() ([]byte, error) {
...
// Validate validates this adapter config policy
func (m *AdapterConfigPolicy) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AdapterConfigPolicy) validateOrganization(formats strfmt.Registry) error {
...
func (m *AdapterConfigPolicy) validateProfiles(formats strfmt.Registry) error {
...
func (m *AdapterConfigPolicy) validateSettings(formats strfmt.Registry) error {
...
func (m *AdapterConfigPolicy) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AdapterConfigPolicy) UnmarshalBinary(b []byte) error {
	var res AdapterConfigPolicy
