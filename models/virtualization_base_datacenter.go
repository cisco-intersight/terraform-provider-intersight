...
// VirtualizationBaseDatacenter Virtualization:Base Datacenter
//
...
//
// swagger:model virtualizationBaseDatacenter
...
func (m *VirtualizationBaseDatacenter) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m VirtualizationBaseDatacenter) MarshalJSON() ([]byte, error) {
...
// Validate validates this virtualization base datacenter
func (m *VirtualizationBaseDatacenter) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VirtualizationBaseDatacenter) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *VirtualizationBaseDatacenter) UnmarshalBinary(b []byte) error {
	var res VirtualizationBaseDatacenter
