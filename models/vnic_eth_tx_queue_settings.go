...
func (m *VnicEthTxQueueSettings) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 VnicEthTxQueueSettingsAO1P1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.VnicEthTxQueueSettingsAO1P1 = aO1
...
func (m VnicEthTxQueueSettings) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.VnicEthTxQueueSettingsAO1P1)
	if err != nil {
		return nil, err
	}
...
func (m *VnicEthTxQueueSettings) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with VnicEthTxQueueSettingsAO1P1
	if err := m.VnicEthTxQueueSettingsAO1P1.Validate(formats); err != nil {
		res = append(res, err)
	}
...
type VnicEthTxQueueSettingsAO1P1 struct {
	...
	VnicEthTxQueueSettingsAO1P1 map[string]interface{} `json:"-"`
}

// UnmarshalJSON unmarshals this object with additional properties from JSON
func (m *VnicEthTxQueueSettingsAO1P1) UnmarshalJSON(data []byte) error {
	...
	*m = rcv
	...
	if len(stage2) > 0 {
		...
		m.VnicEthTxQueueSettingsAO1P1 = result
	}
...
func (m VnicEthTxQueueSettingsAO1P1) MarshalJSON() ([]byte, error) {
	var stage1 struct {
	...
	if len(m.VnicEthTxQueueSettingsAO1P1) == 0 {
		return props, nil
	}

	// make JSON object for the additional properties
	additional, err := json.Marshal(m.VnicEthTxQueueSettingsAO1P1)
	if err != nil {
		return nil, err
	}
...
// Validate validates this vnic eth tx queue settings a o1 p1
func (m *VnicEthTxQueueSettingsAO1P1) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *VnicEthTxQueueSettingsAO1P1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *VnicEthTxQueueSettingsAO1P1) UnmarshalBinary(b []byte) error {
	var res VnicEthTxQueueSettingsAO1P1
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
