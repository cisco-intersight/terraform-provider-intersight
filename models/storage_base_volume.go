...
func (m *StorageBaseVolume) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 MoBaseMo
...
func (m StorageBaseVolume) MarshalJSON() ([]byte, error) {
...
// Validate validates this storage base volume
func (m *StorageBaseVolume) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StorageBaseVolume) validateStorageUtilization(formats strfmt.Registry) error {
...
func (m *StorageBaseVolume) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageBaseVolume) UnmarshalBinary(b []byte) error {
	var res StorageBaseVolume
