...
//
// swagger:model firmwareDistributable
...
func (m *FirmwareDistributable) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m FirmwareDistributable) MarshalJSON() ([]byte, error) {
...
// Validate validates this firmware distributable
func (m *FirmwareDistributable) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FirmwareDistributable) validateCatalog(formats strfmt.Registry) error {
...
func (m *FirmwareDistributable) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *FirmwareDistributable) UnmarshalBinary(b []byte) error {
	var res FirmwareDistributable
