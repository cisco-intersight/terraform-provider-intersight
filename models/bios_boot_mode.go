...
func (m *BiosBootMode) UnmarshalJSON(raw []byte) error {
	// AO0
	...
	m.ActualBootMode = dataAO1.ActualBootMode
...
func (m BiosBootMode) MarshalJSON() ([]byte, error) {
	...
	dataAO1.ActualBootMode = m.ActualBootMode
...
// Validate validates this bios boot mode
func (m *BiosBootMode) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BiosBootMode) validateComputeRackUnit(formats strfmt.Registry) error {
...
func (m *BiosBootMode) validateRegisteredDevice(formats strfmt.Registry) error {
...
func (m *BiosBootMode) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BiosBootMode) UnmarshalBinary(b []byte) error {
	var res BiosBootMode
