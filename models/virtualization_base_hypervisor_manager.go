...
// VirtualizationBaseHypervisorManager Virtualization:Base Hypervisor Manager
//
...
//
// swagger:model virtualizationBaseHypervisorManager
...
func (m *VirtualizationBaseHypervisorManager) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 MoBaseMo
...
func (m VirtualizationBaseHypervisorManager) MarshalJSON() ([]byte, error) {
...
// Validate validates this virtualization base hypervisor manager
func (m *VirtualizationBaseHypervisorManager) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VirtualizationBaseHypervisorManager) validateRegisteredDevice(formats strfmt.Registry) error {
...
func (m *VirtualizationBaseHypervisorManager) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *VirtualizationBaseHypervisorManager) UnmarshalBinary(b []byte) error {
	var res VirtualizationBaseHypervisorManager
