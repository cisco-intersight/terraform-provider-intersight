...
// RecoveryConfigResultEntry Recovery:Config Result Entry
//
// An entry that describes the result of a Backup Profile state on the end device.
//
// swagger:model recoveryConfigResultEntry
type RecoveryConfigResultEntry struct {
	PolicyAbstractConfigResultEntry

	// A collection of references to the [recovery.ConfigResult](mo://recovery.ConfigResult) Managed Object.
...
func (m *RecoveryConfigResultEntry) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m RecoveryConfigResultEntry) MarshalJSON() ([]byte, error) {
...
// Validate validates this recovery config result entry
func (m *RecoveryConfigResultEntry) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoveryConfigResultEntry) validateConfigResult(formats strfmt.Registry) error {
...
func (m *RecoveryConfigResultEntry) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoveryConfigResultEntry) UnmarshalBinary(b []byte) error {
	var res RecoveryConfigResultEntry
