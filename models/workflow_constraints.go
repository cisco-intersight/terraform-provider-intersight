...
type WorkflowConstraints struct {
	WorkflowConstraintsAO0P0
}

// UnmarshalJSON unmarshals this object from a JSON structure
func (m *WorkflowConstraints) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 WorkflowConstraintsAO0P0
	if err := swag.ReadJSON(raw, &aO0); err != nil {
		return err
	}
	m.WorkflowConstraintsAO0P0 = aO0
...
func (m WorkflowConstraints) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.WorkflowConstraintsAO0P0)
	if err != nil {
		return nil, err
	}
...
func (m *WorkflowConstraints) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with WorkflowConstraintsAO0P0
	if err := m.WorkflowConstraintsAO0P0.Validate(formats); err != nil {
		res = append(res, err)
	}
...
// WorkflowConstraintsAO0P0 workflow constraints a o0 p0
// swagger:model WorkflowConstraintsAO0P0
type WorkflowConstraintsAO0P0 struct {
	...
	// workflow constraints a o0 p0
	WorkflowConstraintsAO0P0 map[string]interface{} `json:"-"`
}

// UnmarshalJSON unmarshals this object with additional properties from JSON
func (m *WorkflowConstraintsAO0P0) UnmarshalJSON(data []byte) error {
	...
	var rcv WorkflowConstraintsAO0P0
	...
	*m = rcv
	...
	if len(stage2) > 0 {
		...
		m.WorkflowConstraintsAO0P0 = result
	}
...
func (m WorkflowConstraintsAO0P0) MarshalJSON() ([]byte, error) {
	var stage1 struct {
	...
	if len(m.WorkflowConstraintsAO0P0) == 0 {
		return props, nil
	}

	// make JSON object for the additional properties
	additional, err := json.Marshal(m.WorkflowConstraintsAO0P0)
	if err != nil {
		return nil, err
	}
...
// Validate validates this workflow constraints a o0 p0
func (m *WorkflowConstraintsAO0P0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *WorkflowConstraintsAO0P0) validateEnumList(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *WorkflowConstraintsAO0P0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *WorkflowConstraintsAO0P0) UnmarshalBinary(b []byte) error {
	var res WorkflowConstraintsAO0P0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
