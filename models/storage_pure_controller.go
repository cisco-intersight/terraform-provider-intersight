...
// StoragePureController Storage:Pure Controller
//
...
// Validate validates this storage pure controller
...
func (m *StoragePureController) validateRegisteredDevice(formats strfmt.Registry) error {
...
func (m *StoragePureController) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StoragePureController) UnmarshalBinary(b []byte) error {
	var res StoragePureController
