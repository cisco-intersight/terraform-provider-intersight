...
// SoftwareHyperflexDistributable HyperFlex
//
// A HyperFlex image distributed by Cisco.
//
// swagger:model softwareHyperflexDistributable
...
func (m *SoftwareHyperflexDistributable) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m SoftwareHyperflexDistributable) MarshalJSON() ([]byte, error) {
...
// Validate validates this software hyperflex distributable
func (m *SoftwareHyperflexDistributable) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SoftwareHyperflexDistributable) validateCatalog(formats strfmt.Registry) error {
...
func (m *SoftwareHyperflexDistributable) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SoftwareHyperflexDistributable) UnmarshalBinary(b []byte) error {
	var res SoftwareHyperflexDistributable
