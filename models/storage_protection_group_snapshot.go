...
// StorageProtectionGroupSnapshot Storage:Protection Group Snapshot
//
// Protection group snapshot entity in protection group.
//
// swagger:model storageProtectionGroupSnapshot
...
func (m *StorageProtectionGroupSnapshot) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 MoBaseMo
...
func (m StorageProtectionGroupSnapshot) MarshalJSON() ([]byte, error) {
...
// Validate validates this storage protection group snapshot
func (m *StorageProtectionGroupSnapshot) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StorageProtectionGroupSnapshot) validateCreatedTime(formats strfmt.Registry) error {
...
func (m *StorageProtectionGroupSnapshot) validateProtectionGroup(formats strfmt.Registry) error {
...
func (m *StorageProtectionGroupSnapshot) validateStorageArray(formats strfmt.Registry) error {
...
func (m *StorageProtectionGroupSnapshot) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageProtectionGroupSnapshot) UnmarshalBinary(b []byte) error {
	var res StorageProtectionGroupSnapshot
