...
func (m *NtpPolicy) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m NtpPolicy) MarshalJSON() ([]byte, error) {
...
// Validate validates this ntp policy
func (m *NtpPolicy) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NtpPolicy) validateOrganization(formats strfmt.Registry) error {
...
func (m *NtpPolicy) validateProfiles(formats strfmt.Registry) error {
...
func (m *NtpPolicy) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NtpPolicy) UnmarshalBinary(b []byte) error {
	var res NtpPolicy
