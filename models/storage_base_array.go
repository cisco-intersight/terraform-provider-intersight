...
func (m *StorageBaseArray) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m StorageBaseArray) MarshalJSON() ([]byte, error) {
...
// Validate validates this storage base array
func (m *StorageBaseArray) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StorageBaseArray) validateStorageUtilization(formats strfmt.Registry) error {
...
func (m *StorageBaseArray) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageBaseArray) UnmarshalBinary(b []byte) error {
	var res StorageBaseArray
