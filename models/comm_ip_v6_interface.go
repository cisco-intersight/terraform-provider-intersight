...
type CommIPV6Interface struct {
	CommIPV6InterfaceAO0P0
}

// UnmarshalJSON unmarshals this object from a JSON structure
func (m *CommIPV6Interface) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 CommIPV6InterfaceAO0P0
	if err := swag.ReadJSON(raw, &aO0); err != nil {
		return err
	}
	m.CommIPV6InterfaceAO0P0 = aO0
...
func (m CommIPV6Interface) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.CommIPV6InterfaceAO0P0)
	if err != nil {
		return nil, err
	}
...
func (m *CommIPV6Interface) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with CommIPV6InterfaceAO0P0
	if err := m.CommIPV6InterfaceAO0P0.Validate(formats); err != nil {
		res = append(res, err)
	}
...
// CommIPV6InterfaceAO0P0 comm IP v6 interface a o0 p0
// swagger:model CommIPV6InterfaceAO0P0
type CommIPV6InterfaceAO0P0 struct {
	...
	// comm IP v6 interface a o0 p0
	CommIPV6InterfaceAO0P0 map[string]interface{} `json:"-"`
}

// UnmarshalJSON unmarshals this object with additional properties from JSON
func (m *CommIPV6InterfaceAO0P0) UnmarshalJSON(data []byte) error {
	...
	var rcv CommIPV6InterfaceAO0P0
	...
	*m = rcv
	...
	if len(stage2) > 0 {
		...
		m.CommIPV6InterfaceAO0P0 = result
	}
...
func (m CommIPV6InterfaceAO0P0) MarshalJSON() ([]byte, error) {
	var stage1 struct {
	...
	if len(m.CommIPV6InterfaceAO0P0) == 0 {
		return props, nil
	}

	// make JSON object for the additional properties
	additional, err := json.Marshal(m.CommIPV6InterfaceAO0P0)
	if err != nil {
		return nil, err
	}
...
// Validate validates this comm IP v6 interface a o0 p0
func (m *CommIPV6InterfaceAO0P0) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *CommIPV6InterfaceAO0P0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *CommIPV6InterfaceAO0P0) UnmarshalBinary(b []byte) error {
	var res CommIPV6InterfaceAO0P0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
