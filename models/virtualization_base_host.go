...
// VirtualizationBaseHost Virtualization:Base Host
//
...
//
// swagger:model virtualizationBaseHost
...
func (m *VirtualizationBaseHost) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m VirtualizationBaseHost) MarshalJSON() ([]byte, error) {
...
// Validate validates this virtualization base host
func (m *VirtualizationBaseHost) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VirtualizationBaseHost) validateCPUInfo(formats strfmt.Registry) error {
...
func (m *VirtualizationBaseHost) validateHardwareInfo(formats strfmt.Registry) error {
...
var virtualizationBaseHostTypeHypervisorTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		virtualizationBaseHostTypeHypervisorTypePropEnum = append(virtualizationBaseHostTypeHypervisorTypePropEnum, v)
	}
}

// property enum
func (m *VirtualizationBaseHost) validateHypervisorTypeEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, virtualizationBaseHostTypeHypervisorTypePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *VirtualizationBaseHost) validateHypervisorType(formats strfmt.Registry) error {
...
func (m *VirtualizationBaseHost) validateMemoryCapacity(formats strfmt.Registry) error {
...
func (m *VirtualizationBaseHost) validateProcessorCapacity(formats strfmt.Registry) error {
...
func (m *VirtualizationBaseHost) validateProductInfo(formats strfmt.Registry) error {
...
var virtualizationBaseHostTypeStatusPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		virtualizationBaseHostTypeStatusPropEnum = append(virtualizationBaseHostTypeStatusPropEnum, v)
	}
}

// property enum
func (m *VirtualizationBaseHost) validateStatusEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, virtualizationBaseHostTypeStatusPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *VirtualizationBaseHost) validateStatus(formats strfmt.Registry) error {
...
func (m *VirtualizationBaseHost) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *VirtualizationBaseHost) UnmarshalBinary(b []byte) error {
	var res VirtualizationBaseHost
