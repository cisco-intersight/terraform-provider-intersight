...
// StoragePureArrayUtilization Storage:Pure Array Utilization
//
// Storage space consumption of Pure FlashArray.
//
// swagger:model storagePureArrayUtilization
...
func (m *StoragePureArrayUtilization) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m StoragePureArrayUtilization) MarshalJSON() ([]byte, error) {
...
// Validate validates this storage pure array utilization
func (m *StoragePureArrayUtilization) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StoragePureArrayUtilization) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StoragePureArrayUtilization) UnmarshalBinary(b []byte) error {
	var res StoragePureArrayUtilization
