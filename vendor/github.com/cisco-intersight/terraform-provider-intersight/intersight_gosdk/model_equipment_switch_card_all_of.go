...
type _EquipmentSwitchCardAllOf EquipmentSwitchCardAllOf
...
func (o *EquipmentSwitchCardAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varEquipmentSwitchCardAllOf := _EquipmentSwitchCardAllOf{}

	if err = json.Unmarshal(bytes, &varEquipmentSwitchCardAllOf); err == nil {
		*o = EquipmentSwitchCardAllOf(varEquipmentSwitchCardAllOf)
	}
