...
func (dst *TelemetryDruidTopNMetricSpec) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["type"] == "dimension" {
		...
		if err == nil {
			jsonTelemetryDruidDimensionTopNMetricSpec, _ := json.Marshal(dst.TelemetryDruidDimensionTopNMetricSpec)
			if string(jsonTelemetryDruidDimensionTopNMetricSpec) == "{}" { // empty struct
	...
	if jsonDict["type"] == "inverted" {
		...
		if err == nil {
			jsonTelemetryDruidInvertedTopNMetricSpec, _ := json.Marshal(dst.TelemetryDruidInvertedTopNMetricSpec)
			if string(jsonTelemetryDruidInvertedTopNMetricSpec) == "{}" { // empty struct
	...
	if jsonDict["type"] == "numeric" {
		...
		if err == nil {
			jsonTelemetryDruidNumericTopNMetricSpec, _ := json.Marshal(dst.TelemetryDruidNumericTopNMetricSpec)
			if string(jsonTelemetryDruidNumericTopNMetricSpec) == "{}" { // empty struct
	...
	// try to unmarshal data into TelemetryDruidDimensionTopNMetricSpec
	err = json.Unmarshal(data, &dst.TelemetryDruidDimensionTopNMetricSpec)
	if err == nil {
		jsonTelemetryDruidDimensionTopNMetricSpec, _ := json.Marshal(dst.TelemetryDruidDimensionTopNMetricSpec)
		if string(jsonTelemetryDruidDimensionTopNMetricSpec) == "{}" { // empty struct
	...
	// try to unmarshal data into TelemetryDruidInvertedTopNMetricSpec
	err = json.Unmarshal(data, &dst.TelemetryDruidInvertedTopNMetricSpec)
	if err == nil {
		jsonTelemetryDruidInvertedTopNMetricSpec, _ := json.Marshal(dst.TelemetryDruidInvertedTopNMetricSpec)
		if string(jsonTelemetryDruidInvertedTopNMetricSpec) == "{}" { // empty struct
	...
	// try to unmarshal data into TelemetryDruidNumericTopNMetricSpec
	err = json.Unmarshal(data, &dst.TelemetryDruidNumericTopNMetricSpec)
	if err == nil {
		jsonTelemetryDruidNumericTopNMetricSpec, _ := json.Marshal(dst.TelemetryDruidNumericTopNMetricSpec)
		if string(jsonTelemetryDruidNumericTopNMetricSpec) == "{}" { // empty struct
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(TelemetryDruidTopNMetricSpec)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(TelemetryDruidTopNMetricSpec)")
	}
}
