...
// MemoryPersistentMemoryConfigurationAllOf Definition of the list of properties defined in 'memory.PersistentMemoryConfiguration', excluding properties defined in parent classes.
type MemoryPersistentMemoryConfigurationAllOf struct {
...
type _MemoryPersistentMemoryConfigurationAllOf MemoryPersistentMemoryConfigurationAllOf
...
func NewMemoryPersistentMemoryConfigurationAllOf() *MemoryPersistentMemoryConfigurationAllOf {
	this := MemoryPersistentMemoryConfigurationAllOf{}
	return &this
}
...
func (o MemoryPersistentMemoryConfigurationAllOf) MarshalJSON() ([]byte, error) {
...
func (o *MemoryPersistentMemoryConfigurationAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varMemoryPersistentMemoryConfigurationAllOf := _MemoryPersistentMemoryConfigurationAllOf{}

	if err = json.Unmarshal(bytes, &varMemoryPersistentMemoryConfigurationAllOf); err == nil {
		*o = MemoryPersistentMemoryConfigurationAllOf(varMemoryPersistentMemoryConfigurationAllOf)
	}
...
type NullableMemoryPersistentMemoryConfigurationAllOf struct {
	value *MemoryPersistentMemoryConfigurationAllOf
	isSet bool
}

func (v NullableMemoryPersistentMemoryConfigurationAllOf) Get() *MemoryPersistentMemoryConfigurationAllOf {
	return v.value
}

func (v *NullableMemoryPersistentMemoryConfigurationAllOf) Set(val *MemoryPersistentMemoryConfigurationAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMemoryPersistentMemoryConfigurationAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMemoryPersistentMemoryConfigurationAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMemoryPersistentMemoryConfigurationAllOf(val *MemoryPersistentMemoryConfigurationAllOf) *NullableMemoryPersistentMemoryConfigurationAllOf {
	return &NullableMemoryPersistentMemoryConfigurationAllOf{value: val, isSet: true}
}

func (v NullableMemoryPersistentMemoryConfigurationAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMemoryPersistentMemoryConfigurationAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
