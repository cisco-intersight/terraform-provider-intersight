...
func (o *FirmwareBaseDistributable) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varFirmwareBaseDistributable.ImageCategory = varFirmwareBaseDistributableWithoutEmbeddedStruct.ImageCategory
		...
		varFirmwareBaseDistributable.Origin = varFirmwareBaseDistributableWithoutEmbeddedStruct.Origin
