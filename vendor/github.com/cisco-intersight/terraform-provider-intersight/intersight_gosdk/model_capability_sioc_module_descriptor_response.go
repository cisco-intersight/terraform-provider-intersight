...
func (dst *CapabilitySiocModuleDescriptorResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "capability.SiocModuleDescriptor.List" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CapabilitySiocModuleDescriptorResponse as CapabilitySiocModuleDescriptorList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CapabilitySiocModuleDescriptorResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CapabilitySiocModuleDescriptorResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CapabilitySiocModuleDescriptorResponse as MoTagSummary: %s", err.Error())
		}
	}
