...
// VirtualizationVirtualDiskList This resource list is returned as a response to a HTTP GET request that does not include a specific resource identifier.
type VirtualizationVirtualDiskList struct {
	MoBaseResponse
...
func NewVirtualizationVirtualDiskList() *VirtualizationVirtualDiskList {
	this := VirtualizationVirtualDiskList{}
	return &this
}
...
func (o VirtualizationVirtualDiskList) MarshalJSON() ([]byte, error) {
...
type NullableVirtualizationVirtualDiskList struct {
	value *VirtualizationVirtualDiskList
	isSet bool
}

func (v NullableVirtualizationVirtualDiskList) Get() *VirtualizationVirtualDiskList {
	return v.value
}

func (v *NullableVirtualizationVirtualDiskList) Set(val *VirtualizationVirtualDiskList) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVirtualDiskList) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVirtualDiskList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVirtualDiskList(val *VirtualizationVirtualDiskList) *NullableVirtualizationVirtualDiskList {
	return &NullableVirtualizationVirtualDiskList{value: val, isSet: true}
}

func (v NullableVirtualizationVirtualDiskList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVirtualDiskList) UnmarshalJSON(src []byte) error {
	v.isSet = true
