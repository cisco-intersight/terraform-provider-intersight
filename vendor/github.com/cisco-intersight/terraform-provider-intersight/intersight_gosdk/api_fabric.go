...
type apiCreateFabricQosPolicyRequest struct {
	ctx             _context.Context
	apiService      *FabricApiService
	fabricQosPolicy *FabricQosPolicy
	ifMatch         *string
	ifNoneMatch     *string
}

func (r apiCreateFabricQosPolicyRequest) FabricQosPolicy(fabricQosPolicy FabricQosPolicy) apiCreateFabricQosPolicyRequest {
	r.fabricQosPolicy = &fabricQosPolicy
	return r
}

func (r apiCreateFabricQosPolicyRequest) IfMatch(ifMatch string) apiCreateFabricQosPolicyRequest {
	r.ifMatch = &ifMatch
	return r
}

func (r apiCreateFabricQosPolicyRequest) IfNoneMatch(ifNoneMatch string) apiCreateFabricQosPolicyRequest {
	r.ifNoneMatch = &ifNoneMatch
	return r
}

/*
CreateFabricQosPolicy Create a 'fabric.QosPolicy' resource.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return apiCreateFabricQosPolicyRequest
*/
func (a *FabricApiService) CreateFabricQosPolicy(ctx _context.Context) apiCreateFabricQosPolicyRequest {
	return apiCreateFabricQosPolicyRequest{
		apiService: a,
		ctx:        ctx,
	}
...
/*
Execute executes the request
 @return FabricQosPolicy
*/
func (r apiCreateFabricQosPolicyRequest) Execute() (FabricQosPolicy, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  FabricQosPolicy
	)

	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "FabricApiService.CreateFabricQosPolicy")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/fabric/QosPolicies"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}

	if r.fabricQosPolicy == nil {
		return localVarReturnValue, nil, reportError("fabricQosPolicy is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.fabricQosPolicy
	req, err := r.apiService.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type apiDeleteFabricQosPolicyRequest struct {
	ctx        _context.Context
	apiService *FabricApiService
	moid       string
}
...
/*
DeleteFabricQosPolicy Delete a 'fabric.QosPolicy' resource.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param moid The unique Moid identifier of a resource instance.
@return apiDeleteFabricQosPolicyRequest
*/
func (a *FabricApiService) DeleteFabricQosPolicy(ctx _context.Context, moid string) apiDeleteFabricQosPolicyRequest {
	return apiDeleteFabricQosPolicyRequest{
		apiService: a,
		ctx:        ctx,
		moid:       moid,
...
*/
func (r apiDeleteFabricQosPolicyRequest) Execute() (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "FabricApiService.DeleteFabricQosPolicy")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/fabric/QosPolicies/{Moid}"
	localVarPath = strings.Replace(localVarPath, "{"+"Moid"+"}", _neturl.PathEscape(parameterToString(r.moid, "")), -1)
...
type apiGetFabricQosPolicyByMoidRequest struct {
	ctx        _context.Context
	apiService *FabricApiService
	moid       string
}
...
/*
GetFabricQosPolicyByMoid Read a 'fabric.QosPolicy' resource.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param moid The unique Moid identifier of a resource instance.
@return apiGetFabricQosPolicyByMoidRequest
*/
func (a *FabricApiService) GetFabricQosPolicyByMoid(ctx _context.Context, moid string) apiGetFabricQosPolicyByMoidRequest {
	return apiGetFabricQosPolicyByMoidRequest{
		apiService: a,
		ctx:        ctx,
		moid:       moid,
...
Execute executes the request
 @return FabricQosPolicy
*/
func (r apiGetFabricQosPolicyByMoidRequest) Execute() (FabricQosPolicy, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "FabricApiService.GetFabricQosPolicyByMoid")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
type apiGetFabricQosPolicyListRequest struct {
	ctx         _context.Context
	apiService  *FabricApiService
	filter      *string
	orderby     *string
...
func (r apiGetFabricQosPolicyListRequest) Filter(filter string) apiGetFabricQosPolicyListRequest {
	r.filter = &filter
	return r
}

func (r apiGetFabricQosPolicyListRequest) Orderby(orderby string) apiGetFabricQosPolicyListRequest {
	r.orderby = &orderby
	return r
}

func (r apiGetFabricQosPolicyListRequest) Top(top int32) apiGetFabricQosPolicyListRequest {
	r.top = &top
	return r
}

func (r apiGetFabricQosPolicyListRequest) Skip(skip int32) apiGetFabricQosPolicyListRequest {
	r.skip = &skip
	return r
}

func (r apiGetFabricQosPolicyListRequest) Select_(select_ string) apiGetFabricQosPolicyListRequest {
	r.select_ = &select_
	return r
}

func (r apiGetFabricQosPolicyListRequest) Expand(expand string) apiGetFabricQosPolicyListRequest {
	r.expand = &expand
	return r
}

func (r apiGetFabricQosPolicyListRequest) Apply(apply string) apiGetFabricQosPolicyListRequest {
	r.apply = &apply
	return r
}

func (r apiGetFabricQosPolicyListRequest) Count(count bool) apiGetFabricQosPolicyListRequest {
	r.count = &count
	return r
}

func (r apiGetFabricQosPolicyListRequest) Inlinecount(inlinecount string) apiGetFabricQosPolicyListRequest {
	r.inlinecount = &inlinecount
	return r
}

func (r apiGetFabricQosPolicyListRequest) At(at string) apiGetFabricQosPolicyListRequest {
	r.at = &at
	return r
}

func (r apiGetFabricQosPolicyListRequest) Tags(tags string) apiGetFabricQosPolicyListRequest {
	r.tags = &tags
	return r
}

/*
GetFabricQosPolicyList Read a 'fabric.QosPolicy' resource.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return apiGetFabricQosPolicyListRequest
*/
func (a *FabricApiService) GetFabricQosPolicyList(ctx _context.Context) apiGetFabricQosPolicyListRequest {
	return apiGetFabricQosPolicyListRequest{
		apiService: a,
		ctx:        ctx,
	}
...
/*
Execute executes the request
 @return FabricQosPolicyResponse
*/
func (r apiGetFabricQosPolicyListRequest) Execute() (FabricQosPolicyResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  FabricQosPolicyResponse
	)

	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "FabricApiService.GetFabricQosPolicyList")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
type apiPatchFabricQosPolicyRequest struct {
	ctx             _context.Context
	apiService      *FabricApiService
	moid            string
	fabricQosPolicy *FabricQosPolicy
...
func (r apiPatchFabricQosPolicyRequest) FabricQosPolicy(fabricQosPolicy FabricQosPolicy) apiPatchFabricQosPolicyRequest {
	r.fabricQosPolicy = &fabricQosPolicy
	return r
}

func (r apiPatchFabricQosPolicyRequest) IfMatch(ifMatch string) apiPatchFabricQosPolicyRequest {
	r.ifMatch = &ifMatch
	return r
}

/*
PatchFabricQosPolicy Update a 'fabric.QosPolicy' resource.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param moid The unique Moid identifier of a resource instance.
@return apiPatchFabricQosPolicyRequest
*/
func (a *FabricApiService) PatchFabricQosPolicy(ctx _context.Context, moid string) apiPatchFabricQosPolicyRequest {
	return apiPatchFabricQosPolicyRequest{
		apiService: a,
		ctx:        ctx,
		moid:       moid,
...
Execute executes the request
 @return FabricQosPolicy
*/
func (r apiPatchFabricQosPolicyRequest) Execute() (FabricQosPolicy, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "FabricApiService.PatchFabricQosPolicy")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
type apiUpdateFabricQosPolicyRequest struct {
	ctx             _context.Context
	apiService      *FabricApiService
	moid            string
	fabricQosPolicy *FabricQosPolicy
...
func (r apiUpdateFabricQosPolicyRequest) FabricQosPolicy(fabricQosPolicy FabricQosPolicy) apiUpdateFabricQosPolicyRequest {
	r.fabricQosPolicy = &fabricQosPolicy
	return r
}

func (r apiUpdateFabricQosPolicyRequest) IfMatch(ifMatch string) apiUpdateFabricQosPolicyRequest {
	r.ifMatch = &ifMatch
	return r
}

/*
UpdateFabricQosPolicy Update a 'fabric.QosPolicy' resource.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param moid The unique Moid identifier of a resource instance.
@return apiUpdateFabricQosPolicyRequest
*/
func (a *FabricApiService) UpdateFabricQosPolicy(ctx _context.Context, moid string) apiUpdateFabricQosPolicyRequest {
	return apiUpdateFabricQosPolicyRequest{
		apiService: a,
		ctx:        ctx,
		moid:       moid,
...
Execute executes the request
 @return FabricQosPolicy
*/
func (r apiUpdateFabricQosPolicyRequest) Execute() (FabricQosPolicy, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "FabricApiService.UpdateFabricQosPolicy")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
