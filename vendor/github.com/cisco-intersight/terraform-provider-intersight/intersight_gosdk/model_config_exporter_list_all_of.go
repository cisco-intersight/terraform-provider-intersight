...
type _ConfigExporterListAllOf ConfigExporterListAllOf
...
func (o *ConfigExporterListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varConfigExporterListAllOf := _ConfigExporterListAllOf{}

	if err = json.Unmarshal(bytes, &varConfigExporterListAllOf); err == nil {
		*o = ConfigExporterListAllOf(varConfigExporterListAllOf)
	}
