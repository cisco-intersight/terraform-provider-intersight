...
func (dst *VirtualizationVmwareHostResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationVmwareHostResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationVmwareHostResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationVmwareHostResponse as MoTagSummary: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "virtualization.VmwareHost.List" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationVmwareHostResponse as VirtualizationVmwareHostList: %s", err.Error())
		}
	}
