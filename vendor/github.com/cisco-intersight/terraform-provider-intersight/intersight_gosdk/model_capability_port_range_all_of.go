...
// CapabilityPortRangeAllOf Definition of the list of properties defined in 'capability.PortRange', excluding properties defined in parent classes.
type CapabilityPortRangeAllOf struct {
...
type _CapabilityPortRangeAllOf CapabilityPortRangeAllOf
...
func (o CapabilityPortRangeAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CapabilityPortRangeAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCapabilityPortRangeAllOf := _CapabilityPortRangeAllOf{}

	if err = json.Unmarshal(bytes, &varCapabilityPortRangeAllOf); err == nil {
		*o = CapabilityPortRangeAllOf(varCapabilityPortRangeAllOf)
	}
...
type NullableCapabilityPortRangeAllOf struct {
	value *CapabilityPortRangeAllOf
	isSet bool
}

func (v NullableCapabilityPortRangeAllOf) Get() *CapabilityPortRangeAllOf {
	return v.value
}

func (v *NullableCapabilityPortRangeAllOf) Set(val *CapabilityPortRangeAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCapabilityPortRangeAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCapabilityPortRangeAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCapabilityPortRangeAllOf(val *CapabilityPortRangeAllOf) *NullableCapabilityPortRangeAllOf {
	return &NullableCapabilityPortRangeAllOf{value: val, isSet: true}
}

func (v NullableCapabilityPortRangeAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCapabilityPortRangeAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
