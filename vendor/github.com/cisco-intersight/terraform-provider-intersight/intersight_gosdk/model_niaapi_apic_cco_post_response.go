...
func MoAggregateTransformAsNiaapiApicCcoPostResponse(v *MoAggregateTransform) NiaapiApicCcoPostResponse {
	return NiaapiApicCcoPostResponse{MoAggregateTransform: v}
}
...
func MoDocumentCountAsNiaapiApicCcoPostResponse(v *MoDocumentCount) NiaapiApicCcoPostResponse {
	return NiaapiApicCcoPostResponse{MoDocumentCount: v}
}
...
func MoTagSummaryAsNiaapiApicCcoPostResponse(v *MoTagSummary) NiaapiApicCcoPostResponse {
	return NiaapiApicCcoPostResponse{MoTagSummary: v}
}
...
func NiaapiApicCcoPostListAsNiaapiApicCcoPostResponse(v *NiaapiApicCcoPostList) NiaapiApicCcoPostResponse {
	return NiaapiApicCcoPostResponse{NiaapiApicCcoPostList: v}
}
...
func (dst *NiaapiApicCcoPostResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "niaapi.ApicCcoPost.List" {
		...
		if err == nil {
			jsonNiaapiApicCcoPostList, _ := json.Marshal(dst.NiaapiApicCcoPostList)
			if string(jsonNiaapiApicCcoPostList) == "{}" { // empty struct
	...
	// try to unmarshal data into NiaapiApicCcoPostList
	err = json.Unmarshal(data, &dst.NiaapiApicCcoPostList)
	if err == nil {
		jsonNiaapiApicCcoPostList, _ := json.Marshal(dst.NiaapiApicCcoPostList)
		if string(jsonNiaapiApicCcoPostList) == "{}" { // empty struct
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(NiaapiApicCcoPostResponse)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(NiaapiApicCcoPostResponse)")
	}
}
