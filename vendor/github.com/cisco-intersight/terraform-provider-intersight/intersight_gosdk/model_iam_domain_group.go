...
func (o *IamDomainGroup) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varIamDomainGroupWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varIamDomainGroup)
	if err == nil {
