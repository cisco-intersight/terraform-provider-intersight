...
func (dst *MemoryUnitResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "memory.Unit.List" {
		// try to unmarshal JSON data into MemoryUnitList
		err = json.Unmarshal(data, &dst.MemoryUnitList)
		if err == nil {
			return nil // data stored in dst.MemoryUnitList, return on the first match
		} else {
			dst.MemoryUnitList = nil
			return fmt.Errorf("Failed to unmarshal MemoryUnitResponse as MemoryUnitList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal MemoryUnitResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal MemoryUnitResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal MemoryUnitResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src MemoryUnitResponse) MarshalJSON() ([]byte, error) {
	if src.MemoryUnitList != nil {
		return json.Marshal(&src.MemoryUnitList)
	}
...
type NullableMemoryUnitResponse struct {
	value *MemoryUnitResponse
	isSet bool
}

func (v NullableMemoryUnitResponse) Get() *MemoryUnitResponse {
	return v.value
}

func (v *NullableMemoryUnitResponse) Set(val *MemoryUnitResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMemoryUnitResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMemoryUnitResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMemoryUnitResponse(val *MemoryUnitResponse) *NullableMemoryUnitResponse {
	return &NullableMemoryUnitResponse{value: val, isSet: true}
}

func (v NullableMemoryUnitResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMemoryUnitResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
