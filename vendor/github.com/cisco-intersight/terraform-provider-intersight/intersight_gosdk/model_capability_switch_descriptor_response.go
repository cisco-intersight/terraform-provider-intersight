...
func (dst *CapabilitySwitchDescriptorResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "capability.SwitchDescriptor.List" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CapabilitySwitchDescriptorResponse as CapabilitySwitchDescriptorList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CapabilitySwitchDescriptorResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CapabilitySwitchDescriptorResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CapabilitySwitchDescriptorResponse as MoTagSummary: %s", err.Error())
		}
	}
