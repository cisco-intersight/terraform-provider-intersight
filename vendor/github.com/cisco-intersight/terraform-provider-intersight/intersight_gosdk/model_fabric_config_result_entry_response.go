...
func FabricConfigResultEntryListAsFabricConfigResultEntryResponse(v *FabricConfigResultEntryList) FabricConfigResultEntryResponse {
	return FabricConfigResultEntryResponse{FabricConfigResultEntryList: v}
}
...
func MoAggregateTransformAsFabricConfigResultEntryResponse(v *MoAggregateTransform) FabricConfigResultEntryResponse {
	return FabricConfigResultEntryResponse{MoAggregateTransform: v}
}
...
func MoDocumentCountAsFabricConfigResultEntryResponse(v *MoDocumentCount) FabricConfigResultEntryResponse {
	return FabricConfigResultEntryResponse{MoDocumentCount: v}
}
...
func MoTagSummaryAsFabricConfigResultEntryResponse(v *MoTagSummary) FabricConfigResultEntryResponse {
	return FabricConfigResultEntryResponse{MoTagSummary: v}
}
...
func (dst *FabricConfigResultEntryResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "fabric.ConfigResultEntry.List" {
		...
		if err == nil {
			jsonFabricConfigResultEntryList, _ := json.Marshal(dst.FabricConfigResultEntryList)
			if string(jsonFabricConfigResultEntryList) == "{}" { // empty struct
	...
	// try to unmarshal data into FabricConfigResultEntryList
	err = json.Unmarshal(data, &dst.FabricConfigResultEntryList)
	if err == nil {
		jsonFabricConfigResultEntryList, _ := json.Marshal(dst.FabricConfigResultEntryList)
		if string(jsonFabricConfigResultEntryList) == "{}" { // empty struct
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(FabricConfigResultEntryResponse)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(FabricConfigResultEntryResponse)")
	}
}
