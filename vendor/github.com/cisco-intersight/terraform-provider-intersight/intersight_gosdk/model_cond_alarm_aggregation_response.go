...
func (dst *CondAlarmAggregationResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "cond.AlarmAggregation.List" {
		// try to unmarshal JSON data into CondAlarmAggregationList
		err = json.Unmarshal(data, &dst.CondAlarmAggregationList)
		if err == nil {
			return nil // data stored in dst.CondAlarmAggregationList, return on the first match
		} else {
			dst.CondAlarmAggregationList = nil
			return fmt.Errorf("Failed to unmarshal CondAlarmAggregationResponse as CondAlarmAggregationList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CondAlarmAggregationResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CondAlarmAggregationResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CondAlarmAggregationResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src CondAlarmAggregationResponse) MarshalJSON() ([]byte, error) {
	if src.CondAlarmAggregationList != nil {
		return json.Marshal(&src.CondAlarmAggregationList)
	}
...
type NullableCondAlarmAggregationResponse struct {
	value *CondAlarmAggregationResponse
	isSet bool
}

func (v NullableCondAlarmAggregationResponse) Get() *CondAlarmAggregationResponse {
	return v.value
}

func (v *NullableCondAlarmAggregationResponse) Set(val *CondAlarmAggregationResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCondAlarmAggregationResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCondAlarmAggregationResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCondAlarmAggregationResponse(val *CondAlarmAggregationResponse) *NullableCondAlarmAggregationResponse {
	return &NullableCondAlarmAggregationResponse{value: val, isSet: true}
}

func (v NullableCondAlarmAggregationResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCondAlarmAggregationResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
