...
// NiatelemetryNiaFeatureUsageListAllOf struct for NiatelemetryNiaFeatureUsageListAllOf
type NiatelemetryNiaFeatureUsageListAllOf struct {
...
type _NiatelemetryNiaFeatureUsageListAllOf NiatelemetryNiaFeatureUsageListAllOf
...
func NewNiatelemetryNiaFeatureUsageListAllOf() *NiatelemetryNiaFeatureUsageListAllOf {
	this := NiatelemetryNiaFeatureUsageListAllOf{}
	return &this
}
...
func (o NiatelemetryNiaFeatureUsageListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryNiaFeatureUsageListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryNiaFeatureUsageListAllOf := _NiatelemetryNiaFeatureUsageListAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryNiaFeatureUsageListAllOf); err == nil {
		*o = NiatelemetryNiaFeatureUsageListAllOf(varNiatelemetryNiaFeatureUsageListAllOf)
	}
...
type NullableNiatelemetryNiaFeatureUsageListAllOf struct {
	value *NiatelemetryNiaFeatureUsageListAllOf
	isSet bool
}

func (v NullableNiatelemetryNiaFeatureUsageListAllOf) Get() *NiatelemetryNiaFeatureUsageListAllOf {
	return v.value
}

func (v *NullableNiatelemetryNiaFeatureUsageListAllOf) Set(val *NiatelemetryNiaFeatureUsageListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryNiaFeatureUsageListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryNiaFeatureUsageListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryNiaFeatureUsageListAllOf(val *NiatelemetryNiaFeatureUsageListAllOf) *NullableNiatelemetryNiaFeatureUsageListAllOf {
	return &NullableNiatelemetryNiaFeatureUsageListAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryNiaFeatureUsageListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryNiaFeatureUsageListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
