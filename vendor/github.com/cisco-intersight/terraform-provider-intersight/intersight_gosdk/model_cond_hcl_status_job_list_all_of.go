...
// CondHclStatusJobListAllOf struct for CondHclStatusJobListAllOf
type CondHclStatusJobListAllOf struct {
...
type _CondHclStatusJobListAllOf CondHclStatusJobListAllOf
...
func NewCondHclStatusJobListAllOf() *CondHclStatusJobListAllOf {
	this := CondHclStatusJobListAllOf{}
	return &this
}
...
func (o CondHclStatusJobListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CondHclStatusJobListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCondHclStatusJobListAllOf := _CondHclStatusJobListAllOf{}

	if err = json.Unmarshal(bytes, &varCondHclStatusJobListAllOf); err == nil {
		*o = CondHclStatusJobListAllOf(varCondHclStatusJobListAllOf)
	}
...
type NullableCondHclStatusJobListAllOf struct {
	value *CondHclStatusJobListAllOf
	isSet bool
}

func (v NullableCondHclStatusJobListAllOf) Get() *CondHclStatusJobListAllOf {
	return v.value
}

func (v *NullableCondHclStatusJobListAllOf) Set(val *CondHclStatusJobListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCondHclStatusJobListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCondHclStatusJobListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCondHclStatusJobListAllOf(val *CondHclStatusJobListAllOf) *NullableCondHclStatusJobListAllOf {
	return &NullableCondHclStatusJobListAllOf{value: val, isSet: true}
}

func (v NullableCondHclStatusJobListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCondHclStatusJobListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
