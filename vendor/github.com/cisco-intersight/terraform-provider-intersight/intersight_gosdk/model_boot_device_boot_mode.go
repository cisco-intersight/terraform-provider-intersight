...
func (o *BootDeviceBootMode) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varBootDeviceBootModeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varBootDeviceBootMode)
	if err == nil {
