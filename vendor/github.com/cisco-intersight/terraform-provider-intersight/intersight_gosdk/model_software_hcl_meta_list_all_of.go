...
// SoftwareHclMetaListAllOf struct for SoftwareHclMetaListAllOf
type SoftwareHclMetaListAllOf struct {
...
type _SoftwareHclMetaListAllOf SoftwareHclMetaListAllOf
...
func (o SoftwareHclMetaListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *SoftwareHclMetaListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varSoftwareHclMetaListAllOf := _SoftwareHclMetaListAllOf{}

	if err = json.Unmarshal(bytes, &varSoftwareHclMetaListAllOf); err == nil {
		*o = SoftwareHclMetaListAllOf(varSoftwareHclMetaListAllOf)
	}
...
type NullableSoftwareHclMetaListAllOf struct {
	value *SoftwareHclMetaListAllOf
	isSet bool
}

func (v NullableSoftwareHclMetaListAllOf) Get() *SoftwareHclMetaListAllOf {
	return v.value
}

func (v *NullableSoftwareHclMetaListAllOf) Set(val *SoftwareHclMetaListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSoftwareHclMetaListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSoftwareHclMetaListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoftwareHclMetaListAllOf(val *SoftwareHclMetaListAllOf) *NullableSoftwareHclMetaListAllOf {
	return &NullableSoftwareHclMetaListAllOf{value: val, isSet: true}
}

func (v NullableSoftwareHclMetaListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoftwareHclMetaListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
