...
func (dst *VrfVrfResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VrfVrfResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VrfVrfResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VrfVrfResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'vrf.Vrf.List'
	if jsonDict["ObjectType"] == "vrf.Vrf.List" {
		// try to unmarshal JSON data into VrfVrfList
		err = json.Unmarshal(data, &dst.VrfVrfList)
		if err == nil {
			return nil // data stored in dst.VrfVrfList, return on the first match
		} else {
			dst.VrfVrfList = nil
			return fmt.Errorf("Failed to unmarshal VrfVrfResponse as VrfVrfList: %s", err.Error())
		}
	}
...
type NullableVrfVrfResponse struct {
	value *VrfVrfResponse
	isSet bool
}

func (v NullableVrfVrfResponse) Get() *VrfVrfResponse {
	return v.value
}

func (v *NullableVrfVrfResponse) Set(val *VrfVrfResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVrfVrfResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVrfVrfResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVrfVrfResponse(val *VrfVrfResponse) *NullableVrfVrfResponse {
	return &NullableVrfVrfResponse{value: val, isSet: true}
}

func (v NullableVrfVrfResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVrfVrfResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
