...
func (o *NiaapiDcnmLatestMaintainedRelease) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varNiaapiDcnmLatestMaintainedReleaseWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varNiaapiDcnmLatestMaintainedRelease)
	if err == nil {
