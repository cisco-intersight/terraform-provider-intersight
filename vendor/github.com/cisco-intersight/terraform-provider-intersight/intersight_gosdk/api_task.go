...
func (r apiCreateTaskPureScopedInventoryRequest) Execute() (TaskPureScopedInventory, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "TaskApiService.CreateTaskPureScopedInventory")
	if err != nil {
...
func (r apiCreateTaskWorkflowActionRequest) Execute() (TaskWorkflowAction, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "TaskApiService.CreateTaskWorkflowAction")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiGetTaskWorkflowActionByMoidRequest) Execute() (TaskWorkflowAction, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "TaskApiService.GetTaskWorkflowActionByMoid")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiGetTaskWorkflowActionListRequest) Execute() (TaskWorkflowActionResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "TaskApiService.GetTaskWorkflowActionList")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiPatchTaskWorkflowActionRequest) Execute() (TaskWorkflowAction, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "TaskApiService.PatchTaskWorkflowAction")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiUpdateTaskWorkflowActionRequest) Execute() (TaskWorkflowAction, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "TaskApiService.UpdateTaskWorkflowAction")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
