...
func (dst *SoftwarerepositoryDownloadSpecResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal SoftwarerepositoryDownloadSpecResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal SoftwarerepositoryDownloadSpecResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal SoftwarerepositoryDownloadSpecResponse as MoTagSummary: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "softwarerepository.DownloadSpec.List" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal SoftwarerepositoryDownloadSpecResponse as SoftwarerepositoryDownloadSpecList: %s", err.Error())
		}
	}
