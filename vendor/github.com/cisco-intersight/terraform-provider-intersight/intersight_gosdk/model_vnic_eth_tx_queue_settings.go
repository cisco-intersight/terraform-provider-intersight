...
func (o *VnicEthTxQueueSettings) UnmarshalJSON(bytes []byte) (err error) {
	type VnicEthTxQueueSettingsWithoutEmbeddedStruct struct {
		// The number of queue resources to allocate.
		Count *int64 `json:"Count,omitempty"`
		// The number of descriptors in each queue.
		RingSize *int64 `json:"RingSize,omitempty"`
	...
	varVnicEthTxQueueSettingsWithoutEmbeddedStruct := VnicEthTxQueueSettingsWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varVnicEthTxQueueSettingsWithoutEmbeddedStruct)
	if err == nil {
		varVnicEthTxQueueSettings := _VnicEthTxQueueSettings{}
		varVnicEthTxQueueSettings.Count = varVnicEthTxQueueSettingsWithoutEmbeddedStruct.Count
		varVnicEthTxQueueSettings.RingSize = varVnicEthTxQueueSettingsWithoutEmbeddedStruct.RingSize
	...
	err = json.Unmarshal(bytes, &varVnicEthTxQueueSettings)
	if err == nil {
		o.MoBaseComplexType = varVnicEthTxQueueSettings.MoBaseComplexType
	} else {
		return err
	}
