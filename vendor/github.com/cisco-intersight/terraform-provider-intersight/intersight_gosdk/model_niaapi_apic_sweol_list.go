...
func (o *NiaapiApicSweolList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varNiaapiApicSweolListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varNiaapiApicSweolList)
	if err == nil {
