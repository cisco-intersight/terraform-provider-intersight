...
// FabricFcoeUplinkRoleAllOf Definition of the list of properties defined in 'fabric.FcoeUplinkRole', excluding properties defined in parent classes.
type FabricFcoeUplinkRoleAllOf struct {
...
type _FabricFcoeUplinkRoleAllOf FabricFcoeUplinkRoleAllOf
...
func NewFabricFcoeUplinkRoleAllOf() *FabricFcoeUplinkRoleAllOf {
	this := FabricFcoeUplinkRoleAllOf{}
...
func (o FabricFcoeUplinkRoleAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FabricFcoeUplinkRoleAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFabricFcoeUplinkRoleAllOf := _FabricFcoeUplinkRoleAllOf{}

	if err = json.Unmarshal(bytes, &varFabricFcoeUplinkRoleAllOf); err == nil {
		*o = FabricFcoeUplinkRoleAllOf(varFabricFcoeUplinkRoleAllOf)
	}
...
type NullableFabricFcoeUplinkRoleAllOf struct {
	value *FabricFcoeUplinkRoleAllOf
	isSet bool
}

func (v NullableFabricFcoeUplinkRoleAllOf) Get() *FabricFcoeUplinkRoleAllOf {
	return v.value
}

func (v *NullableFabricFcoeUplinkRoleAllOf) Set(val *FabricFcoeUplinkRoleAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFabricFcoeUplinkRoleAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFabricFcoeUplinkRoleAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFabricFcoeUplinkRoleAllOf(val *FabricFcoeUplinkRoleAllOf) *NullableFabricFcoeUplinkRoleAllOf {
	return &NullableFabricFcoeUplinkRoleAllOf{value: val, isSet: true}
}

func (v NullableFabricFcoeUplinkRoleAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFabricFcoeUplinkRoleAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
