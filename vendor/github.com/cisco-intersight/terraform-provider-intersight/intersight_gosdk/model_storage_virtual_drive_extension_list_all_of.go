...
// StorageVirtualDriveExtensionListAllOf struct for StorageVirtualDriveExtensionListAllOf
type StorageVirtualDriveExtensionListAllOf struct {
...
type _StorageVirtualDriveExtensionListAllOf StorageVirtualDriveExtensionListAllOf
...
func NewStorageVirtualDriveExtensionListAllOf() *StorageVirtualDriveExtensionListAllOf {
	this := StorageVirtualDriveExtensionListAllOf{}
	return &this
}
...
func (o StorageVirtualDriveExtensionListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageVirtualDriveExtensionListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageVirtualDriveExtensionListAllOf := _StorageVirtualDriveExtensionListAllOf{}

	if err = json.Unmarshal(bytes, &varStorageVirtualDriveExtensionListAllOf); err == nil {
		*o = StorageVirtualDriveExtensionListAllOf(varStorageVirtualDriveExtensionListAllOf)
	}
...
type NullableStorageVirtualDriveExtensionListAllOf struct {
	value *StorageVirtualDriveExtensionListAllOf
	isSet bool
}

func (v NullableStorageVirtualDriveExtensionListAllOf) Get() *StorageVirtualDriveExtensionListAllOf {
	return v.value
}

func (v *NullableStorageVirtualDriveExtensionListAllOf) Set(val *StorageVirtualDriveExtensionListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageVirtualDriveExtensionListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageVirtualDriveExtensionListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageVirtualDriveExtensionListAllOf(val *StorageVirtualDriveExtensionListAllOf) *NullableStorageVirtualDriveExtensionListAllOf {
	return &NullableStorageVirtualDriveExtensionListAllOf{value: val, isSet: true}
}

func (v NullableStorageVirtualDriveExtensionListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageVirtualDriveExtensionListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
