...
func (dst *MetaDefinitionResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "meta.Definition.List" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal MetaDefinitionResponse as MetaDefinitionList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal MetaDefinitionResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal MetaDefinitionResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal MetaDefinitionResponse as MoTagSummary: %s", err.Error())
		}
	}
