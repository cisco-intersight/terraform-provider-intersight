...
func (dst *TechsupportmanagementTechSupportBundleResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "techsupportmanagement.TechSupportBundle.List" {
		...
		if err == nil {
			jsonTechsupportmanagementTechSupportBundleList, _ := json.Marshal(dst.TechsupportmanagementTechSupportBundleList)
			if string(jsonTechsupportmanagementTechSupportBundleList) == "{}" { // empty struct
	...
	// try to unmarshal data into TechsupportmanagementTechSupportBundleList
	err = json.Unmarshal(data, &dst.TechsupportmanagementTechSupportBundleList)
	if err == nil {
		jsonTechsupportmanagementTechSupportBundleList, _ := json.Marshal(dst.TechsupportmanagementTechSupportBundleList)
		if string(jsonTechsupportmanagementTechSupportBundleList) == "{}" { // empty struct
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(TechsupportmanagementTechSupportBundleResponse)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(TechsupportmanagementTechSupportBundleResponse)")
	}
}
