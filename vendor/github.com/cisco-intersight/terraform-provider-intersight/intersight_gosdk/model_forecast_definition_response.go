...
func (dst *ForecastDefinitionResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "forecast.Definition.List" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ForecastDefinitionResponse as ForecastDefinitionList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ForecastDefinitionResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ForecastDefinitionResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ForecastDefinitionResponse as MoTagSummary: %s", err.Error())
		}
	}
