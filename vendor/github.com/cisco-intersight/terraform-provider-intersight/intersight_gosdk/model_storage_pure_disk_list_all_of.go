...
// StoragePureDiskListAllOf struct for StoragePureDiskListAllOf
type StoragePureDiskListAllOf struct {
...
type _StoragePureDiskListAllOf StoragePureDiskListAllOf
...
func (o StoragePureDiskListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StoragePureDiskListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStoragePureDiskListAllOf := _StoragePureDiskListAllOf{}

	if err = json.Unmarshal(bytes, &varStoragePureDiskListAllOf); err == nil {
		*o = StoragePureDiskListAllOf(varStoragePureDiskListAllOf)
	}
...
type NullableStoragePureDiskListAllOf struct {
	value *StoragePureDiskListAllOf
	isSet bool
}

func (v NullableStoragePureDiskListAllOf) Get() *StoragePureDiskListAllOf {
	return v.value
}

func (v *NullableStoragePureDiskListAllOf) Set(val *StoragePureDiskListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePureDiskListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePureDiskListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePureDiskListAllOf(val *StoragePureDiskListAllOf) *NullableStoragePureDiskListAllOf {
	return &NullableStoragePureDiskListAllOf{value: val, isSet: true}
}

func (v NullableStoragePureDiskListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePureDiskListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
