...
// VirtualizationStorageCapacityAllOf Definition of the list of properties defined in 'virtualization.StorageCapacity', excluding properties defined in parent classes.
type VirtualizationStorageCapacityAllOf struct {
...
type _VirtualizationStorageCapacityAllOf VirtualizationStorageCapacityAllOf
...
func NewVirtualizationStorageCapacityAllOf() *VirtualizationStorageCapacityAllOf {
	this := VirtualizationStorageCapacityAllOf{}
	return &this
}
...
func (o VirtualizationStorageCapacityAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationStorageCapacityAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationStorageCapacityAllOf := _VirtualizationStorageCapacityAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationStorageCapacityAllOf); err == nil {
		*o = VirtualizationStorageCapacityAllOf(varVirtualizationStorageCapacityAllOf)
	}
...
type NullableVirtualizationStorageCapacityAllOf struct {
	value *VirtualizationStorageCapacityAllOf
	isSet bool
}

func (v NullableVirtualizationStorageCapacityAllOf) Get() *VirtualizationStorageCapacityAllOf {
	return v.value
}

func (v *NullableVirtualizationStorageCapacityAllOf) Set(val *VirtualizationStorageCapacityAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationStorageCapacityAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationStorageCapacityAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationStorageCapacityAllOf(val *VirtualizationStorageCapacityAllOf) *NullableVirtualizationStorageCapacityAllOf {
	return &NullableVirtualizationStorageCapacityAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationStorageCapacityAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationStorageCapacityAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
