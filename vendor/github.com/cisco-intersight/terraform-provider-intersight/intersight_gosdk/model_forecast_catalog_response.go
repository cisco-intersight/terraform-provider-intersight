...
func (dst *ForecastCatalogResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "forecast.Catalog.List" {
		// try to unmarshal JSON data into ForecastCatalogList
		err = json.Unmarshal(data, &dst.ForecastCatalogList)
		if err == nil {
			return nil // data stored in dst.ForecastCatalogList, return on the first match
		} else {
			dst.ForecastCatalogList = nil
			return fmt.Errorf("Failed to unmarshal ForecastCatalogResponse as ForecastCatalogList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ForecastCatalogResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ForecastCatalogResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ForecastCatalogResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src ForecastCatalogResponse) MarshalJSON() ([]byte, error) {
	if src.ForecastCatalogList != nil {
		return json.Marshal(&src.ForecastCatalogList)
	}
...
type NullableForecastCatalogResponse struct {
	value *ForecastCatalogResponse
	isSet bool
}

func (v NullableForecastCatalogResponse) Get() *ForecastCatalogResponse {
	return v.value
}

func (v *NullableForecastCatalogResponse) Set(val *ForecastCatalogResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableForecastCatalogResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableForecastCatalogResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableForecastCatalogResponse(val *ForecastCatalogResponse) *NullableForecastCatalogResponse {
	return &NullableForecastCatalogResponse{value: val, isSet: true}
}

func (v NullableForecastCatalogResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableForecastCatalogResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
