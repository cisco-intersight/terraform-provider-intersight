...
func (o *PoolAbstractLease) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varPoolAbstractLease.AssignedToMoid = varPoolAbstractLeaseWithoutEmbeddedStruct.AssignedToMoid
		varPoolAbstractLease.AssignedToType = varPoolAbstractLeaseWithoutEmbeddedStruct.AssignedToType
