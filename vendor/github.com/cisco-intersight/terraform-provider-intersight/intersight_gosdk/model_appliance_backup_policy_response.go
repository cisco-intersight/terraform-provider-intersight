...
func (dst *ApplianceBackupPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "appliance.BackupPolicy.List" {
		// try to unmarshal JSON data into ApplianceBackupPolicyList
		err = json.Unmarshal(data, &dst.ApplianceBackupPolicyList)
		if err == nil {
			return nil // data stored in dst.ApplianceBackupPolicyList, return on the first match
		} else {
			dst.ApplianceBackupPolicyList = nil
			return fmt.Errorf("Failed to unmarshal ApplianceBackupPolicyResponse as ApplianceBackupPolicyList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ApplianceBackupPolicyResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ApplianceBackupPolicyResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ApplianceBackupPolicyResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src ApplianceBackupPolicyResponse) MarshalJSON() ([]byte, error) {
	if src.ApplianceBackupPolicyList != nil {
		return json.Marshal(&src.ApplianceBackupPolicyList)
	}
...
type NullableApplianceBackupPolicyResponse struct {
	value *ApplianceBackupPolicyResponse
	isSet bool
}

func (v NullableApplianceBackupPolicyResponse) Get() *ApplianceBackupPolicyResponse {
	return v.value
}

func (v *NullableApplianceBackupPolicyResponse) Set(val *ApplianceBackupPolicyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableApplianceBackupPolicyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableApplianceBackupPolicyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplianceBackupPolicyResponse(val *ApplianceBackupPolicyResponse) *NullableApplianceBackupPolicyResponse {
	return &NullableApplianceBackupPolicyResponse{value: val, isSet: true}
}

func (v NullableApplianceBackupPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplianceBackupPolicyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
