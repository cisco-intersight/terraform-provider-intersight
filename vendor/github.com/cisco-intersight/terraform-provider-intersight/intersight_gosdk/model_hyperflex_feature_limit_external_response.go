...
func (dst *HyperflexFeatureLimitExternalResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "hyperflex.FeatureLimitExternal.List" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexFeatureLimitExternalResponse as HyperflexFeatureLimitExternalList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexFeatureLimitExternalResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexFeatureLimitExternalResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexFeatureLimitExternalResponse as MoTagSummary: %s", err.Error())
		}
	}
