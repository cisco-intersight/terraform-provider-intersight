...
func (dst *HyperflexClusterNetworkPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "hyperflex.ClusterNetworkPolicy.List" {
		// try to unmarshal JSON data into HyperflexClusterNetworkPolicyList
		err = json.Unmarshal(data, &dst.HyperflexClusterNetworkPolicyList)
		if err == nil {
			return nil // data stored in dst.HyperflexClusterNetworkPolicyList, return on the first match
		} else {
			dst.HyperflexClusterNetworkPolicyList = nil
			return fmt.Errorf("Failed to unmarshal HyperflexClusterNetworkPolicyResponse as HyperflexClusterNetworkPolicyList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexClusterNetworkPolicyResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexClusterNetworkPolicyResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexClusterNetworkPolicyResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src HyperflexClusterNetworkPolicyResponse) MarshalJSON() ([]byte, error) {
	if src.HyperflexClusterNetworkPolicyList != nil {
		return json.Marshal(&src.HyperflexClusterNetworkPolicyList)
	}
...
type NullableHyperflexClusterNetworkPolicyResponse struct {
	value *HyperflexClusterNetworkPolicyResponse
	isSet bool
}

func (v NullableHyperflexClusterNetworkPolicyResponse) Get() *HyperflexClusterNetworkPolicyResponse {
	return v.value
}

func (v *NullableHyperflexClusterNetworkPolicyResponse) Set(val *HyperflexClusterNetworkPolicyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperflexClusterNetworkPolicyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperflexClusterNetworkPolicyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperflexClusterNetworkPolicyResponse(val *HyperflexClusterNetworkPolicyResponse) *NullableHyperflexClusterNetworkPolicyResponse {
	return &NullableHyperflexClusterNetworkPolicyResponse{value: val, isSet: true}
}

func (v NullableHyperflexClusterNetworkPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperflexClusterNetworkPolicyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
