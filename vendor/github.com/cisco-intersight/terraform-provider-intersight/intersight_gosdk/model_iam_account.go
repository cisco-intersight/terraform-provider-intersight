...
type IamAccount struct {
	...
	Var2LicenseReservationOp *LicenseLicenseReservationOpRelationship `json:"_2_LicenseReservationOp,omitempty"`
...
func (o *IamAccount) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varIamAccount.Var2LicenseReservationOp = varIamAccountWithoutEmbeddedStruct.Var2LicenseReservationOp
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_2_LicenseReservationOp")
