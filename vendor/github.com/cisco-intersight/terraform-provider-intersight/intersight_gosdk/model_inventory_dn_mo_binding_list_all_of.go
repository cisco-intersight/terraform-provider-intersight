...
type _InventoryDnMoBindingListAllOf InventoryDnMoBindingListAllOf
...
func (o *InventoryDnMoBindingListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varInventoryDnMoBindingListAllOf := _InventoryDnMoBindingListAllOf{}

	if err = json.Unmarshal(bytes, &varInventoryDnMoBindingListAllOf); err == nil {
		*o = InventoryDnMoBindingListAllOf(varInventoryDnMoBindingListAllOf)
	}
