...
type _CommIpV6InterfaceAllOf CommIpV6InterfaceAllOf
...
func (o *CommIpV6InterfaceAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCommIpV6InterfaceAllOf := _CommIpV6InterfaceAllOf{}

	if err = json.Unmarshal(bytes, &varCommIpV6InterfaceAllOf); err == nil {
		*o = CommIpV6InterfaceAllOf(varCommIpV6InterfaceAllOf)
	}
