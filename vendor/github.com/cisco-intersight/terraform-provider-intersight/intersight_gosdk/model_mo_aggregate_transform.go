...
// MoAggregateTransform The output of a request that includes the $apply query parameter. The schema of an aggregation query is dynamically determined based on the request query parameters.  See https://qa.starshipcloud.com/apidocs/introduction/query/#apply-query-option for more details.
