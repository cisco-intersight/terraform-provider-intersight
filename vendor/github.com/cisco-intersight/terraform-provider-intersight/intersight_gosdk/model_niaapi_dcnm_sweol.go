...
func (o *NiaapiDcnmSweol) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varNiaapiDcnmSweolWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varNiaapiDcnmSweol)
	if err == nil {
