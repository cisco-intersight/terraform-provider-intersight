...
type _TelemetryDruidHavingDimensionSelectorFilterAllOf TelemetryDruidHavingDimensionSelectorFilterAllOf
...
func (o *TelemetryDruidHavingDimensionSelectorFilterAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varTelemetryDruidHavingDimensionSelectorFilterAllOf := _TelemetryDruidHavingDimensionSelectorFilterAllOf{}

	if err = json.Unmarshal(bytes, &varTelemetryDruidHavingDimensionSelectorFilterAllOf); err == nil {
		*o = TelemetryDruidHavingDimensionSelectorFilterAllOf(varTelemetryDruidHavingDimensionSelectorFilterAllOf)
	}
