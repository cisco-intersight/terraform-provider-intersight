...
func (dst *FabricPortModeResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "fabric.PortMode.List" {
		// try to unmarshal JSON data into FabricPortModeList
		err = json.Unmarshal(data, &dst.FabricPortModeList)
		if err == nil {
			return nil // data stored in dst.FabricPortModeList, return on the first match
		} else {
			dst.FabricPortModeList = nil
			return fmt.Errorf("Failed to unmarshal FabricPortModeResponse as FabricPortModeList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FabricPortModeResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FabricPortModeResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FabricPortModeResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src FabricPortModeResponse) MarshalJSON() ([]byte, error) {
	if src.FabricPortModeList != nil {
		return json.Marshal(&src.FabricPortModeList)
	}
...
type NullableFabricPortModeResponse struct {
	value *FabricPortModeResponse
	isSet bool
}

func (v NullableFabricPortModeResponse) Get() *FabricPortModeResponse {
	return v.value
}

func (v *NullableFabricPortModeResponse) Set(val *FabricPortModeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFabricPortModeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFabricPortModeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFabricPortModeResponse(val *FabricPortModeResponse) *NullableFabricPortModeResponse {
	return &NullableFabricPortModeResponse{value: val, isSet: true}
}

func (v NullableFabricPortModeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFabricPortModeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
