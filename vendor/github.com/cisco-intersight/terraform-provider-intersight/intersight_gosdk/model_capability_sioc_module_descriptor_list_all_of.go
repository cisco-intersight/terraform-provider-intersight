...
type _CapabilitySiocModuleDescriptorListAllOf CapabilitySiocModuleDescriptorListAllOf
...
func (o *CapabilitySiocModuleDescriptorListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCapabilitySiocModuleDescriptorListAllOf := _CapabilitySiocModuleDescriptorListAllOf{}

	if err = json.Unmarshal(bytes, &varCapabilitySiocModuleDescriptorListAllOf); err == nil {
		*o = CapabilitySiocModuleDescriptorListAllOf(varCapabilitySiocModuleDescriptorListAllOf)
	}
