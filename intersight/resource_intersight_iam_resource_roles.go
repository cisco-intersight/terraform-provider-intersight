...
func resourceIamResourceRoles() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"permission": {
				Description: "A collection of references to the [iam.Permission](mo://iam.Permission) Managed Object.When this managed object is deleted, the referenced [iam.Permission](mo://iam.Permission) MO unsets its reference to this deleted MO.",
				Type:        schema.TypeList,
				MaxItems:    1,
				Optional:    true,
				Elem: &schema.Resource{
...
func resourceIamResourceRolesRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err := d.Set("resource", flattenMapMoBaseMoRef(s.Resource, d)); err != nil {
		return err
	}
