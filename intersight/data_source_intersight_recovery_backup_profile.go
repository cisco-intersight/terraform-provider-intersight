...
func dataSourceRecoveryBackupProfile() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"backup_config": {
				Description: "A collection of references to the [recovery.BackupConfigPolicy](mo://recovery.BackupConfigPolicy) Managed Object.When this managed object is deleted, the referenced [recovery.BackupConfigPolicy](mo://recovery.BackupConfigPolicy) MO unsets its reference to this deleted MO.",
			...
			"schedule_config": {
				Description: "A collection of references to the [recovery.ScheduleConfigPolicy](mo://recovery.ScheduleConfigPolicy) Managed Object.When this managed object is deleted, the referenced [recovery.ScheduleConfigPolicy](mo://recovery.ScheduleConfigPolicy) MO unsets its reference to this deleted MO.",
				Type:        schema.TypeList,
				MaxItems:    1,
				Optional:    true,
				Elem: &schema.Resource{
