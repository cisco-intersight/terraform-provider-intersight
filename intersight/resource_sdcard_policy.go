				...
				if v, ok := l["additional_properties"]; ok {
					{
						...
						if err == nil && x1 != nil {
							o.SdcardPartitionAO0P0.SdcardPartitionAO0P0 = x1.(map[string]interface{})
						}
					}
				}
				if v, ok := l["object_type"]; ok {
								...
								if v, ok := l["additional_properties"]; ok {
									{
										...
										err := json.Unmarshal(x, &x1)
										if err == nil && x1 != nil {
											o.SdcardVirtualDriveAO0P0.SdcardVirtualDriveAO0P0 = x1.(map[string]interface{})
										}
									}
								}
								if v, ok := l["enable"]; ok {
...
func resourceSdcardPolicyDelete(d *schema.ResourceData, meta interface{}) error {
	...
	conn := meta.(*Config)
	url := "sdcard/Policies" + "/" + d.Id()
	detachSdcardPolicyProfiles(d, meta)
