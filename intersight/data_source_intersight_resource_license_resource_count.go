...
func dataSourceResourceLicenseResourceCountRead(d *schema.ResourceData, meta interface{}) error {
	...
	url := "resource/LicenseResourceCounts"
	...
	case reflect.Slice:
		...
		for i := 0; i < r.Len(); i++ {
			var s models.ResourceLicenseResourceCount
			...
			if err := d.Set("license_groups", flattenListResourceGroupRef(s.LicenseGroups, d)); err != nil {
				return err
			}
