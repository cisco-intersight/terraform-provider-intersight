...
func dataSourceMemoryArrayRead(d *schema.ResourceData, meta interface{}) error {
	...
	result, _, err := conn.ApiClient.MemoryApi.GetMemoryArrayList(conn.ctx).Filter(getRequestParams(data)).Execute()
	if err != nil {
