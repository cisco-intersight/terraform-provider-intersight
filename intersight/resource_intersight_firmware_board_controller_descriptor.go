...
func resourceFirmwareBoardControllerDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceFirmwareBoardControllerDescriptorCreate,
		Read:   resourceFirmwareBoardControllerDescriptorRead,
		Update: resourceFirmwareBoardControllerDescriptorUpdate,
		Delete: resourceFirmwareBoardControllerDescriptorDelete,
...
func resourceFirmwareBoardControllerDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewFirmwareBoardControllerDescriptorWithDefaults()
	...
	o.SetClassId("firmware.BoardControllerDescriptor")
	...
	o.SetObjectType("firmware.BoardControllerDescriptor")
	...
	r := conn.ApiClient.FirmwareApi.CreateFirmwareBoardControllerDescriptor(conn.ctx).FirmwareBoardControllerDescriptor(*o)
	...
	return resourceFirmwareBoardControllerDescriptorRead(d, meta)
}

func resourceFirmwareBoardControllerDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	...
	if err := d.Set("brand_string", (s.BrandString)); err != nil {
...
func resourceFirmwareBoardControllerDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewFirmwareBoardControllerDescriptorWithDefaults()
	...
	r := conn.ApiClient.FirmwareApi.UpdateFirmwareBoardControllerDescriptor(conn.ctx, d.Id()).FirmwareBoardControllerDescriptor(*o)
	result, _, err := r.Execute()
	if err != nil {
...
func resourceFirmwareBoardControllerDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	p := conn.ApiClient.FirmwareApi.DeleteFirmwareBoardControllerDescriptor(conn.ctx, d.Id())
	_, err := p.Execute()
	if err != nil {
