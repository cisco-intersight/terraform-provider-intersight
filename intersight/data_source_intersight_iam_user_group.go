...
func dataSourceIamUserGroupRead(d *schema.ResourceData, meta interface{}) error {
	...
	result, _, err := conn.ApiClient.IamApi.GetIamUserGroupList(conn.ctx).Filter(getRequestParams(data)).Execute()
	if err != nil {
