...
func dataSourceStoragePhysicalDiskExtensionRead(d *schema.ResourceData, meta interface{}) error {
	...
	url := "storage/PhysicalDiskExtensions"
	var o models.StoragePhysicalDiskExtension
	...
	case reflect.Slice:
		...
		for i := 0; i < r.Len(); i++ {
			var s models.StoragePhysicalDiskExtension
			...
			if err := d.Set("physical_disk", flattenMapStoragePhysicalDiskRef(s.PhysicalDisk, d)); err != nil {
				return err
			}
