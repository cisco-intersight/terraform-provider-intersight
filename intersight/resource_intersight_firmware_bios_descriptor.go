...
func resourceFirmwareBiosDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceFirmwareBiosDescriptorCreate,
		Read:   resourceFirmwareBiosDescriptorRead,
		Update: resourceFirmwareBiosDescriptorUpdate,
		Delete: resourceFirmwareBiosDescriptorDelete,
...
func resourceFirmwareBiosDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	...
	o.SetClassId("firmware.BiosDescriptor")
	...
	o.SetObjectType("firmware.BiosDescriptor")
	...
	return resourceFirmwareBiosDescriptorRead(d, meta)
}

func resourceFirmwareBiosDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFirmwareBiosDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewFirmwareBiosDescriptorWithDefaults()
...
func resourceFirmwareBiosDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
