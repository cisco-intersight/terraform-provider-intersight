			...
			if v, ok := l["additional_properties"]; ok {
				{
					...
					if err == nil && x1 != nil {
						o.IamLdapBasePropertiesAO0P0.IamLdapBasePropertiesAO0P0 = x1.(map[string]interface{})
					}
				}
			}
			...
			if v, ok := l["additional_properties"]; ok {
				{
					...
					err := json.Unmarshal(x, &x1)
					if err == nil && x1 != nil {
						o.IamLdapDNSParametersAO0P0.IamLdapDNSParametersAO0P0 = x1.(map[string]interface{})
					}
				}
			}
			if v, ok := l["object_type"]; ok {
