				...
				if v, ok := l["additional_properties"]; ok {
					{
						...
						if err == nil && x1 != nil {
							o.AdapterAdapterConfigAO0P0.AdapterAdapterConfigAO0P0 = x1.(map[string]interface{})
						}
					}
				}
							...
							if v, ok := l["additional_properties"]; ok {
								{
									...
									err := json.Unmarshal(x, &x1)
									if err == nil && x1 != nil {
										o.AdapterEthSettingsAO0P0.AdapterEthSettingsAO0P0 = x1.(map[string]interface{})
									}
								}
							}
							...
							if v, ok := l["additional_properties"]; ok {
								{
									...
									err := json.Unmarshal(x, &x1)
									if err == nil && x1 != nil {
										o.AdapterFcSettingsAO0P0.AdapterFcSettingsAO0P0 = x1.(map[string]interface{})
									}
								}
							}
