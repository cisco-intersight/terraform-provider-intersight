...
func dataSourcePciLink() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"pci_switch": {
				Description: "A collection of references to the [pci.Switch](mo://pci.Switch) Managed Object.When this managed object is deleted, the referenced [pci.Switch](mo://pci.Switch) MO unsets its reference to this deleted MO.",
...
func dataSourcePciLinkRead(d *schema.ResourceData, meta interface{}) error {
	...
	case reflect.Slice:
		...
		for i := 0; i < r.Len(); i++ {
			...
			if err := d.Set("adapter", (s.Adapter)); err != nil {
				return err
			}
			...
			if err := d.Set("link_status", (s.LinkStatus)); err != nil {
				return err
			}
			if err := d.Set("link_width", (s.LinkWidth)); err != nil {
				return err
			}
			...
			if err := d.Set("pci_switch", flattenMapPciSwitchRef(s.PciSwitch, d)); err != nil {
				return err
			}
			...
			if err := d.Set("slot_status", (s.SlotStatus)); err != nil {
				return err
			}
