...
func resourceFirmwareHbaDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceFirmwareHbaDescriptorCreate,
		Read:   resourceFirmwareHbaDescriptorRead,
		Update: resourceFirmwareHbaDescriptorUpdate,
		Delete: resourceFirmwareHbaDescriptorDelete,
...
func resourceFirmwareHbaDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewFirmwareHbaDescriptorWithDefaults()
	...
	o.SetClassId("firmware.HbaDescriptor")
	...
	o.SetObjectType("firmware.HbaDescriptor")
	...
	return resourceFirmwareHbaDescriptorRead(d, meta)
}

func resourceFirmwareHbaDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFirmwareHbaDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewFirmwareHbaDescriptorWithDefaults()
...
func resourceFirmwareHbaDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
