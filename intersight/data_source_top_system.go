...
func dataSourceTopSystemRead(d *schema.ResourceData, meta interface{}) error {
	...
	case reflect.Slice:
		...
		for i := 0; i < r.Len(); i++ {
			...
			if err := d.Set("compute_blades", flattenListComputeBladeRef(s.ComputeBlades, d)); err != nil {
				return err
			}

			if err := d.Set("compute_rack_units", flattenListComputeRackUnitRef(s.ComputeRackUnits, d)); err != nil {
				return err
			}
