	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"storage_sas_expander": {
				Description: "A collection of references to the [storage.SasExpander](mo://storage.SasExpander) Managed Object.When this managed object is deleted, the referenced [storage.SasExpander](mo://storage.SasExpander) MO unsets its reference to this deleted MO.",
				Type:        schema.TypeList,
				MaxItems:    1,
				Optional:    true,
				Computed:    true,
...
func dataSourceManagementControllerRead(d *schema.ResourceData, meta interface{}) error {
	...
	var o models.ManagementController
	...
	case reflect.Slice:
		...
		for i := 0; i < r.Len(); i++ {
			var s models.ManagementController
			...
			if err := d.Set("management_interfaces", flattenListManagementInterfaceRef(s.ManagementInterfaces, d)); err != nil {
				return err
			}
			...
			if err := d.Set("storage_sas_expander", flattenMapStorageSasExpanderRef(s.StorageSasExpander, d)); err != nil {
				return err
			}
