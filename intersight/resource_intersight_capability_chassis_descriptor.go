...
func resourceCapabilityChassisDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceCapabilityChassisDescriptorCreate,
		Read:   resourceCapabilityChassisDescriptorRead,
		Update: resourceCapabilityChassisDescriptorUpdate,
		Delete: resourceCapabilityChassisDescriptorDelete,
...
func resourceCapabilityChassisDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	...
	o.SetClassId("capability.ChassisDescriptor")
	...
	o.SetObjectType("capability.ChassisDescriptor")
	...
	r := conn.ApiClient.CapabilityApi.CreateCapabilityChassisDescriptor(conn.ctx).CapabilityChassisDescriptor(*o)
	...
	return resourceCapabilityChassisDescriptorRead(d, meta)
}

func resourceCapabilityChassisDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceCapabilityChassisDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewCapabilityChassisDescriptorWithDefaults()
	...
	r := conn.ApiClient.CapabilityApi.UpdateCapabilityChassisDescriptor(conn.ctx, d.Id()).CapabilityChassisDescriptor(*o)
	result, _, err := r.Execute()
	if err != nil {
...
func resourceCapabilityChassisDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
