...
func resourceCapabilitySiocModuleManufacturingDef() *schema.Resource {
	return &schema.Resource{
		Create: resourceCapabilitySiocModuleManufacturingDefCreate,
		Read:   resourceCapabilitySiocModuleManufacturingDefRead,
		Update: resourceCapabilitySiocModuleManufacturingDefUpdate,
		Delete: resourceCapabilitySiocModuleManufacturingDefDelete,
...
func resourceCapabilitySiocModuleManufacturingDefCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceCapabilitySiocModuleManufacturingDefRead(d, meta)
}

func resourceCapabilitySiocModuleManufacturingDefRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceCapabilitySiocModuleManufacturingDefUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewCapabilitySiocModuleManufacturingDefWithDefaults()
...
func resourceCapabilitySiocModuleManufacturingDefDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
