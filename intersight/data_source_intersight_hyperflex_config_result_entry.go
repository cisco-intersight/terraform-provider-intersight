...
func dataSourceHyperflexConfigResultEntry() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"config_result": {
				Description: "A collection of references to the [hyperflex.ConfigResult](mo://hyperflex.ConfigResult) Managed Object.When this managed object is deleted, the referenced [hyperflex.ConfigResult](mo://hyperflex.ConfigResult) MO unsets its reference to this deleted MO.",
...
func dataSourceHyperflexConfigResultEntryRead(d *schema.ResourceData, meta interface{}) error {
	...
	url := "hyperflex/ConfigResultEntries"
	var o models.HyperflexConfigResultEntry
	...
	case reflect.Slice:
		...
		for i := 0; i < r.Len(); i++ {
			var s models.HyperflexConfigResultEntry
