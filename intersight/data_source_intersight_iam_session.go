...
func dataSourceIamSessionRead(d *schema.ResourceData, meta interface{}) error {
	...
	result, _, err := conn.ApiClient.IamApi.GetIamSessionList(conn.ctx).Filter(getRequestParams(data)).Execute()
	if err != nil {
