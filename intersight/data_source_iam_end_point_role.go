...
func dataSourceIamEndPointRoleRead(d *schema.ResourceData, meta interface{}) error {
	...
	case reflect.Slice:
		...
		for i := 0; i < r.Len(); i++ {
			...
			if err := d.Set("end_point_privileges", flattenListIamEndPointPrivilegeRef(s.EndPointPrivileges, d)); err != nil {
				return err
			}
			...
			if err := d.Set("role_type", (s.RoleType)); err != nil {
				return err
			}
