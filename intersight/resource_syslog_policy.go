				...
				if v, ok := l["additional_properties"]; ok {
					{
						...
						if err == nil && x1 != nil {
							o.SyslogLocalClientBaseAO0P0.SyslogLocalClientBaseAO0P0 = x1.(map[string]interface{})
						}
					}
				}
				...
				if v, ok := l["additional_properties"]; ok {
					{
						...
						err := json.Unmarshal(x, &x1)
						if err == nil && x1 != nil {
							o.SyslogRemoteClientBaseAO0P0.SyslogRemoteClientBaseAO0P0 = x1.(map[string]interface{})
						}
					}
				}
