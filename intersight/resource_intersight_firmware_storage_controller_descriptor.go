...
func resourceFirmwareStorageControllerDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceFirmwareStorageControllerDescriptorCreate,
		Read:   resourceFirmwareStorageControllerDescriptorRead,
...
func resourceFirmwareStorageControllerDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	...
	o.SetClassId("firmware.StorageControllerDescriptor")
	...
	o.SetObjectType("firmware.StorageControllerDescriptor")
	...
	return resourceFirmwareStorageControllerDescriptorRead(d, meta)
}

func resourceFirmwareStorageControllerDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFirmwareStorageControllerDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewFirmwareStorageControllerDescriptorWithDefaults()
...
func resourceFirmwareStorageControllerDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
