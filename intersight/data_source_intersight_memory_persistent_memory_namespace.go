	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"memory_persistent_memory_region": {
				Description: "A collection of references to the [memory.PersistentMemoryRegion](mo://memory.PersistentMemoryRegion) Managed Object.When this managed object is deleted, the referenced [memory.PersistentMemoryRegion](mo://memory.PersistentMemoryRegion) MO unsets its reference to this deleted MO.",
...
func dataSourceMemoryPersistentMemoryNamespaceRead(d *schema.ResourceData, meta interface{}) error {
	...
	url := "memory/PersistentMemoryNamespaces"
	...
	case reflect.Slice:
		...
		for i := 0; i < r.Len(); i++ {
			...
			if err := d.Set("memory_persistent_memory_region", flattenMapMemoryPersistentMemoryRegionRef(s.MemoryPersistentMemoryRegion, d)); err != nil {
				return err
			}
