...
func resourceCapabilityIoCardCapabilityDef() *schema.Resource {
	return &schema.Resource{
		Create: resourceCapabilityIoCardCapabilityDefCreate,
		Read:   resourceCapabilityIoCardCapabilityDefRead,
		Update: resourceCapabilityIoCardCapabilityDefUpdate,
		Delete: resourceCapabilityIoCardCapabilityDefDelete,
...
func resourceCapabilityIoCardCapabilityDefCreate(d *schema.ResourceData, meta interface{}) error {
	...
	o.SetObjectType("capability.IoCardCapabilityDef")
	...
	return resourceCapabilityIoCardCapabilityDefRead(d, meta)
}

func resourceCapabilityIoCardCapabilityDefRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	...
	if err := d.Set("dc_supported", (s.DcSupported)); err != nil {
...
func resourceCapabilityIoCardCapabilityDefUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewCapabilityIoCardCapabilityDefWithDefaults()
	...
	if d.HasChange("dc_supported") {
		v := d.Get("dc_supported")
		x := (v.(bool))
		o.SetDcSupported(x)
	}
...
func resourceCapabilityIoCardCapabilityDefDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
