...
func dataSourceEquipmentFan() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceEquipmentFanRead,
		Schema: map[string]*schema.Schema{
			...
			"equipment_fan_module": {
				Description: "A collection of references to the [equipment.FanModule](mo://equipment.FanModule) Managed Object.When this managed object is deleted, the referenced [equipment.FanModule](mo://equipment.FanModule) MO unsets its reference to this deleted MO.",
...
func dataSourceEquipmentFanRead(d *schema.ResourceData, meta interface{}) error {
	...
	case reflect.Slice:
		...
		for i := 0; i < r.Len(); i++ {
			...
			if err := d.Set("equipment_fan_module", flattenMapEquipmentFanModuleRef(s.EquipmentFanModule, d)); err != nil {
				return err
			}
