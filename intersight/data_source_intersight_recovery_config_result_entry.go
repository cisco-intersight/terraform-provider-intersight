...
func dataSourceRecoveryConfigResultEntry() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"config_result": {
				Description: "A collection of references to the [recovery.ConfigResult](mo://recovery.ConfigResult) Managed Object.When this managed object is deleted, the referenced [recovery.ConfigResult](mo://recovery.ConfigResult) MO unsets its reference to this deleted MO.",
...
func dataSourceRecoveryConfigResultEntryRead(d *schema.ResourceData, meta interface{}) error {
	...
	url := "recovery/ConfigResultEntries"
