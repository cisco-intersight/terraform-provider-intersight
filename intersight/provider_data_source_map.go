...
func GetDataSourceMapping() map[string]*schema.Resource {
	return map[string]*schema.Resource{
		...
		"intersight_capability_section":                                  dataSourceCapabilitySection(),
		...
		"intersight_fabric_qos_policy":                                   dataSourceFabricQosPolicy(),
		...
		"intersight_hyperflex_hxap_event":                                dataSourceHyperflexHxapEvent(),
		...
		"intersight_inventory_uem_connection":                            dataSourceInventoryUemConnection(),
		...
		"intersight_kvm_kvm_session":                                     dataSourceKvmKvmSession(),
