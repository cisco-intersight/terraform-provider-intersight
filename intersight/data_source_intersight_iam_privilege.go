...
func dataSourceIamPrivilegeRead(d *schema.ResourceData, meta interface{}) error {
	...
	result, _, err := conn.ApiClient.IamApi.GetIamPrivilegeList(conn.ctx).Filter(getRequestParams(data)).Execute()
	if err != nil {
