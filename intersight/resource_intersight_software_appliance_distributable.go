...
func resourceSoftwareApplianceDistributable() *schema.Resource {
	return &schema.Resource{
		Create: resourceSoftwareApplianceDistributableCreate,
		Read:   resourceSoftwareApplianceDistributableRead,
		Update: resourceSoftwareApplianceDistributableUpdate,
		Delete: resourceSoftwareApplianceDistributableDelete,
...
func resourceSoftwareApplianceDistributableCreate(d *schema.ResourceData, meta interface{}) error {
	...
	o.SetClassId("software.ApplianceDistributable")
	...
	o.SetObjectType("software.ApplianceDistributable")
	...
	r := conn.ApiClient.SoftwareApi.CreateSoftwareApplianceDistributable(conn.ctx).SoftwareApplianceDistributable(*o)
	...
	return resourceSoftwareApplianceDistributableRead(d, meta)
}

func resourceSoftwareApplianceDistributableRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)

	r := conn.ApiClient.SoftwareApi.GetSoftwareApplianceDistributableByMoid(conn.ctx, d.Id())
	s, _, err := r.Execute()
...
func resourceSoftwareApplianceDistributableUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewSoftwareApplianceDistributableWithDefaults()
	...
	r := conn.ApiClient.SoftwareApi.UpdateSoftwareApplianceDistributable(conn.ctx, d.Id()).SoftwareApplianceDistributable(*o)
	result, _, err := r.Execute()
	if err != nil {
...
func resourceSoftwareApplianceDistributableDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	p := conn.ApiClient.SoftwareApi.DeleteSoftwareApplianceDistributable(conn.ctx, d.Id())
	_, err := p.Execute()
	if err != nil {
