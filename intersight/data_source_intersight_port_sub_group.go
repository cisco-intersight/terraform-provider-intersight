...
func dataSourcePortSubGroupRead(d *schema.ResourceData, meta interface{}) error {
	...
	result, _, err := conn.ApiClient.PortApi.GetPortSubGroupList(conn.ctx).Filter(getRequestParams(data)).Execute()
	if err != nil {
