...
func resourceHyperflexLocalCredentialPolicyCreate(d *schema.ResourceData, meta interface{}) error {
	...
	url := "hyperflex/LocalCredentialPolicies"
...
func resourceHyperflexLocalCredentialPolicyRead(d *schema.ResourceData, meta interface{}) error {
	...
	url := "hyperflex/LocalCredentialPolicies" + "/" + d.Id()
	...
	if err := d.Set("hxdp_root_pwd", (s.HxdpRootPwd)); err != nil {
		return err
	}
	...
	if err := d.Set("hypervisor_admin_pwd", (s.HypervisorAdminPwd)); err != nil {
		return err
	}
