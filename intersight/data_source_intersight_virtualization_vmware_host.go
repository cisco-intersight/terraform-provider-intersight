...
func dataSourceVirtualizationVmwareHost() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"datastores": {
				Description: "A collection of references to the [virtualization.VmwareDatastore](mo://virtualization.VmwareDatastore) Managed Object.When this managed object is deleted, the referenced [virtualization.VmwareDatastore](mo://virtualization.VmwareDatastore) MOs unset their reference to this deleted MO.",
				Type:        schema.TypeList,
				Optional:    true,
				Computed:    true,
				Elem: &schema.Resource{
