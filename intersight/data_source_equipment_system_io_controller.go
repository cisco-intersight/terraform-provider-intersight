...
func dataSourceEquipmentSystemIoControllerRead(d *schema.ResourceData, meta interface{}) error {
	...
	url := "equipment/SystemIoControllers"
	...
	case reflect.Slice:
		...
		for i := 0; i < r.Len(); i++ {
			...
			if err := d.Set("shared_io_module", flattenMapEquipmentSharedIoModuleRef(s.SharedIoModule, d)); err != nil {
				return err
			}
