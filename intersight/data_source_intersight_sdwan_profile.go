...
func dataSourceSdwanProfileRead(d *schema.ResourceData, meta interface{}) error {
	...
	result, _, err := conn.ApiClient.SdwanApi.GetSdwanProfileList(conn.ctx).Filter(getRequestParams(data)).Execute()
	if err != nil {
