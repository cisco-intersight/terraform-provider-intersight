...
func dataSourceComputeBoardRead(d *schema.ResourceData, meta interface{}) error {
	...
	result, _, err := conn.ApiClient.ComputeApi.GetComputeBoardList(conn.ctx).Filter(getRequestParams(data)).Execute()
	if err != nil {
