...
func dataSourceUuidpoolUuidLeaseRead(d *schema.ResourceData, meta interface{}) error {
	...
	case reflect.Slice:
		...
		for i := 0; i < r.Len(); i++ {
			...
			if err := d.Set("pool_member", flattenMapUuidpoolPoolMemberRelationship(s.PoolMember, d)); err != nil {
			...
			if err := d.Set("universe", flattenMapUuidpoolUniverseRelationship(s.Universe, d)); err != nil {
