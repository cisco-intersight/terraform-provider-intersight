...
func resourceHyperflexServerFirmwareVersionCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("server_firmware_version_entries"); ok {
				...
				if v, ok := l["additional_properties"]; ok {
					{
						...
						if err == nil && x1 != nil {
							o.HyperflexAbstractAppSettingAO0P0.HyperflexAbstractAppSettingAO0P0 = x1.(map[string]interface{})
						}
					}
				}
							...
							if v, ok := l["additional_properties"]; ok {
								{
									...
									err := json.Unmarshal(x, &x1)
									if err == nil && x1 != nil {
										o.HyperflexAppSettingConstraintAO0P0.HyperflexAppSettingConstraintAO0P0 = x1.(map[string]interface{})
									}
								}
							}
		...
		o.ServerFirmwareVersionEntries = x
	...
	url := "hyperflex/ServerFirmwareVersions"
...
func resourceHyperflexServerFirmwareVersionRead(d *schema.ResourceData, meta interface{}) error {
	...
	url := "hyperflex/ServerFirmwareVersions" + "/" + d.Id()

	body, err := conn.SendGetRequest(url, []byte(""))
	if err != nil {
		return err
	}
	var s models.HyperflexServerFirmwareVersion
