...
func resourceCapabilityPsuManufacturingDef() *schema.Resource {
	return &schema.Resource{
		Create: resourceCapabilityPsuManufacturingDefCreate,
		Read:   resourceCapabilityPsuManufacturingDefRead,
...
func resourceCapabilityPsuManufacturingDefCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceCapabilityPsuManufacturingDefRead(d, meta)
}

func resourceCapabilityPsuManufacturingDefRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceCapabilityPsuManufacturingDefUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewCapabilityPsuManufacturingDefWithDefaults()
...
func resourceCapabilityPsuManufacturingDefDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
