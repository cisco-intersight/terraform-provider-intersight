	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"memory_persistent_memory_config_result": {
				Description: "A collection of references to the [memory.PersistentMemoryConfigResult](mo://memory.PersistentMemoryConfigResult) Managed Object.When this managed object is deleted, the referenced [memory.PersistentMemoryConfigResult](mo://memory.PersistentMemoryConfigResult) MO unsets its reference to this deleted MO.",
...
func dataSourceMemoryPersistentMemoryNamespaceConfigResultRead(d *schema.ResourceData, meta interface{}) error {
	...
	url := "memory/PersistentMemoryNamespaceConfigResults"
	...
	case reflect.Slice:
		...
		for i := 0; i < r.Len(); i++ {
			...
			if err := d.Set("config_status", (s.ConfigStatus)); err != nil {
				return err
			}
			...
			if err := d.Set("memory_persistent_memory_config_result", flattenMapMemoryPersistentMemoryConfigResultRef(s.MemoryPersistentMemoryConfigResult, d)); err != nil {
				return err
			}
