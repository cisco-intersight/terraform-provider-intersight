...
func dataSourceGraphicsController() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"graphics_card": {
				Description: "A collection of references to the [graphics.Card](mo://graphics.Card) Managed Object.When this managed object is deleted, the referenced [graphics.Card](mo://graphics.Card) MO unsets its reference to this deleted MO.",
...
func dataSourceGraphicsControllerRead(d *schema.ResourceData, meta interface{}) error {
	...
	url := "graphics/Controllers"
	var o models.GraphicsController
	...
	case reflect.Slice:
		...
		for i := 0; i < r.Len(); i++ {
			var s models.GraphicsController
			...
			if err := d.Set("graphics_card", flattenMapGraphicsCardRef(s.GraphicsCard, d)); err != nil {
				return err
			}
