...
func dataSourceVirtualizationVmwareClusterRead(d *schema.ResourceData, meta interface{}) error {
	...
	url := "virtualization/VmwareClusters"
	...
	case reflect.Slice:
		...
		for i := 0; i < r.Len(); i++ {
			var s models.VirtualizationVmwareCluster
