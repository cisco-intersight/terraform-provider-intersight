...
func dataSourceVirtualizationVmwareCluster() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"hosts": {
				Description: "A collection of references to the [virtualization.VmwareHost](mo://virtualization.VmwareHost) Managed Object.When this managed object is deleted, the referenced [virtualization.VmwareHost](mo://virtualization.VmwareHost) MOs unset their reference to this deleted MO.",
				Type:        schema.TypeList,
				Optional:    true,
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
