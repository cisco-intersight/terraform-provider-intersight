...
func resourceRecoveryScheduleConfigPolicyCreate(d *schema.ResourceData, meta interface{}) error {
			...
			if v, ok := l["additional_properties"]; ok {
				{
					...
					if err == nil && x1 != nil {
						o.RecoveryBackupScheduleAO1P1.RecoveryBackupScheduleAO1P1 = x1.(map[string]interface{})
					}
				}
			}
	...
	url := "recovery/ScheduleConfigPolicies"
...
func resourceRecoveryScheduleConfigPolicyRead(d *schema.ResourceData, meta interface{}) error {
	...
	url := "recovery/ScheduleConfigPolicies" + "/" + d.Id()
	...
	if err := d.Set("schedule", flattenMapRecoveryBackupSchedule(s.Schedule, d)); err != nil {
		return err
	}
