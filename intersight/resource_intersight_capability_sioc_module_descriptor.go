...
func resourceCapabilitySiocModuleDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceCapabilitySiocModuleDescriptorCreate,
		Read:   resourceCapabilitySiocModuleDescriptorRead,
		Update: resourceCapabilitySiocModuleDescriptorUpdate,
		Delete: resourceCapabilitySiocModuleDescriptorDelete,
...
func resourceCapabilitySiocModuleDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	...
	o.SetClassId("capability.SiocModuleDescriptor")
	...
	o.SetObjectType("capability.SiocModuleDescriptor")
	...
	r := conn.ApiClient.CapabilityApi.CreateCapabilitySiocModuleDescriptor(conn.ctx).CapabilitySiocModuleDescriptor(*o)
	...
	return resourceCapabilitySiocModuleDescriptorRead(d, meta)
}

func resourceCapabilitySiocModuleDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceCapabilitySiocModuleDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewCapabilitySiocModuleDescriptorWithDefaults()
	...
	r := conn.ApiClient.CapabilityApi.UpdateCapabilitySiocModuleDescriptor(conn.ctx, d.Id()).CapabilitySiocModuleDescriptor(*o)
	result, _, err := r.Execute()
	if err != nil {
...
func resourceCapabilitySiocModuleDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
