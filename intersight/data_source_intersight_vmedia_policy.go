...
func dataSourceVmediaPolicyRead(d *schema.ResourceData, meta interface{}) error {
	...
	result, _, err := conn.ApiClient.VmediaApi.GetVmediaPolicyList(conn.ctx).Filter(getRequestParams(data)).Execute()
	if err != nil {
