...
func dataSourceIamLdapGroupRead(d *schema.ResourceData, meta interface{}) error {
	...
	result, _, err := conn.ApiClient.IamApi.GetIamLdapGroupList(conn.ctx).Filter(getRequestParams(data)).Execute()
	if err != nil {
