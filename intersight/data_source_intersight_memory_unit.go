...
func dataSourceMemoryUnitRead(d *schema.ResourceData, meta interface{}) error {
	...
	result, _, err := conn.ApiClient.MemoryApi.GetMemoryUnitList(conn.ctx).Filter(getRequestParams(data)).Execute()
	if err != nil {
