...
// HclOperatingSystemVendorListAllOf struct for HclOperatingSystemVendorListAllOf
type HclOperatingSystemVendorListAllOf struct {
...
type _HclOperatingSystemVendorListAllOf HclOperatingSystemVendorListAllOf
...
func NewHclOperatingSystemVendorListAllOf() *HclOperatingSystemVendorListAllOf {
	this := HclOperatingSystemVendorListAllOf{}
	return &this
}
...
func (o HclOperatingSystemVendorListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *HclOperatingSystemVendorListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varHclOperatingSystemVendorListAllOf := _HclOperatingSystemVendorListAllOf{}

	if err = json.Unmarshal(bytes, &varHclOperatingSystemVendorListAllOf); err == nil {
		*o = HclOperatingSystemVendorListAllOf(varHclOperatingSystemVendorListAllOf)
	}
...
type NullableHclOperatingSystemVendorListAllOf struct {
	value *HclOperatingSystemVendorListAllOf
	isSet bool
}

func (v NullableHclOperatingSystemVendorListAllOf) Get() *HclOperatingSystemVendorListAllOf {
	return v.value
}

func (v *NullableHclOperatingSystemVendorListAllOf) Set(val *HclOperatingSystemVendorListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHclOperatingSystemVendorListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHclOperatingSystemVendorListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHclOperatingSystemVendorListAllOf(val *HclOperatingSystemVendorListAllOf) *NullableHclOperatingSystemVendorListAllOf {
	return &NullableHclOperatingSystemVendorListAllOf{value: val, isSet: true}
}

func (v NullableHclOperatingSystemVendorListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHclOperatingSystemVendorListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
