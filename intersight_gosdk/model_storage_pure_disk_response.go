...
type StoragePureDiskResponse struct {
	StoragePureDiskResponseInterface interface{ GetObjectType() string }
}

func (s StoragePureDiskResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StoragePureDiskResponseInterface)
}

func (s *StoragePureDiskResponse) UnmarshalJSON(src []byte) error {
	var err error
