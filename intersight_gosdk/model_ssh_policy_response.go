...
type SshPolicyResponse struct {
	SshPolicyResponseInterface interface{ GetObjectType() string }
}

func (s SshPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.SshPolicyResponseInterface)
}

func (s *SshPolicyResponse) UnmarshalJSON(src []byte) error {
	var err error
