...
type EquipmentPsuRelationship struct {
	EquipmentPsuRelationshipInterface interface{}
}

func (s EquipmentPsuRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.EquipmentPsuRelationshipInterface)
}

func (s *EquipmentPsuRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledEquipmentPsu *EquipmentPsu = &EquipmentPsu{}
	err = json.Unmarshal(src, unmarshaledEquipmentPsu)
	if err == nil {
		s.EquipmentPsuRelationshipInterface = unmarshaledEquipmentPsu
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.EquipmentPsuRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
