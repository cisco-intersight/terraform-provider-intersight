...
type EquipmentIoExpanderResponse struct {
	EquipmentIoExpanderResponseInterface interface{ GetObjectType() string }
}

func (s EquipmentIoExpanderResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.EquipmentIoExpanderResponseInterface)
}

func (s *EquipmentIoExpanderResponse) UnmarshalJSON(src []byte) error {
	var err error
