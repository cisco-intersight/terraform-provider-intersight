...
type FirmwareEulaResponse struct {
	FirmwareEulaResponseInterface interface{ GetObjectType() string }
}

func (s FirmwareEulaResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.FirmwareEulaResponseInterface)
}

func (s *FirmwareEulaResponse) UnmarshalJSON(src []byte) error {
	var err error
