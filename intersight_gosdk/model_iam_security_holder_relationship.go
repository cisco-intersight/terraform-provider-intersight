...
type IamSecurityHolderRelationship struct {
	IamSecurityHolderRelationshipInterface interface{}
}

func (s IamSecurityHolderRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamSecurityHolderRelationshipInterface)
}

func (s *IamSecurityHolderRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamSecurityHolder *IamSecurityHolder = &IamSecurityHolder{}
	err = json.Unmarshal(src, unmarshaledIamSecurityHolder)
	if err == nil {
		s.IamSecurityHolderRelationshipInterface = unmarshaledIamSecurityHolder
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamSecurityHolderRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
