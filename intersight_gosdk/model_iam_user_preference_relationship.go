...
type IamUserPreferenceRelationship struct {
	IamUserPreferenceRelationshipInterface interface{}
}

func (s IamUserPreferenceRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamUserPreferenceRelationshipInterface)
}

func (s *IamUserPreferenceRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamUserPreference *IamUserPreference = &IamUserPreference{}
	err = json.Unmarshal(src, unmarshaledIamUserPreference)
	if err == nil {
		s.IamUserPreferenceRelationshipInterface = unmarshaledIamUserPreference
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamUserPreferenceRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
