...
type StorageVirtualDriveExtensionResponse struct {
	StorageVirtualDriveExtensionResponseInterface interface{ GetObjectType() string }
}

func (s StorageVirtualDriveExtensionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageVirtualDriveExtensionResponseInterface)
}

func (s *StorageVirtualDriveExtensionResponse) UnmarshalJSON(src []byte) error {
	var err error
