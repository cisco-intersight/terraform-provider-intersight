...
type IpmioverlanPolicyResponse struct {
	IpmioverlanPolicyResponseInterface interface{ GetObjectType() string }
}

func (s IpmioverlanPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IpmioverlanPolicyResponseInterface)
}

func (s *IpmioverlanPolicyResponse) UnmarshalJSON(src []byte) error {
	var err error
