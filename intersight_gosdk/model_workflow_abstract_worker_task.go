...
func (o *WorkflowAbstractWorkerTask) GetInputParameters() map[string]interface{} {
...
func (o *WorkflowAbstractWorkerTask) GetInputParametersOk() (*map[string]interface{}, bool) {
	if o == nil || o.InputParameters == nil {
		return nil, false
	}
...
func (o *WorkflowAbstractWorkerTask) SetInputParameters(v map[string]interface{}) {
	o.InputParameters = &v
}
