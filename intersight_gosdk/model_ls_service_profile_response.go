...
type LsServiceProfileResponse struct {
	LsServiceProfileResponseInterface interface{ GetObjectType() string }
}

func (s LsServiceProfileResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.LsServiceProfileResponseInterface)
}

func (s *LsServiceProfileResponse) UnmarshalJSON(src []byte) error {
	var err error
