...
type StorageFlexUtilPhysicalDriveResponse struct {
	StorageFlexUtilPhysicalDriveResponseInterface interface{ GetObjectType() string }
}

func (s StorageFlexUtilPhysicalDriveResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageFlexUtilPhysicalDriveResponseInterface)
}

func (s *StorageFlexUtilPhysicalDriveResponse) UnmarshalJSON(src []byte) error {
	var err error
