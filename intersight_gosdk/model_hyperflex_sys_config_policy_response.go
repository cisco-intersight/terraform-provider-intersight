...
type HyperflexSysConfigPolicyResponse struct {
	HyperflexSysConfigPolicyResponseInterface interface{ GetObjectType() string }
}

func (s HyperflexSysConfigPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexSysConfigPolicyResponseInterface)
}

func (s *HyperflexSysConfigPolicyResponse) UnmarshalJSON(src []byte) error {
	var err error
