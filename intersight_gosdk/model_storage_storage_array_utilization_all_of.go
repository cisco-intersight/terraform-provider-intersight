...
// StorageStorageArrayUtilizationAllOf Definition of the list of properties defined in 'storage.StorageArrayUtilization', excluding properties defined in parent classes.
type StorageStorageArrayUtilizationAllOf struct {
...
func NewStorageStorageArrayUtilizationAllOf() *StorageStorageArrayUtilizationAllOf {
	this := StorageStorageArrayUtilizationAllOf{}
	return &this
}
...
func (o StorageStorageArrayUtilizationAllOf) MarshalJSON() ([]byte, error) {
...
type NullableStorageStorageArrayUtilizationAllOf struct {
	value *StorageStorageArrayUtilizationAllOf
	isSet bool
}

func (v NullableStorageStorageArrayUtilizationAllOf) Get() *StorageStorageArrayUtilizationAllOf {
	return v.value
}

func (v *NullableStorageStorageArrayUtilizationAllOf) Set(val *StorageStorageArrayUtilizationAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageStorageArrayUtilizationAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageStorageArrayUtilizationAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageStorageArrayUtilizationAllOf(val *StorageStorageArrayUtilizationAllOf) *NullableStorageStorageArrayUtilizationAllOf {
	return &NullableStorageStorageArrayUtilizationAllOf{value: val, isSet: true}
}

func (v NullableStorageStorageArrayUtilizationAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageStorageArrayUtilizationAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
