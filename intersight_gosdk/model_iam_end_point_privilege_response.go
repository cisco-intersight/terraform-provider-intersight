...
type IamEndPointPrivilegeResponse struct {
	IamEndPointPrivilegeResponseInterface interface{ GetObjectType() string }
}

func (s IamEndPointPrivilegeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamEndPointPrivilegeResponseInterface)
}

func (s *IamEndPointPrivilegeResponse) UnmarshalJSON(src []byte) error {
	var err error
