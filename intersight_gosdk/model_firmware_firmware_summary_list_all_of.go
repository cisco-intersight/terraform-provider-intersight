...
// FirmwareFirmwareSummaryListAllOf struct for FirmwareFirmwareSummaryListAllOf
type FirmwareFirmwareSummaryListAllOf struct {
...
type _FirmwareFirmwareSummaryListAllOf FirmwareFirmwareSummaryListAllOf
...
func NewFirmwareFirmwareSummaryListAllOf() *FirmwareFirmwareSummaryListAllOf {
	this := FirmwareFirmwareSummaryListAllOf{}
	return &this
}
...
func (o FirmwareFirmwareSummaryListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FirmwareFirmwareSummaryListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFirmwareFirmwareSummaryListAllOf := _FirmwareFirmwareSummaryListAllOf{}

	if err = json.Unmarshal(bytes, &varFirmwareFirmwareSummaryListAllOf); err == nil {
		*o = FirmwareFirmwareSummaryListAllOf(varFirmwareFirmwareSummaryListAllOf)
	}
...
type NullableFirmwareFirmwareSummaryListAllOf struct {
	value *FirmwareFirmwareSummaryListAllOf
	isSet bool
}

func (v NullableFirmwareFirmwareSummaryListAllOf) Get() *FirmwareFirmwareSummaryListAllOf {
	return v.value
}

func (v *NullableFirmwareFirmwareSummaryListAllOf) Set(val *FirmwareFirmwareSummaryListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFirmwareFirmwareSummaryListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFirmwareFirmwareSummaryListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFirmwareFirmwareSummaryListAllOf(val *FirmwareFirmwareSummaryListAllOf) *NullableFirmwareFirmwareSummaryListAllOf {
	return &NullableFirmwareFirmwareSummaryListAllOf{value: val, isSet: true}
}

func (v NullableFirmwareFirmwareSummaryListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFirmwareFirmwareSummaryListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
