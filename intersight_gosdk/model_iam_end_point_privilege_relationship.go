...
type IamEndPointPrivilegeRelationship struct {
	IamEndPointPrivilegeRelationshipInterface interface{}
}

func (s IamEndPointPrivilegeRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamEndPointPrivilegeRelationshipInterface)
}

func (s *IamEndPointPrivilegeRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamEndPointPrivilege *IamEndPointPrivilege = &IamEndPointPrivilege{}
	err = json.Unmarshal(src, unmarshaledIamEndPointPrivilege)
	if err == nil {
		s.IamEndPointPrivilegeRelationshipInterface = unmarshaledIamEndPointPrivilege
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamEndPointPrivilegeRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
