...
type IaasDeviceStatusRelationship struct {
	IaasDeviceStatusRelationshipInterface interface{}
}

func (s IaasDeviceStatusRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IaasDeviceStatusRelationshipInterface)
}

func (s *IaasDeviceStatusRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIaasDeviceStatus *IaasDeviceStatus = &IaasDeviceStatus{}
	err = json.Unmarshal(src, unmarshaledIaasDeviceStatus)
	if err == nil {
		s.IaasDeviceStatusRelationshipInterface = unmarshaledIaasDeviceStatus
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IaasDeviceStatusRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
