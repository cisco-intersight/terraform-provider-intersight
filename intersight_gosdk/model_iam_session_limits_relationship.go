...
type IamSessionLimitsRelationship struct {
	IamSessionLimitsRelationshipInterface interface{}
}

func (s IamSessionLimitsRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamSessionLimitsRelationshipInterface)
}

func (s *IamSessionLimitsRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamSessionLimits *IamSessionLimits = &IamSessionLimits{}
	err = json.Unmarshal(src, unmarshaledIamSessionLimits)
	if err == nil {
		s.IamSessionLimitsRelationshipInterface = unmarshaledIamSessionLimits
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamSessionLimitsRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
