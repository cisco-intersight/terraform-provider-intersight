...
type AdapterHostFcInterfaceRelationship struct {
	AdapterHostFcInterfaceRelationshipInterface interface{}
}

func (s AdapterHostFcInterfaceRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.AdapterHostFcInterfaceRelationshipInterface)
}

func (s *AdapterHostFcInterfaceRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledAdapterHostFcInterface *AdapterHostFcInterface = &AdapterHostFcInterface{}
	err = json.Unmarshal(src, unmarshaledAdapterHostFcInterface)
	if err == nil {
		s.AdapterHostFcInterfaceRelationshipInterface = unmarshaledAdapterHostFcInterface
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.AdapterHostFcInterfaceRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
