...
type WorkflowWorkflowInfoRelationship struct {
	WorkflowWorkflowInfoRelationshipInterface interface{}
}

func (s WorkflowWorkflowInfoRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.WorkflowWorkflowInfoRelationshipInterface)
}

func (s *WorkflowWorkflowInfoRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.WorkflowWorkflowInfoRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledWorkflowWorkflowInfo *WorkflowWorkflowInfo = &WorkflowWorkflowInfo{}
	err = json.Unmarshal(src, unmarshaledWorkflowWorkflowInfo)
	if err == nil {
		s.WorkflowWorkflowInfoRelationshipInterface = unmarshaledWorkflowWorkflowInfo
		return nil
	}
