...
type OsConfigurationFileResponse struct {
	OsConfigurationFileResponseInterface interface{ GetObjectType() string }
}

func (s OsConfigurationFileResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.OsConfigurationFileResponseInterface)
}

func (s *OsConfigurationFileResponse) UnmarshalJSON(src []byte) error {
	var err error
