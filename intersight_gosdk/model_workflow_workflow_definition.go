...
type WorkflowWorkflowDefinition struct {
	...
	UiRenderingData       *map[string]interface{}        `json:"UiRenderingData,omitempty"`
...
// AsWorkflowWorkflowDefinitionRelationship wraps this instance of WorkflowWorkflowDefinition in WorkflowWorkflowDefinitionRelationship
func (s *WorkflowWorkflowDefinition) AsWorkflowWorkflowDefinitionRelationship() WorkflowWorkflowDefinitionRelationship {
