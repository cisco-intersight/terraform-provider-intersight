...
type HyperflexConfigResultEntryRelationship struct {
	HyperflexConfigResultEntryRelationshipInterface interface{}
}

func (s HyperflexConfigResultEntryRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexConfigResultEntryRelationshipInterface)
}

func (s *HyperflexConfigResultEntryRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexConfigResultEntry *HyperflexConfigResultEntry = &HyperflexConfigResultEntry{}
	err = json.Unmarshal(src, unmarshaledHyperflexConfigResultEntry)
	if err == nil {
		s.HyperflexConfigResultEntryRelationshipInterface = unmarshaledHyperflexConfigResultEntry
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexConfigResultEntryRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
