...
// IamSystemAllOf Definition of the list of properties defined in 'iam.System', excluding properties defined in parent classes.
type IamSystemAllOf struct {
...
type _IamSystemAllOf IamSystemAllOf
...
func (o IamSystemAllOf) MarshalJSON() ([]byte, error) {
...
func (o *IamSystemAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varIamSystemAllOf := _IamSystemAllOf{}

	if err = json.Unmarshal(bytes, &varIamSystemAllOf); err == nil {
		*o = IamSystemAllOf(varIamSystemAllOf)
	}
...
type NullableIamSystemAllOf struct {
	value *IamSystemAllOf
	isSet bool
}

func (v NullableIamSystemAllOf) Get() *IamSystemAllOf {
	return v.value
}

func (v *NullableIamSystemAllOf) Set(val *IamSystemAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIamSystemAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIamSystemAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamSystemAllOf(val *IamSystemAllOf) *NullableIamSystemAllOf {
	return &NullableIamSystemAllOf{value: val, isSet: true}
}

func (v NullableIamSystemAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamSystemAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
