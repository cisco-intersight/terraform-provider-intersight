...
type HyperflexConfigResultRelationship struct {
	HyperflexConfigResultRelationshipInterface interface{}
}

func (s HyperflexConfigResultRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexConfigResultRelationshipInterface)
}

func (s *HyperflexConfigResultRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexConfigResult *HyperflexConfigResult = &HyperflexConfigResult{}
	err = json.Unmarshal(src, unmarshaledHyperflexConfigResult)
	if err == nil {
		s.HyperflexConfigResultRelationshipInterface = unmarshaledHyperflexConfigResult
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexConfigResultRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
