...
type NetworkElementRelationship struct {
	NetworkElementRelationshipInterface interface{}
}

func (s NetworkElementRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.NetworkElementRelationshipInterface)
}

func (s *NetworkElementRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.NetworkElementRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledNetworkElement *NetworkElement = &NetworkElement{}
	err = json.Unmarshal(src, unmarshaledNetworkElement)
	if err == nil {
		s.NetworkElementRelationshipInterface = unmarshaledNetworkElement
		return nil
	}
