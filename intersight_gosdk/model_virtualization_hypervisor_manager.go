...
// VirtualizationHypervisorManager The basic hypervisor manager. Serves as a management layer for all hypervisors. A hypervisor manager contains datacenters, and datacenters contain all other entities such as Host, Portgroups, Virtual Machines, etc.
...
func NewVirtualizationHypervisorManager() *VirtualizationHypervisorManager {
	this := VirtualizationHypervisorManager{}
	return &this
}
...
func (o VirtualizationHypervisorManager) MarshalJSON() ([]byte, error) {
...
type NullableVirtualizationHypervisorManager struct {
	value *VirtualizationHypervisorManager
	isSet bool
}

func (v NullableVirtualizationHypervisorManager) Get() *VirtualizationHypervisorManager {
	return v.value
}

func (v *NullableVirtualizationHypervisorManager) Set(val *VirtualizationHypervisorManager) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationHypervisorManager) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationHypervisorManager) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationHypervisorManager(val *VirtualizationHypervisorManager) *NullableVirtualizationHypervisorManager {
	return &NullableVirtualizationHypervisorManager{value: val, isSet: true}
}

func (v NullableVirtualizationHypervisorManager) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationHypervisorManager) UnmarshalJSON(src []byte) error {
	v.isSet = true
