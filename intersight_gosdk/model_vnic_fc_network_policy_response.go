...
type VnicFcNetworkPolicyResponse struct {
	VnicFcNetworkPolicyResponseInterface interface{ GetObjectType() string }
}

func (s VnicFcNetworkPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.VnicFcNetworkPolicyResponseInterface)
}

func (s *VnicFcNetworkPolicyResponse) UnmarshalJSON(src []byte) error {
	var err error
