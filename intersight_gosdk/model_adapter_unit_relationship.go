...
type AdapterUnitRelationship struct {
	AdapterUnitRelationshipInterface interface{}
}

func (s AdapterUnitRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.AdapterUnitRelationshipInterface)
}

func (s *AdapterUnitRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledAdapterUnit *AdapterUnit = &AdapterUnit{}
	err = json.Unmarshal(src, unmarshaledAdapterUnit)
	if err == nil {
		s.AdapterUnitRelationshipInterface = unmarshaledAdapterUnit
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.AdapterUnitRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
