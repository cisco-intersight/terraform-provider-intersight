...
type HyperflexClusterProfileResponse struct {
	HyperflexClusterProfileResponseInterface interface{ GetObjectType() string }
}

func (s HyperflexClusterProfileResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexClusterProfileResponseInterface)
}

func (s *HyperflexClusterProfileResponse) UnmarshalJSON(src []byte) error {
	var err error
