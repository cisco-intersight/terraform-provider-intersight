...
type StorageFlexUtilVirtualDriveResponse struct {
	StorageFlexUtilVirtualDriveResponseInterface interface{ GetObjectType() string }
}

func (s StorageFlexUtilVirtualDriveResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageFlexUtilVirtualDriveResponseInterface)
}

func (s *StorageFlexUtilVirtualDriveResponse) UnmarshalJSON(src []byte) error {
	var err error
