...
type HyperflexAutoSupportPolicyRelationship struct {
	HyperflexAutoSupportPolicyRelationshipInterface interface{}
}

func (s HyperflexAutoSupportPolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexAutoSupportPolicyRelationshipInterface)
}

func (s *HyperflexAutoSupportPolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexAutoSupportPolicy *HyperflexAutoSupportPolicy = &HyperflexAutoSupportPolicy{}
	err = json.Unmarshal(src, unmarshaledHyperflexAutoSupportPolicy)
	if err == nil {
		s.HyperflexAutoSupportPolicyRelationshipInterface = unmarshaledHyperflexAutoSupportPolicy
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexAutoSupportPolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
