...
type StorageEnclosureDiskSlotEpRelationship struct {
	StorageEnclosureDiskSlotEpRelationshipInterface interface{}
}

func (s StorageEnclosureDiskSlotEpRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageEnclosureDiskSlotEpRelationshipInterface)
}

func (s *StorageEnclosureDiskSlotEpRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StorageEnclosureDiskSlotEpRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStorageEnclosureDiskSlotEp *StorageEnclosureDiskSlotEp = &StorageEnclosureDiskSlotEp{}
	err = json.Unmarshal(src, unmarshaledStorageEnclosureDiskSlotEp)
	if err == nil {
		s.StorageEnclosureDiskSlotEpRelationshipInterface = unmarshaledStorageEnclosureDiskSlotEp
		return nil
	}
