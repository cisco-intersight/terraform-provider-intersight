...
type LicenseCustomerOpRelationship struct {
	LicenseCustomerOpRelationshipInterface interface{}
}

func (s LicenseCustomerOpRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.LicenseCustomerOpRelationshipInterface)
}

func (s *LicenseCustomerOpRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledLicenseCustomerOp *LicenseCustomerOp = &LicenseCustomerOp{}
	err = json.Unmarshal(src, unmarshaledLicenseCustomerOp)
	if err == nil {
		s.LicenseCustomerOpRelationshipInterface = unmarshaledLicenseCustomerOp
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.LicenseCustomerOpRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
