...
type HclHyperflexSoftwareCompatibilityInfoRelationship struct {
	HclHyperflexSoftwareCompatibilityInfoRelationshipInterface interface{}
}

func (s HclHyperflexSoftwareCompatibilityInfoRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HclHyperflexSoftwareCompatibilityInfoRelationshipInterface)
}

func (s *HclHyperflexSoftwareCompatibilityInfoRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHclHyperflexSoftwareCompatibilityInfo *HclHyperflexSoftwareCompatibilityInfo = &HclHyperflexSoftwareCompatibilityInfo{}
	err = json.Unmarshal(src, unmarshaledHclHyperflexSoftwareCompatibilityInfo)
	if err == nil {
		s.HclHyperflexSoftwareCompatibilityInfoRelationshipInterface = unmarshaledHclHyperflexSoftwareCompatibilityInfo
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HclHyperflexSoftwareCompatibilityInfoRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
