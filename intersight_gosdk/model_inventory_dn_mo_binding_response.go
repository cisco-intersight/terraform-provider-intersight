...
type InventoryDnMoBindingResponse struct {
	InventoryDnMoBindingResponseInterface interface{ GetObjectType() string }
}

func (s InventoryDnMoBindingResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.InventoryDnMoBindingResponseInterface)
}

func (s *InventoryDnMoBindingResponse) UnmarshalJSON(src []byte) error {
	var err error
