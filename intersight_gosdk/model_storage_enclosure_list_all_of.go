...
// StorageEnclosureListAllOf struct for StorageEnclosureListAllOf
type StorageEnclosureListAllOf struct {
...
type _StorageEnclosureListAllOf StorageEnclosureListAllOf
...
func NewStorageEnclosureListAllOf() *StorageEnclosureListAllOf {
	this := StorageEnclosureListAllOf{}
	return &this
}
...
func (o StorageEnclosureListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageEnclosureListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageEnclosureListAllOf := _StorageEnclosureListAllOf{}

	if err = json.Unmarshal(bytes, &varStorageEnclosureListAllOf); err == nil {
		*o = StorageEnclosureListAllOf(varStorageEnclosureListAllOf)
	}
...
type NullableStorageEnclosureListAllOf struct {
	value *StorageEnclosureListAllOf
	isSet bool
}

func (v NullableStorageEnclosureListAllOf) Get() *StorageEnclosureListAllOf {
	return v.value
}

func (v *NullableStorageEnclosureListAllOf) Set(val *StorageEnclosureListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageEnclosureListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageEnclosureListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageEnclosureListAllOf(val *StorageEnclosureListAllOf) *NullableStorageEnclosureListAllOf {
	return &NullableStorageEnclosureListAllOf{value: val, isSet: true}
}

func (v NullableStorageEnclosureListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageEnclosureListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
