...
type IamAccountResponse struct {
	IamAccountResponseInterface interface{ GetObjectType() string }
}

func (s IamAccountResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamAccountResponseInterface)
}

func (s *IamAccountResponse) UnmarshalJSON(src []byte) error {
	var err error
