...
type ComputeRackUnitRelationship struct {
	ComputeRackUnitRelationshipInterface interface{}
}

func (s ComputeRackUnitRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.ComputeRackUnitRelationshipInterface)
}

func (s *ComputeRackUnitRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledComputeRackUnit *ComputeRackUnit = &ComputeRackUnit{}
	err = json.Unmarshal(src, unmarshaledComputeRackUnit)
	if err == nil {
		s.ComputeRackUnitRelationshipInterface = unmarshaledComputeRackUnit
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.ComputeRackUnitRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
