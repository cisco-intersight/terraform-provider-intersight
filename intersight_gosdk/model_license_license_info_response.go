...
type LicenseLicenseInfoResponse struct {
	LicenseLicenseInfoResponseInterface interface{ GetObjectType() string }
}

func (s LicenseLicenseInfoResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.LicenseLicenseInfoResponseInterface)
}

func (s *LicenseLicenseInfoResponse) UnmarshalJSON(src []byte) error {
	var err error
