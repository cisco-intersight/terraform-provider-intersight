...
type HyperflexStPlatformClusterResiliencyInfoAllOf struct {
	...
	MessagesIterator      *map[string]interface{} `json:"MessagesIterator,omitempty"`
...
// GetMessagesIterator returns the MessagesIterator field value if set, zero value otherwise.
func (o *HyperflexStPlatformClusterResiliencyInfoAllOf) GetMessagesIterator() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *HyperflexStPlatformClusterResiliencyInfoAllOf) GetMessagesIteratorOk() (*map[string]interface{}, bool) {
	if o == nil || o.MessagesIterator == nil {
		return nil, false
	}
...
// SetMessagesIterator gets a reference to the given map[string]interface{} and assigns it to the MessagesIterator field.
func (o *HyperflexStPlatformClusterResiliencyInfoAllOf) SetMessagesIterator(v map[string]interface{}) {
