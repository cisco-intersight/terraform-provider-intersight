...
type OsConfigurationFileRelationship struct {
	OsConfigurationFileRelationshipInterface interface{}
}

func (s OsConfigurationFileRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.OsConfigurationFileRelationshipInterface)
}

func (s *OsConfigurationFileRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.OsConfigurationFileRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledOsConfigurationFile *OsConfigurationFile = &OsConfigurationFile{}
	err = json.Unmarshal(src, unmarshaledOsConfigurationFile)
	if err == nil {
		s.OsConfigurationFileRelationshipInterface = unmarshaledOsConfigurationFile
		return nil
	}
