...
type VnicEthAdapterPolicyRelationship struct {
	VnicEthAdapterPolicyRelationshipInterface interface{}
}

func (s VnicEthAdapterPolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.VnicEthAdapterPolicyRelationshipInterface)
}

func (s *VnicEthAdapterPolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.VnicEthAdapterPolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledVnicEthAdapterPolicy *VnicEthAdapterPolicy = &VnicEthAdapterPolicy{}
	err = json.Unmarshal(src, unmarshaledVnicEthAdapterPolicy)
	if err == nil {
		s.VnicEthAdapterPolicyRelationshipInterface = unmarshaledVnicEthAdapterPolicy
		return nil
	}
