...
func (o StoragePureHostGroup) MarshalJSON() ([]byte, error) {
	...
	serializedStorageHostGroup, errStorageHostGroup := json.Marshal(o.StorageHostGroup)
	if errStorageHostGroup != nil {
		return []byte{}, errStorageHostGroup
	}
	errStorageHostGroup = json.Unmarshal([]byte(serializedStorageHostGroup), &toSerialize)
	if errStorageHostGroup != nil {
		return []byte{}, errStorageHostGroup
	}
	if o.HostNames != nil {
...
// AsStoragePureHostGroupRelationship wraps this instance of StoragePureHostGroup in StoragePureHostGroupRelationship
func (s *StoragePureHostGroup) AsStoragePureHostGroupRelationship() StoragePureHostGroupRelationship {
