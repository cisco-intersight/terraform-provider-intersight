...
type StorageFlexFlashControllerPropsRelationship struct {
	StorageFlexFlashControllerPropsRelationshipInterface interface{}
}

func (s StorageFlexFlashControllerPropsRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageFlexFlashControllerPropsRelationshipInterface)
}

func (s *StorageFlexFlashControllerPropsRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StorageFlexFlashControllerPropsRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStorageFlexFlashControllerProps *StorageFlexFlashControllerProps = &StorageFlexFlashControllerProps{}
	err = json.Unmarshal(src, unmarshaledStorageFlexFlashControllerProps)
	if err == nil {
		s.StorageFlexFlashControllerPropsRelationshipInterface = unmarshaledStorageFlexFlashControllerProps
		return nil
	}
