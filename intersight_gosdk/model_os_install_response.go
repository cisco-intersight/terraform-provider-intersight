...
type OsInstallResponse struct {
	OsInstallResponseInterface interface{ GetObjectType() string }
}

func (s OsInstallResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.OsInstallResponseInterface)
}

func (s *OsInstallResponse) UnmarshalJSON(src []byte) error {
	var err error
