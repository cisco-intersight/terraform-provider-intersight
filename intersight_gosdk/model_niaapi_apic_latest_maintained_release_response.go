...
type NiaapiApicLatestMaintainedReleaseResponse struct {
	NiaapiApicLatestMaintainedReleaseResponseInterface interface{ GetObjectType() string }
}

func (s NiaapiApicLatestMaintainedReleaseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.NiaapiApicLatestMaintainedReleaseResponseInterface)
}

func (s *NiaapiApicLatestMaintainedReleaseResponse) UnmarshalJSON(src []byte) error {
	var err error
