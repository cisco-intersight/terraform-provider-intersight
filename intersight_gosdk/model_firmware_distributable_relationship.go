...
type FirmwareDistributableRelationship struct {
	FirmwareDistributableRelationshipInterface interface{}
}

func (s FirmwareDistributableRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.FirmwareDistributableRelationshipInterface)
}

func (s *FirmwareDistributableRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledFirmwareDistributable *FirmwareDistributable = &FirmwareDistributable{}
	err = json.Unmarshal(src, unmarshaledFirmwareDistributable)
	if err == nil {
		s.FirmwareDistributableRelationshipInterface = unmarshaledFirmwareDistributable
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.FirmwareDistributableRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
