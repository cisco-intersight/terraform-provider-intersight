...
func (o VirtualizationVmwareDatastore) MarshalJSON() ([]byte, error) {
	...
	serializedVirtualizationDatastore, errVirtualizationDatastore := json.Marshal(o.VirtualizationDatastore)
	if errVirtualizationDatastore != nil {
		return []byte{}, errVirtualizationDatastore
	}
	errVirtualizationDatastore = json.Unmarshal([]byte(serializedVirtualizationDatastore), &toSerialize)
	if errVirtualizationDatastore != nil {
		return []byte{}, errVirtualizationDatastore
	}
	if o.Accessible != nil {
...
// AsVirtualizationVmwareDatastoreRelationship wraps this instance of VirtualizationVmwareDatastore in VirtualizationVmwareDatastoreRelationship
func (s *VirtualizationVmwareDatastore) AsVirtualizationVmwareDatastoreRelationship() VirtualizationVmwareDatastoreRelationship {
