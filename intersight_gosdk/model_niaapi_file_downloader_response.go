...
func (dst *NiaapiFileDownloaderResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal NiaapiFileDownloaderResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal NiaapiFileDownloaderResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal NiaapiFileDownloaderResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'niaapi.FileDownloader.List'
	if jsonDict["ObjectType"] == "niaapi.FileDownloader.List" {
		// try to unmarshal JSON data into NiaapiFileDownloaderList
		err = json.Unmarshal(data, &dst.NiaapiFileDownloaderList)
		if err == nil {
			return nil // data stored in dst.NiaapiFileDownloaderList, return on the first match
		} else {
			dst.NiaapiFileDownloaderList = nil
			return fmt.Errorf("Failed to unmarshal NiaapiFileDownloaderResponse as NiaapiFileDownloaderList: %s", err.Error())
		}
	}
...
func (src NiaapiFileDownloaderResponse) MarshalJSON() ([]byte, error) {
	...
	if src.NiaapiFileDownloaderList != nil {
		return json.Marshal(&src.NiaapiFileDownloaderList)
	}
...
func (obj *NiaapiFileDownloaderResponse) GetActualInstance() interface{} {
	...
	if obj.NiaapiFileDownloaderList != nil {
		return obj.NiaapiFileDownloaderList
	}
...
type NullableNiaapiFileDownloaderResponse struct {
	value *NiaapiFileDownloaderResponse
	isSet bool
}

func (v NullableNiaapiFileDownloaderResponse) Get() *NiaapiFileDownloaderResponse {
	return v.value
}

func (v *NullableNiaapiFileDownloaderResponse) Set(val *NiaapiFileDownloaderResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNiaapiFileDownloaderResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNiaapiFileDownloaderResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiaapiFileDownloaderResponse(val *NiaapiFileDownloaderResponse) *NullableNiaapiFileDownloaderResponse {
	return &NullableNiaapiFileDownloaderResponse{value: val, isSet: true}
}

func (v NullableNiaapiFileDownloaderResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiaapiFileDownloaderResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
