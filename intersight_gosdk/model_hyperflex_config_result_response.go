...
type HyperflexConfigResultResponse struct {
	HyperflexConfigResultResponseInterface interface{ GetObjectType() string }
}

func (s HyperflexConfigResultResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexConfigResultResponseInterface)
}

func (s *HyperflexConfigResultResponse) UnmarshalJSON(src []byte) error {
	var err error
