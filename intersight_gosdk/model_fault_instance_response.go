...
func (dst *FaultInstanceResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "fault.Instance.List" {
		// try to unmarshal JSON data into FaultInstanceList
		err = json.Unmarshal(data, &dst.FaultInstanceList)
		if err == nil {
			return nil // data stored in dst.FaultInstanceList, return on the first match
		} else {
			dst.FaultInstanceList = nil
			return fmt.Errorf("Failed to unmarshal FaultInstanceResponse as FaultInstanceList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FaultInstanceResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FaultInstanceResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FaultInstanceResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src FaultInstanceResponse) MarshalJSON() ([]byte, error) {
	if src.FaultInstanceList != nil {
		return json.Marshal(&src.FaultInstanceList)
	}
...
type NullableFaultInstanceResponse struct {
	value *FaultInstanceResponse
	isSet bool
}

func (v NullableFaultInstanceResponse) Get() *FaultInstanceResponse {
	return v.value
}

func (v *NullableFaultInstanceResponse) Set(val *FaultInstanceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFaultInstanceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFaultInstanceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFaultInstanceResponse(val *FaultInstanceResponse) *NullableFaultInstanceResponse {
	return &NullableFaultInstanceResponse{value: val, isSet: true}
}

func (v NullableFaultInstanceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFaultInstanceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
