...
type ForecastDefinitionResponse struct {
	ForecastDefinitionResponseInterface interface{ GetObjectType() string }
}

func (s ForecastDefinitionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.ForecastDefinitionResponseInterface)
}

func (s *ForecastDefinitionResponse) UnmarshalJSON(src []byte) error {
	var err error
