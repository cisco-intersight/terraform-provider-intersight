...
type MemoryPersistentMemoryUnitResponse struct {
	MemoryPersistentMemoryUnitResponseInterface interface{ GetObjectType() string }
}

func (s MemoryPersistentMemoryUnitResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.MemoryPersistentMemoryUnitResponseInterface)
}

func (s *MemoryPersistentMemoryUnitResponse) UnmarshalJSON(src []byte) error {
	var err error
