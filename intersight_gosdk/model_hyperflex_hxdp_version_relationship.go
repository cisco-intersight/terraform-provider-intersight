...
type HyperflexHxdpVersionRelationship struct {
	HyperflexHxdpVersionRelationshipInterface interface{}
}

func (s HyperflexHxdpVersionRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexHxdpVersionRelationshipInterface)
}

func (s *HyperflexHxdpVersionRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexHxdpVersion *HyperflexHxdpVersion = &HyperflexHxdpVersion{}
	err = json.Unmarshal(src, unmarshaledHyperflexHxdpVersion)
	if err == nil {
		s.HyperflexHxdpVersionRelationshipInterface = unmarshaledHyperflexHxdpVersion
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexHxdpVersionRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
