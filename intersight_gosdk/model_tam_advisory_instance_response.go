...
type TamAdvisoryInstanceResponse struct {
	TamAdvisoryInstanceResponseInterface interface{ GetObjectType() string }
}

func (s TamAdvisoryInstanceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.TamAdvisoryInstanceResponseInterface)
}

func (s *TamAdvisoryInstanceResponse) UnmarshalJSON(src []byte) error {
	var err error
