...
type AssetDeviceRegistrationRelationship struct {
	AssetDeviceRegistrationRelationshipInterface interface{}
}

func (s AssetDeviceRegistrationRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.AssetDeviceRegistrationRelationshipInterface)
}

func (s *AssetDeviceRegistrationRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledAssetDeviceRegistration *AssetDeviceRegistration = &AssetDeviceRegistration{}
	err = json.Unmarshal(src, unmarshaledAssetDeviceRegistration)
	if err == nil {
		s.AssetDeviceRegistrationRelationshipInterface = unmarshaledAssetDeviceRegistration
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.AssetDeviceRegistrationRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
