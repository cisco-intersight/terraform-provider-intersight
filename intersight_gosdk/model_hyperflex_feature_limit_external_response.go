...
type HyperflexFeatureLimitExternalResponse struct {
	HyperflexFeatureLimitExternalResponseInterface interface{ GetObjectType() string }
}

func (s HyperflexFeatureLimitExternalResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexFeatureLimitExternalResponseInterface)
}

func (s *HyperflexFeatureLimitExternalResponse) UnmarshalJSON(src []byte) error {
	var err error
