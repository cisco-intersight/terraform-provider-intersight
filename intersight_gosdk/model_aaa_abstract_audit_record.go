...
type AaaAbstractAuditRecord struct {
	...
	MoDisplayNames *map[string]interface{} `json:"MoDisplayNames,omitempty"`
...
// GetMoDisplayNames returns the MoDisplayNames field value if set, zero value otherwise.
func (o *AaaAbstractAuditRecord) GetMoDisplayNames() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *AaaAbstractAuditRecord) GetMoDisplayNamesOk() (*map[string]interface{}, bool) {
	if o == nil || o.MoDisplayNames == nil {
		return nil, false
	}
...
// SetMoDisplayNames gets a reference to the given map[string]interface{} and assigns it to the MoDisplayNames field.
func (o *AaaAbstractAuditRecord) SetMoDisplayNames(v map[string]interface{}) {
	o.MoDisplayNames = &v
}
...
func (o *AaaAbstractAuditRecord) GetRequest() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *AaaAbstractAuditRecord) GetRequestOk() (*map[string]interface{}, bool) {
	if o == nil || o.Request == nil {
		return nil, false
	}
...
func (o *AaaAbstractAuditRecord) SetRequest(v map[string]interface{}) {
	o.Request = &v
}
