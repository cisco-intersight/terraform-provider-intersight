...
type _StorageDiskGroupPolicyAllOf StorageDiskGroupPolicyAllOf
...
func (o *StorageDiskGroupPolicyAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageDiskGroupPolicyAllOf := _StorageDiskGroupPolicyAllOf{}

	if err = json.Unmarshal(bytes, &varStorageDiskGroupPolicyAllOf); err == nil {
		*o = StorageDiskGroupPolicyAllOf(varStorageDiskGroupPolicyAllOf)
	}
