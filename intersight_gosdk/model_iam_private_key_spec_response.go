...
type IamPrivateKeySpecResponse struct {
	IamPrivateKeySpecResponseInterface interface{ GetObjectType() string }
}

func (s IamPrivateKeySpecResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamPrivateKeySpecResponseInterface)
}

func (s *IamPrivateKeySpecResponse) UnmarshalJSON(src []byte) error {
	var err error
