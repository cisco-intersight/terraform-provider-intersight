...
func (dst *IamEndPointUserResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "iam.EndPointUser.List" {
		// try to unmarshal JSON data into IamEndPointUserList
		err = json.Unmarshal(data, &dst.IamEndPointUserList)
		if err == nil {
			return nil // data stored in dst.IamEndPointUserList, return on the first match
		} else {
			dst.IamEndPointUserList = nil
			return fmt.Errorf("Failed to unmarshal IamEndPointUserResponse as IamEndPointUserList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal IamEndPointUserResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal IamEndPointUserResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal IamEndPointUserResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src IamEndPointUserResponse) MarshalJSON() ([]byte, error) {
	if src.IamEndPointUserList != nil {
		return json.Marshal(&src.IamEndPointUserList)
	}
...
type NullableIamEndPointUserResponse struct {
	value *IamEndPointUserResponse
	isSet bool
}

func (v NullableIamEndPointUserResponse) Get() *IamEndPointUserResponse {
	return v.value
}

func (v *NullableIamEndPointUserResponse) Set(val *IamEndPointUserResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIamEndPointUserResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableIamEndPointUserResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamEndPointUserResponse(val *IamEndPointUserResponse) *NullableIamEndPointUserResponse {
	return &NullableIamEndPointUserResponse{value: val, isSet: true}
}

func (v NullableIamEndPointUserResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamEndPointUserResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
