...
func (o *VirtualizationVmwareClusterList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varVirtualizationVmwareClusterListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varVirtualizationVmwareClusterList)
	if err == nil {
