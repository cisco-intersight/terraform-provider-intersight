...
type StorageVirtualDriveExtensionRelationship struct {
	StorageVirtualDriveExtensionRelationshipInterface interface{}
}

func (s StorageVirtualDriveExtensionRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageVirtualDriveExtensionRelationshipInterface)
}

func (s *StorageVirtualDriveExtensionRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StorageVirtualDriveExtensionRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStorageVirtualDriveExtension *StorageVirtualDriveExtension = &StorageVirtualDriveExtension{}
	err = json.Unmarshal(src, unmarshaledStorageVirtualDriveExtension)
	if err == nil {
		s.StorageVirtualDriveExtensionRelationshipInterface = unmarshaledStorageVirtualDriveExtension
		return nil
	}
