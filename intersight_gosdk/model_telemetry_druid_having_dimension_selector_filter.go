...
func (o TelemetryDruidHavingDimensionSelectorFilter) MarshalJSON() ([]byte, error) {
	...
	serializedTelemetryDruidBaseHavingFilter, errTelemetryDruidBaseHavingFilter := json.Marshal(o.TelemetryDruidBaseHavingFilter)
	if errTelemetryDruidBaseHavingFilter != nil {
		return []byte{}, errTelemetryDruidBaseHavingFilter
	}
	errTelemetryDruidBaseHavingFilter = json.Unmarshal([]byte(serializedTelemetryDruidBaseHavingFilter), &toSerialize)
	if errTelemetryDruidBaseHavingFilter != nil {
		return []byte{}, errTelemetryDruidBaseHavingFilter
	}
	if true {
...
// AsTelemetryDruidHavingFilter wraps this instance of TelemetryDruidHavingDimensionSelectorFilter in TelemetryDruidHavingFilter
func (s *TelemetryDruidHavingDimensionSelectorFilter) AsTelemetryDruidHavingFilter() TelemetryDruidHavingFilter {
	return TelemetryDruidHavingFilter{TelemetryDruidHavingFilterInterface: s}
}
