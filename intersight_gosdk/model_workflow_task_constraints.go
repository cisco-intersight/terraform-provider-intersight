...
type WorkflowTaskConstraints struct {
	...
	TargetDataType *map[string]interface{} `json:"TargetDataType,omitempty"`
}
...
// GetTargetDataType returns the TargetDataType field value if set, zero value otherwise.
...
// SetTargetDataType gets a reference to the given map[string]interface{} and assigns it to the TargetDataType field.
