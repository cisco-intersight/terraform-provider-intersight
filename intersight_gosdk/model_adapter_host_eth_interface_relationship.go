...
type AdapterHostEthInterfaceRelationship struct {
	AdapterHostEthInterfaceRelationshipInterface interface{}
}

func (s AdapterHostEthInterfaceRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.AdapterHostEthInterfaceRelationshipInterface)
}

func (s *AdapterHostEthInterfaceRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledAdapterHostEthInterface *AdapterHostEthInterface = &AdapterHostEthInterface{}
	err = json.Unmarshal(src, unmarshaledAdapterHostEthInterface)
	if err == nil {
		s.AdapterHostEthInterfaceRelationshipInterface = unmarshaledAdapterHostEthInterface
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.AdapterHostEthInterfaceRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
