...
// IamPermissionListAllOf struct for IamPermissionListAllOf
type IamPermissionListAllOf struct {
...
type _IamPermissionListAllOf IamPermissionListAllOf
...
func (o IamPermissionListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *IamPermissionListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varIamPermissionListAllOf := _IamPermissionListAllOf{}

	if err = json.Unmarshal(bytes, &varIamPermissionListAllOf); err == nil {
		*o = IamPermissionListAllOf(varIamPermissionListAllOf)
	}
...
type NullableIamPermissionListAllOf struct {
	value *IamPermissionListAllOf
	isSet bool
}

func (v NullableIamPermissionListAllOf) Get() *IamPermissionListAllOf {
	return v.value
}

func (v *NullableIamPermissionListAllOf) Set(val *IamPermissionListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIamPermissionListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIamPermissionListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamPermissionListAllOf(val *IamPermissionListAllOf) *NullableIamPermissionListAllOf {
	return &NullableIamPermissionListAllOf{value: val, isSet: true}
}

func (v NullableIamPermissionListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamPermissionListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
