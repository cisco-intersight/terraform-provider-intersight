...
// FirmwareCifsServerAllOf Definition of the list of properties defined in 'firmware.CifsServer', excluding properties defined in parent classes.
type FirmwareCifsServerAllOf struct {
...
type _FirmwareCifsServerAllOf FirmwareCifsServerAllOf
...
func (o FirmwareCifsServerAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FirmwareCifsServerAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFirmwareCifsServerAllOf := _FirmwareCifsServerAllOf{}

	if err = json.Unmarshal(bytes, &varFirmwareCifsServerAllOf); err == nil {
		*o = FirmwareCifsServerAllOf(varFirmwareCifsServerAllOf)
	}
...
type NullableFirmwareCifsServerAllOf struct {
	value *FirmwareCifsServerAllOf
	isSet bool
}

func (v NullableFirmwareCifsServerAllOf) Get() *FirmwareCifsServerAllOf {
	return v.value
}

func (v *NullableFirmwareCifsServerAllOf) Set(val *FirmwareCifsServerAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFirmwareCifsServerAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFirmwareCifsServerAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFirmwareCifsServerAllOf(val *FirmwareCifsServerAllOf) *NullableFirmwareCifsServerAllOf {
	return &NullableFirmwareCifsServerAllOf{value: val, isSet: true}
}

func (v NullableFirmwareCifsServerAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFirmwareCifsServerAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
