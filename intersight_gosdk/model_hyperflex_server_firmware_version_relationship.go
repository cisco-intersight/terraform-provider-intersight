...
type HyperflexServerFirmwareVersionRelationship struct {
	HyperflexServerFirmwareVersionRelationshipInterface interface{}
}

func (s HyperflexServerFirmwareVersionRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexServerFirmwareVersionRelationshipInterface)
}

func (s *HyperflexServerFirmwareVersionRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexServerFirmwareVersion *HyperflexServerFirmwareVersion = &HyperflexServerFirmwareVersion{}
	err = json.Unmarshal(src, unmarshaledHyperflexServerFirmwareVersion)
	if err == nil {
		s.HyperflexServerFirmwareVersionRelationshipInterface = unmarshaledHyperflexServerFirmwareVersion
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexServerFirmwareVersionRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
