...
type HyperflexSoftwareVersionPolicyResponse struct {
	HyperflexSoftwareVersionPolicyResponseInterface interface{ GetObjectType() string }
}

func (s HyperflexSoftwareVersionPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexSoftwareVersionPolicyResponseInterface)
}

func (s *HyperflexSoftwareVersionPolicyResponse) UnmarshalJSON(src []byte) error {
	var err error
