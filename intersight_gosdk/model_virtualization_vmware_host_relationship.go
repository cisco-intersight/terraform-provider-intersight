...
type VirtualizationVmwareHostRelationship struct {
	VirtualizationVmwareHostRelationshipInterface interface{}
}

func (s VirtualizationVmwareHostRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.VirtualizationVmwareHostRelationshipInterface)
}

func (s *VirtualizationVmwareHostRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.VirtualizationVmwareHostRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledVirtualizationVmwareHost *VirtualizationVmwareHost = &VirtualizationVmwareHost{}
	err = json.Unmarshal(src, unmarshaledVirtualizationVmwareHost)
	if err == nil {
		s.VirtualizationVmwareHostRelationshipInterface = unmarshaledVirtualizationVmwareHost
		return nil
	}
