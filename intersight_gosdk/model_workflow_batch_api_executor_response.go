...
type WorkflowBatchApiExecutorResponse struct {
	WorkflowBatchApiExecutorResponseInterface interface{ GetObjectType() string }
}

func (s WorkflowBatchApiExecutorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.WorkflowBatchApiExecutorResponseInterface)
}

func (s *WorkflowBatchApiExecutorResponse) UnmarshalJSON(src []byte) error {
	var err error
