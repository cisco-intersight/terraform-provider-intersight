...
type WorkflowBuildTaskMetaAllOf struct {
	...
	TaskList *map[string]interface{} `json:"TaskList,omitempty"`
...
// SetTaskList gets a reference to the given map[string]interface{} and assigns it to the TaskList field.
