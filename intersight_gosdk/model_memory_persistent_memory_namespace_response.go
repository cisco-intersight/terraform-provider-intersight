...
type MemoryPersistentMemoryNamespaceResponse struct {
	MemoryPersistentMemoryNamespaceResponseInterface interface{ GetObjectType() string }
}

func (s MemoryPersistentMemoryNamespaceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.MemoryPersistentMemoryNamespaceResponseInterface)
}

func (s *MemoryPersistentMemoryNamespaceResponse) UnmarshalJSON(src []byte) error {
	var err error
