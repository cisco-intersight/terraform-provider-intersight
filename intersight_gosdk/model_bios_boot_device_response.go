...
func (dst *BiosBootDeviceResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "bios.BootDevice.List" {
		// try to unmarshal JSON data into BiosBootDeviceList
		err = json.Unmarshal(data, &dst.BiosBootDeviceList)
		if err == nil {
			return nil // data stored in dst.BiosBootDeviceList, return on the first match
		} else {
			dst.BiosBootDeviceList = nil
			return fmt.Errorf("Failed to unmarshal BiosBootDeviceResponse as BiosBootDeviceList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal BiosBootDeviceResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal BiosBootDeviceResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal BiosBootDeviceResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src BiosBootDeviceResponse) MarshalJSON() ([]byte, error) {
	if src.BiosBootDeviceList != nil {
		return json.Marshal(&src.BiosBootDeviceList)
	}
...
type NullableBiosBootDeviceResponse struct {
	value *BiosBootDeviceResponse
	isSet bool
}

func (v NullableBiosBootDeviceResponse) Get() *BiosBootDeviceResponse {
	return v.value
}

func (v *NullableBiosBootDeviceResponse) Set(val *BiosBootDeviceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBiosBootDeviceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBiosBootDeviceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBiosBootDeviceResponse(val *BiosBootDeviceResponse) *NullableBiosBootDeviceResponse {
	return &NullableBiosBootDeviceResponse{value: val, isSet: true}
}

func (v NullableBiosBootDeviceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBiosBootDeviceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
