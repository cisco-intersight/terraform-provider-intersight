...
type IamSystemResponse struct {
	IamSystemResponseInterface interface{ GetObjectType() string }
}

func (s IamSystemResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamSystemResponseInterface)
}

func (s *IamSystemResponse) UnmarshalJSON(src []byte) error {
	var err error
