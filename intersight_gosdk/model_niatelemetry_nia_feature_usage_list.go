...
func (o *NiatelemetryNiaFeatureUsageList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryNiaFeatureUsageListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryNiaFeatureUsageList)
	if err == nil {
