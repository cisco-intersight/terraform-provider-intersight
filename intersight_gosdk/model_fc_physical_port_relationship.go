...
type FcPhysicalPortRelationship struct {
	FcPhysicalPortRelationshipInterface interface{}
}

func (s FcPhysicalPortRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.FcPhysicalPortRelationshipInterface)
}

func (s *FcPhysicalPortRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledFcPhysicalPort *FcPhysicalPort = &FcPhysicalPort{}
	err = json.Unmarshal(src, unmarshaledFcPhysicalPort)
	if err == nil {
		s.FcPhysicalPortRelationshipInterface = unmarshaledFcPhysicalPort
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.FcPhysicalPortRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
