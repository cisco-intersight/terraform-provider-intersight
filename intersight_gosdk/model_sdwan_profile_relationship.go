...
type SdwanProfileRelationship struct {
	SdwanProfileRelationshipInterface interface{}
}

func (s SdwanProfileRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.SdwanProfileRelationshipInterface)
}

func (s *SdwanProfileRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.SdwanProfileRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledSdwanProfile *SdwanProfile = &SdwanProfile{}
	err = json.Unmarshal(src, unmarshaledSdwanProfile)
	if err == nil {
		s.SdwanProfileRelationshipInterface = unmarshaledSdwanProfile
		return nil
	}
