...
type ComputePhysicalRelationship struct {
	ComputePhysicalRelationshipInterface interface{}
}

func (s ComputePhysicalRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.ComputePhysicalRelationshipInterface)
}

func (s *ComputePhysicalRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledComputePhysical *ComputePhysical = &ComputePhysical{}
	err = json.Unmarshal(src, unmarshaledComputePhysical)
	if err == nil {
		s.ComputePhysicalRelationshipInterface = unmarshaledComputePhysical
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.ComputePhysicalRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
