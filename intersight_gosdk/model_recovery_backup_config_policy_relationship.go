...
type RecoveryBackupConfigPolicyRelationship struct {
	RecoveryBackupConfigPolicyRelationshipInterface interface{}
}

func (s RecoveryBackupConfigPolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.RecoveryBackupConfigPolicyRelationshipInterface)
}

func (s *RecoveryBackupConfigPolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.RecoveryBackupConfigPolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledRecoveryBackupConfigPolicy *RecoveryBackupConfigPolicy = &RecoveryBackupConfigPolicy{}
	err = json.Unmarshal(src, unmarshaledRecoveryBackupConfigPolicy)
	if err == nil {
		s.RecoveryBackupConfigPolicyRelationshipInterface = unmarshaledRecoveryBackupConfigPolicy
		return nil
	}
