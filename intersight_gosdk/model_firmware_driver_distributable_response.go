...
type FirmwareDriverDistributableResponse struct {
	FirmwareDriverDistributableResponseInterface interface{ GetObjectType() string }
}

func (s FirmwareDriverDistributableResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.FirmwareDriverDistributableResponseInterface)
}

func (s *FirmwareDriverDistributableResponse) UnmarshalJSON(src []byte) error {
	var err error
