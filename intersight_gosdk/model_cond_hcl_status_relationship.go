...
type CondHclStatusRelationship struct {
	CondHclStatusRelationshipInterface interface{}
}

func (s CondHclStatusRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.CondHclStatusRelationshipInterface)
}

func (s *CondHclStatusRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledCondHclStatus *CondHclStatus = &CondHclStatus{}
	err = json.Unmarshal(src, unmarshaledCondHclStatus)
	if err == nil {
		s.CondHclStatusRelationshipInterface = unmarshaledCondHclStatus
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.CondHclStatusRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
