...
type IamPrivateKeySpecRelationship struct {
	IamPrivateKeySpecRelationshipInterface interface{}
}

func (s IamPrivateKeySpecRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamPrivateKeySpecRelationshipInterface)
}

func (s *IamPrivateKeySpecRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamPrivateKeySpec *IamPrivateKeySpec = &IamPrivateKeySpec{}
	err = json.Unmarshal(src, unmarshaledIamPrivateKeySpec)
	if err == nil {
		s.IamPrivateKeySpecRelationshipInterface = unmarshaledIamPrivateKeySpec
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamPrivateKeySpecRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
