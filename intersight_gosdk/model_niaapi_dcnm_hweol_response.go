...
type NiaapiDcnmHweolResponse struct {
	NiaapiDcnmHweolResponseInterface interface{ GetObjectType() string }
}

func (s NiaapiDcnmHweolResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.NiaapiDcnmHweolResponseInterface)
}

func (s *NiaapiDcnmHweolResponse) UnmarshalJSON(src []byte) error {
	var err error
