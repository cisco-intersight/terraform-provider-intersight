...
type PortGroupRelationship struct {
	PortGroupRelationshipInterface interface{}
}

func (s PortGroupRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.PortGroupRelationshipInterface)
}

func (s *PortGroupRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.PortGroupRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledPortGroup *PortGroup = &PortGroup{}
	err = json.Unmarshal(src, unmarshaledPortGroup)
	if err == nil {
		s.PortGroupRelationshipInterface = unmarshaledPortGroup
		return nil
	}
