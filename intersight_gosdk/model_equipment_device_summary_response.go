...
type EquipmentDeviceSummaryResponse struct {
	EquipmentDeviceSummaryResponseInterface interface{ GetObjectType() string }
}

func (s EquipmentDeviceSummaryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.EquipmentDeviceSummaryResponseInterface)
}

func (s *EquipmentDeviceSummaryResponse) UnmarshalJSON(src []byte) error {
	var err error
