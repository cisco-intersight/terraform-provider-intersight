...
type ComputeServerSettingResponse struct {
	ComputeServerSettingResponseInterface interface{ GetObjectType() string }
}

func (s ComputeServerSettingResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.ComputeServerSettingResponseInterface)
}

func (s *ComputeServerSettingResponse) UnmarshalJSON(src []byte) error {
	var err error
