...
type FirmwareUpgradeResponse struct {
	FirmwareUpgradeResponseInterface interface{ GetObjectType() string }
}

func (s FirmwareUpgradeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.FirmwareUpgradeResponseInterface)
}

func (s *FirmwareUpgradeResponse) UnmarshalJSON(src []byte) error {
	var err error
