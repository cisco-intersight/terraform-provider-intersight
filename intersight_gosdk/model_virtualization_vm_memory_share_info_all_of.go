...
// VirtualizationVmMemoryShareInfoAllOf Definition of the list of properties defined in 'virtualization.VmMemoryShareInfo', excluding properties defined in parent classes.
type VirtualizationVmMemoryShareInfoAllOf struct {
...
func NewVirtualizationVmMemoryShareInfoAllOf() *VirtualizationVmMemoryShareInfoAllOf {
	this := VirtualizationVmMemoryShareInfoAllOf{}
	return &this
}
...
func (o VirtualizationVmMemoryShareInfoAllOf) MarshalJSON() ([]byte, error) {
...
type NullableVirtualizationVmMemoryShareInfoAllOf struct {
	value *VirtualizationVmMemoryShareInfoAllOf
	isSet bool
}

func (v NullableVirtualizationVmMemoryShareInfoAllOf) Get() *VirtualizationVmMemoryShareInfoAllOf {
	return v.value
}

func (v *NullableVirtualizationVmMemoryShareInfoAllOf) Set(val *VirtualizationVmMemoryShareInfoAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVmMemoryShareInfoAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVmMemoryShareInfoAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVmMemoryShareInfoAllOf(val *VirtualizationVmMemoryShareInfoAllOf) *NullableVirtualizationVmMemoryShareInfoAllOf {
	return &NullableVirtualizationVmMemoryShareInfoAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationVmMemoryShareInfoAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVmMemoryShareInfoAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
