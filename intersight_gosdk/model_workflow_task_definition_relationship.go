...
type WorkflowTaskDefinitionRelationship struct {
	WorkflowTaskDefinitionRelationshipInterface interface{}
}

func (s WorkflowTaskDefinitionRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.WorkflowTaskDefinitionRelationshipInterface)
}

func (s *WorkflowTaskDefinitionRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.WorkflowTaskDefinitionRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledWorkflowTaskDefinition *WorkflowTaskDefinition = &WorkflowTaskDefinition{}
	err = json.Unmarshal(src, unmarshaledWorkflowTaskDefinition)
	if err == nil {
		s.WorkflowTaskDefinitionRelationshipInterface = unmarshaledWorkflowTaskDefinition
		return nil
	}
