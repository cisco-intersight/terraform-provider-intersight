...
func (dst *CondHclStatusResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "cond.HclStatus.List" {
		// try to unmarshal JSON data into CondHclStatusList
		err = json.Unmarshal(data, &dst.CondHclStatusList)
		if err == nil {
			return nil // data stored in dst.CondHclStatusList, return on the first match
		} else {
			dst.CondHclStatusList = nil
			return fmt.Errorf("Failed to unmarshal CondHclStatusResponse as CondHclStatusList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CondHclStatusResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CondHclStatusResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CondHclStatusResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src CondHclStatusResponse) MarshalJSON() ([]byte, error) {
	if src.CondHclStatusList != nil {
		return json.Marshal(&src.CondHclStatusList)
	}
...
type NullableCondHclStatusResponse struct {
	value *CondHclStatusResponse
	isSet bool
}

func (v NullableCondHclStatusResponse) Get() *CondHclStatusResponse {
	return v.value
}

func (v *NullableCondHclStatusResponse) Set(val *CondHclStatusResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCondHclStatusResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCondHclStatusResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCondHclStatusResponse(val *CondHclStatusResponse) *NullableCondHclStatusResponse {
	return &NullableCondHclStatusResponse{value: val, isSet: true}
}

func (v NullableCondHclStatusResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCondHclStatusResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
