...
type ResourceMembershipHolderRelationship struct {
	ResourceMembershipHolderRelationshipInterface interface{}
}

func (s ResourceMembershipHolderRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.ResourceMembershipHolderRelationshipInterface)
}

func (s *ResourceMembershipHolderRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.ResourceMembershipHolderRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledResourceMembershipHolder *ResourceMembershipHolder = &ResourceMembershipHolder{}
	err = json.Unmarshal(src, unmarshaledResourceMembershipHolder)
	if err == nil {
		s.ResourceMembershipHolderRelationshipInterface = unmarshaledResourceMembershipHolder
		return nil
	}
