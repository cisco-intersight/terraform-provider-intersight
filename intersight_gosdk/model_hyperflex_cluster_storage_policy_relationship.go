...
type HyperflexClusterStoragePolicyRelationship struct {
	HyperflexClusterStoragePolicyRelationshipInterface interface{}
}

func (s HyperflexClusterStoragePolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexClusterStoragePolicyRelationshipInterface)
}

func (s *HyperflexClusterStoragePolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexClusterStoragePolicy *HyperflexClusterStoragePolicy = &HyperflexClusterStoragePolicy{}
	err = json.Unmarshal(src, unmarshaledHyperflexClusterStoragePolicy)
	if err == nil {
		s.HyperflexClusterStoragePolicyRelationshipInterface = unmarshaledHyperflexClusterStoragePolicy
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexClusterStoragePolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
