...
type EquipmentLocatorLedRelationship struct {
	EquipmentLocatorLedRelationshipInterface interface{}
}

func (s EquipmentLocatorLedRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.EquipmentLocatorLedRelationshipInterface)
}

func (s *EquipmentLocatorLedRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledEquipmentLocatorLed *EquipmentLocatorLed = &EquipmentLocatorLed{}
	err = json.Unmarshal(src, unmarshaledEquipmentLocatorLed)
	if err == nil {
		s.EquipmentLocatorLedRelationshipInterface = unmarshaledEquipmentLocatorLed
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.EquipmentLocatorLedRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
