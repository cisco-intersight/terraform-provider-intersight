...
type IamApiKeyRelationship struct {
	IamApiKeyRelationshipInterface interface{}
}

func (s IamApiKeyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamApiKeyRelationshipInterface)
}

func (s *IamApiKeyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamApiKey *IamApiKey = &IamApiKey{}
	err = json.Unmarshal(src, unmarshaledIamApiKey)
	if err == nil {
		s.IamApiKeyRelationshipInterface = unmarshaledIamApiKey
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamApiKeyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
