...
type PciLinkRelationship struct {
	PciLinkRelationshipInterface interface{}
}

func (s PciLinkRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.PciLinkRelationshipInterface)
}

func (s *PciLinkRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.PciLinkRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledPciLink *PciLink = &PciLink{}
	err = json.Unmarshal(src, unmarshaledPciLink)
	if err == nil {
		s.PciLinkRelationshipInterface = unmarshaledPciLink
		return nil
	}
