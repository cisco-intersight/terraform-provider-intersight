...
type _MoTagSummary MoTagSummary
...
func (o *MoTagSummary) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varMoTagSummary.Results = varMoTagSummaryWithoutEmbeddedStruct.Results
		*o = MoTagSummary(varMoTagSummary)
	} else {
		return err
	}
...
type NullableMoTagSummary struct {
	value *MoTagSummary
	isSet bool
}

func (v NullableMoTagSummary) Get() *MoTagSummary {
	return v.value
}

func (v *NullableMoTagSummary) Set(val *MoTagSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableMoTagSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableMoTagSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMoTagSummary(val *MoTagSummary) *NullableMoTagSummary {
	return &NullableMoTagSummary{value: val, isSet: true}
}

func (v NullableMoTagSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMoTagSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
