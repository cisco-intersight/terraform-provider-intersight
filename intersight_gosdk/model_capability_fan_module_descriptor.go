...
func (o *CapabilityFanModuleDescriptor) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCapabilityFanModuleDescriptorWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varCapabilityFanModuleDescriptor)
	if err == nil {
