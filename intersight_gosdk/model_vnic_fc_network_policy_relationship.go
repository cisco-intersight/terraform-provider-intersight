...
type VnicFcNetworkPolicyRelationship struct {
	VnicFcNetworkPolicyRelationshipInterface interface{}
}

func (s VnicFcNetworkPolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.VnicFcNetworkPolicyRelationshipInterface)
}

func (s *VnicFcNetworkPolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.VnicFcNetworkPolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledVnicFcNetworkPolicy *VnicFcNetworkPolicy = &VnicFcNetworkPolicy{}
	err = json.Unmarshal(src, unmarshaledVnicFcNetworkPolicy)
	if err == nil {
		s.VnicFcNetworkPolicyRelationshipInterface = unmarshaledVnicFcNetworkPolicy
		return nil
	}
