...
type SmtpPolicyResponse struct {
	SmtpPolicyResponseInterface interface{ GetObjectType() string }
}

func (s SmtpPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.SmtpPolicyResponseInterface)
}

func (s *SmtpPolicyResponse) UnmarshalJSON(src []byte) error {
	var err error
