...
type RecoveryConfigResultResponse struct {
	RecoveryConfigResultResponseInterface interface{ GetObjectType() string }
}

func (s RecoveryConfigResultResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.RecoveryConfigResultResponseInterface)
}

func (s *RecoveryConfigResultResponse) UnmarshalJSON(src []byte) error {
	var err error
