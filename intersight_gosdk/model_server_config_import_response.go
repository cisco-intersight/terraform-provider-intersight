...
func (dst *ServerConfigImportResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ServerConfigImportResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ServerConfigImportResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ServerConfigImportResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'server.ConfigImport.List'
	if jsonDict["ObjectType"] == "server.ConfigImport.List" {
		// try to unmarshal JSON data into ServerConfigImportList
		err = json.Unmarshal(data, &dst.ServerConfigImportList)
		if err == nil {
			return nil // data stored in dst.ServerConfigImportList, return on the first match
		} else {
			dst.ServerConfigImportList = nil
			return fmt.Errorf("Failed to unmarshal ServerConfigImportResponse as ServerConfigImportList: %s", err.Error())
		}
	}
...
func (src ServerConfigImportResponse) MarshalJSON() ([]byte, error) {
	...
	if src.ServerConfigImportList != nil {
		return json.Marshal(&src.ServerConfigImportList)
	}
...
func (obj *ServerConfigImportResponse) GetActualInstance() interface{} {
	...
	if obj.ServerConfigImportList != nil {
		return obj.ServerConfigImportList
	}
...
type NullableServerConfigImportResponse struct {
	value *ServerConfigImportResponse
	isSet bool
}

func (v NullableServerConfigImportResponse) Get() *ServerConfigImportResponse {
	return v.value
}

func (v *NullableServerConfigImportResponse) Set(val *ServerConfigImportResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableServerConfigImportResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableServerConfigImportResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerConfigImportResponse(val *ServerConfigImportResponse) *NullableServerConfigImportResponse {
	return &NullableServerConfigImportResponse{value: val, isSet: true}
}

func (v NullableServerConfigImportResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerConfigImportResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
