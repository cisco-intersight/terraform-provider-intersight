...
type IamPermissionRelationship struct {
	IamPermissionRelationshipInterface interface{}
}

func (s IamPermissionRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamPermissionRelationshipInterface)
}

func (s *IamPermissionRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamPermission *IamPermission = &IamPermission{}
	err = json.Unmarshal(src, unmarshaledIamPermission)
	if err == nil {
		s.IamPermissionRelationshipInterface = unmarshaledIamPermission
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamPermissionRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
