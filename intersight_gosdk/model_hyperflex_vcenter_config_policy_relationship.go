...
type HyperflexVcenterConfigPolicyRelationship struct {
	HyperflexVcenterConfigPolicyRelationshipInterface interface{}
}

func (s HyperflexVcenterConfigPolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexVcenterConfigPolicyRelationshipInterface)
}

func (s *HyperflexVcenterConfigPolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexVcenterConfigPolicy *HyperflexVcenterConfigPolicy = &HyperflexVcenterConfigPolicy{}
	err = json.Unmarshal(src, unmarshaledHyperflexVcenterConfigPolicy)
	if err == nil {
		s.HyperflexVcenterConfigPolicyRelationshipInterface = unmarshaledHyperflexVcenterConfigPolicy
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexVcenterConfigPolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
