...
type SdwanVmanageAccountPolicyResponse struct {
	SdwanVmanageAccountPolicyResponseInterface interface{ GetObjectType() string }
}

func (s SdwanVmanageAccountPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.SdwanVmanageAccountPolicyResponseInterface)
}

func (s *SdwanVmanageAccountPolicyResponse) UnmarshalJSON(src []byte) error {
	var err error
