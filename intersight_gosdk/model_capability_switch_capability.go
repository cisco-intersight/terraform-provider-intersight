...
func (o *CapabilitySwitchCapability) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varCapabilitySwitchCapability.MaxActiveSpanSessions = varCapabilitySwitchCapabilityWithoutEmbeddedStruct.MaxActiveSpanSessions
		varCapabilitySwitchCapability.MaxEthernetPortChannelMembers = varCapabilitySwitchCapabilityWithoutEmbeddedStruct.MaxEthernetPortChannelMembers
		varCapabilitySwitchCapability.MaxEthernetPortChannels = varCapabilitySwitchCapabilityWithoutEmbeddedStruct.MaxEthernetPortChannels
		varCapabilitySwitchCapability.MaxEthernetUplinkPorts = varCapabilitySwitchCapabilityWithoutEmbeddedStruct.MaxEthernetUplinkPorts
		varCapabilitySwitchCapability.MaxFcFcoePortChannels = varCapabilitySwitchCapabilityWithoutEmbeddedStruct.MaxFcFcoePortChannels
		varCapabilitySwitchCapability.MaxFcPortChannelMembers = varCapabilitySwitchCapabilityWithoutEmbeddedStruct.MaxFcPortChannelMembers
		varCapabilitySwitchCapability.MaxFcoePortChannelMembers = varCapabilitySwitchCapabilityWithoutEmbeddedStruct.MaxFcoePortChannelMembers
		...
		varCapabilitySwitchCapability.MaxVsansSupported = varCapabilitySwitchCapabilityWithoutEmbeddedStruct.MaxVsansSupported
		varCapabilitySwitchCapability.MinActiveFans = varCapabilitySwitchCapabilityWithoutEmbeddedStruct.MinActiveFans
		...
		varCapabilitySwitchCapability.VpCompressionSupported = varCapabilitySwitchCapabilityWithoutEmbeddedStruct.VpCompressionSupported
