...
func (r apiCreateFeedbackFeedbackPostRequest) Execute() (FeedbackFeedbackPost, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "FeedbackApiService.CreateFeedbackFeedbackPost")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/feedback/FeedbackPosts"
