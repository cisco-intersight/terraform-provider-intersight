...
// FabricVlanListAllOf struct for FabricVlanListAllOf
type FabricVlanListAllOf struct {
...
type _FabricVlanListAllOf FabricVlanListAllOf
...
func (o FabricVlanListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FabricVlanListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFabricVlanListAllOf := _FabricVlanListAllOf{}

	if err = json.Unmarshal(bytes, &varFabricVlanListAllOf); err == nil {
		*o = FabricVlanListAllOf(varFabricVlanListAllOf)
	}
...
type NullableFabricVlanListAllOf struct {
	value *FabricVlanListAllOf
	isSet bool
}

func (v NullableFabricVlanListAllOf) Get() *FabricVlanListAllOf {
	return v.value
}

func (v *NullableFabricVlanListAllOf) Set(val *FabricVlanListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFabricVlanListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFabricVlanListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFabricVlanListAllOf(val *FabricVlanListAllOf) *NullableFabricVlanListAllOf {
	return &NullableFabricVlanListAllOf{value: val, isSet: true}
}

func (v NullableFabricVlanListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFabricVlanListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
