...
type RecoveryConfigResultEntryResponse struct {
	RecoveryConfigResultEntryResponseInterface interface{ GetObjectType() string }
}

func (s RecoveryConfigResultEntryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.RecoveryConfigResultEntryResponseInterface)
}

func (s *RecoveryConfigResultEntryResponse) UnmarshalJSON(src []byte) error {
	var err error
