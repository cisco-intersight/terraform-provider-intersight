...
type TopSystemRelationship struct {
	TopSystemRelationshipInterface interface{}
}

func (s TopSystemRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.TopSystemRelationshipInterface)
}

func (s *TopSystemRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.TopSystemRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledTopSystem *TopSystem = &TopSystem{}
	err = json.Unmarshal(src, unmarshaledTopSystem)
	if err == nil {
		s.TopSystemRelationshipInterface = unmarshaledTopSystem
		return nil
	}
