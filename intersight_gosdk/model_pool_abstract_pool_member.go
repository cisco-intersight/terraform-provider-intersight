...
func (o *PoolAbstractPoolMember) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varPoolAbstractPoolMember.AssignedToMoid = varPoolAbstractPoolMemberWithoutEmbeddedStruct.AssignedToMoid
		varPoolAbstractPoolMember.AssignedToType = varPoolAbstractPoolMemberWithoutEmbeddedStruct.AssignedToType
