...
type WorkflowWorkflowDefinitionRelationship struct {
	WorkflowWorkflowDefinitionRelationshipInterface interface{}
}

func (s WorkflowWorkflowDefinitionRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.WorkflowWorkflowDefinitionRelationshipInterface)
}

func (s *WorkflowWorkflowDefinitionRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.WorkflowWorkflowDefinitionRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledWorkflowWorkflowDefinition *WorkflowWorkflowDefinition = &WorkflowWorkflowDefinition{}
	err = json.Unmarshal(src, unmarshaledWorkflowWorkflowDefinition)
	if err == nil {
		s.WorkflowWorkflowDefinitionRelationshipInterface = unmarshaledWorkflowWorkflowDefinition
		return nil
	}
