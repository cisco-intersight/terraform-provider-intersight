...
type BootPrecisionPolicyResponse struct {
	BootPrecisionPolicyResponseInterface interface{ GetObjectType() string }
}

func (s BootPrecisionPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.BootPrecisionPolicyResponseInterface)
}

func (s *BootPrecisionPolicyResponse) UnmarshalJSON(src []byte) error {
	var err error
