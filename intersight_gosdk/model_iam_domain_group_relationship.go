...
type IamDomainGroupRelationship struct {
	IamDomainGroupRelationshipInterface interface{}
}

func (s IamDomainGroupRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamDomainGroupRelationshipInterface)
}

func (s *IamDomainGroupRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamDomainGroup *IamDomainGroup = &IamDomainGroup{}
	err = json.Unmarshal(src, unmarshaledIamDomainGroup)
	if err == nil {
		s.IamDomainGroupRelationshipInterface = unmarshaledIamDomainGroup
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamDomainGroupRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
