...
type EquipmentSwitchCardRelationship struct {
	EquipmentSwitchCardRelationshipInterface interface{}
}

func (s EquipmentSwitchCardRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.EquipmentSwitchCardRelationshipInterface)
}

func (s *EquipmentSwitchCardRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledEquipmentSwitchCard *EquipmentSwitchCard = &EquipmentSwitchCard{}
	err = json.Unmarshal(src, unmarshaledEquipmentSwitchCard)
	if err == nil {
		s.EquipmentSwitchCardRelationshipInterface = unmarshaledEquipmentSwitchCard
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.EquipmentSwitchCardRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
