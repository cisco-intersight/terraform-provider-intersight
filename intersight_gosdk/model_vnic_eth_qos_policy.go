...
// VnicEthQosPolicy An Ethernet Quality of Service (QoS) policy assigns a system class to the outgoing traffic for a vNIC. This system class determines the quality of service for the outgoing traffic. For certain adapters you can also specify additional controls like burst and rate on the outgoing traffic.
...
// AsVnicEthQosPolicyRelationship wraps this instance of VnicEthQosPolicy in VnicEthQosPolicyRelationship
func (s *VnicEthQosPolicy) AsVnicEthQosPolicyRelationship() VnicEthQosPolicyRelationship {
