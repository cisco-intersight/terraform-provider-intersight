...
type SdwanRouterPolicyResponse struct {
	SdwanRouterPolicyResponseInterface interface{ GetObjectType() string }
}

func (s SdwanRouterPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.SdwanRouterPolicyResponseInterface)
}

func (s *SdwanRouterPolicyResponse) UnmarshalJSON(src []byte) error {
	var err error
