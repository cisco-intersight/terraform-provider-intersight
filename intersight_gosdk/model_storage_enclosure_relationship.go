...
type StorageEnclosureRelationship struct {
	StorageEnclosureRelationshipInterface interface{}
}

func (s StorageEnclosureRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageEnclosureRelationshipInterface)
}

func (s *StorageEnclosureRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StorageEnclosureRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStorageEnclosure *StorageEnclosure = &StorageEnclosure{}
	err = json.Unmarshal(src, unmarshaledStorageEnclosure)
	if err == nil {
		s.StorageEnclosureRelationshipInterface = unmarshaledStorageEnclosure
		return nil
	}
