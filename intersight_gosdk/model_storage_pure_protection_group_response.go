...
type StoragePureProtectionGroupResponse struct {
	StoragePureProtectionGroupResponseInterface interface{ GetObjectType() string }
}

func (s StoragePureProtectionGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StoragePureProtectionGroupResponseInterface)
}

func (s *StoragePureProtectionGroupResponse) UnmarshalJSON(src []byte) error {
	var err error
