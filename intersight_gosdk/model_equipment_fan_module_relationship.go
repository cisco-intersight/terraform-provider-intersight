...
type EquipmentFanModuleRelationship struct {
	EquipmentFanModuleRelationshipInterface interface{}
}

func (s EquipmentFanModuleRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.EquipmentFanModuleRelationshipInterface)
}

func (s *EquipmentFanModuleRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledEquipmentFanModule *EquipmentFanModule = &EquipmentFanModule{}
	err = json.Unmarshal(src, unmarshaledEquipmentFanModule)
	if err == nil {
		s.EquipmentFanModuleRelationshipInterface = unmarshaledEquipmentFanModule
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.EquipmentFanModuleRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
