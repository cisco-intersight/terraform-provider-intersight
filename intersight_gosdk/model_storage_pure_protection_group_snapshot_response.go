...
type StoragePureProtectionGroupSnapshotResponse struct {
	StoragePureProtectionGroupSnapshotResponseInterface interface{ GetObjectType() string }
}

func (s StoragePureProtectionGroupSnapshotResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StoragePureProtectionGroupSnapshotResponseInterface)
}

func (s *StoragePureProtectionGroupSnapshotResponse) UnmarshalJSON(src []byte) error {
	var err error
