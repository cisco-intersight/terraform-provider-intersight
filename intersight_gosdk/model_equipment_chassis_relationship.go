...
type EquipmentChassisRelationship struct {
	EquipmentChassisRelationshipInterface interface{}
}

func (s EquipmentChassisRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.EquipmentChassisRelationshipInterface)
}

func (s *EquipmentChassisRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledEquipmentChassis *EquipmentChassis = &EquipmentChassis{}
	err = json.Unmarshal(src, unmarshaledEquipmentChassis)
	if err == nil {
		s.EquipmentChassisRelationshipInterface = unmarshaledEquipmentChassis
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.EquipmentChassisRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
