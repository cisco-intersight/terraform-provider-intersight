...
type SdwanRouterNodeResponse struct {
	SdwanRouterNodeResponseInterface interface{ GetObjectType() string }
}

func (s SdwanRouterNodeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.SdwanRouterNodeResponseInterface)
}

func (s *SdwanRouterNodeResponse) UnmarshalJSON(src []byte) error {
	var err error
