...
type WorkflowPendingDynamicWorkflowInfo struct {
	...
	WorkflowMeta *map[string]interface{}           `json:"WorkflowMeta,omitempty"`
...
// AsWorkflowPendingDynamicWorkflowInfoRelationship wraps this instance of WorkflowPendingDynamicWorkflowInfo in WorkflowPendingDynamicWorkflowInfoRelationship
func (s *WorkflowPendingDynamicWorkflowInfo) AsWorkflowPendingDynamicWorkflowInfoRelationship() WorkflowPendingDynamicWorkflowInfoRelationship {
