...
type VirtualizationVmwareDatacenterRelationship struct {
	VirtualizationVmwareDatacenterRelationshipInterface interface{}
}

func (s VirtualizationVmwareDatacenterRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.VirtualizationVmwareDatacenterRelationshipInterface)
}

func (s *VirtualizationVmwareDatacenterRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.VirtualizationVmwareDatacenterRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledVirtualizationVmwareDatacenter *VirtualizationVmwareDatacenter = &VirtualizationVmwareDatacenter{}
	err = json.Unmarshal(src, unmarshaledVirtualizationVmwareDatacenter)
	if err == nil {
		s.VirtualizationVmwareDatacenterRelationshipInterface = unmarshaledVirtualizationVmwareDatacenter
		return nil
	}
