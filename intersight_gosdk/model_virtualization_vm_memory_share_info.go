...
// VirtualizationVmMemoryShareInfo Information about the virtual machine's memory sharing and limits. For more information, see VMware documentation.
...
func NewVirtualizationVmMemoryShareInfo() *VirtualizationVmMemoryShareInfo {
	this := VirtualizationVmMemoryShareInfo{}
	return &this
}
...
func (o VirtualizationVmMemoryShareInfo) MarshalJSON() ([]byte, error) {
...
type NullableVirtualizationVmMemoryShareInfo struct {
	value *VirtualizationVmMemoryShareInfo
	isSet bool
}

func (v NullableVirtualizationVmMemoryShareInfo) Get() *VirtualizationVmMemoryShareInfo {
	return v.value
}

func (v *NullableVirtualizationVmMemoryShareInfo) Set(val *VirtualizationVmMemoryShareInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVmMemoryShareInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVmMemoryShareInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVmMemoryShareInfo(val *VirtualizationVmMemoryShareInfo) *NullableVirtualizationVmMemoryShareInfo {
	return &NullableVirtualizationVmMemoryShareInfo{value: val, isSet: true}
}

func (v NullableVirtualizationVmMemoryShareInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVmMemoryShareInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
