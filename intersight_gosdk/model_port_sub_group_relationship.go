...
type PortSubGroupRelationship struct {
	PortSubGroupRelationshipInterface interface{}
}

func (s PortSubGroupRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.PortSubGroupRelationshipInterface)
}

func (s *PortSubGroupRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.PortSubGroupRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledPortSubGroup *PortSubGroup = &PortSubGroup{}
	err = json.Unmarshal(src, unmarshaledPortSubGroup)
	if err == nil {
		s.PortSubGroupRelationshipInterface = unmarshaledPortSubGroup
		return nil
	}
