...
type EquipmentTpmRelationship struct {
	EquipmentTpmRelationshipInterface interface{}
}

func (s EquipmentTpmRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.EquipmentTpmRelationshipInterface)
}

func (s *EquipmentTpmRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledEquipmentTpm *EquipmentTpm = &EquipmentTpm{}
	err = json.Unmarshal(src, unmarshaledEquipmentTpm)
	if err == nil {
		s.EquipmentTpmRelationshipInterface = unmarshaledEquipmentTpm
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.EquipmentTpmRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
