...
type ProcessorUnitResponse struct {
	ProcessorUnitResponseInterface interface{ GetObjectType() string }
}

func (s ProcessorUnitResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.ProcessorUnitResponseInterface)
}

func (s *ProcessorUnitResponse) UnmarshalJSON(src []byte) error {
	var err error
