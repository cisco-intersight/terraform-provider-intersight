...
type _VnicVxlanSettingsAllOf VnicVxlanSettingsAllOf
...
func (o *VnicVxlanSettingsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVnicVxlanSettingsAllOf := _VnicVxlanSettingsAllOf{}

	if err = json.Unmarshal(bytes, &varVnicVxlanSettingsAllOf); err == nil {
		*o = VnicVxlanSettingsAllOf(varVnicVxlanSettingsAllOf)
	}
