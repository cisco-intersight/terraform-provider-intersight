...
type StorageSasPortRelationship struct {
	StorageSasPortRelationshipInterface interface{}
}

func (s StorageSasPortRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageSasPortRelationshipInterface)
}

func (s *StorageSasPortRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StorageSasPortRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStorageSasPort *StorageSasPort = &StorageSasPort{}
	err = json.Unmarshal(src, unmarshaledStorageSasPort)
	if err == nil {
		s.StorageSasPortRelationshipInterface = unmarshaledStorageSasPort
		return nil
	}
