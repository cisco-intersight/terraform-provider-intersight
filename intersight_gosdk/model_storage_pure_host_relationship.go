...
type StoragePureHostRelationship struct {
	StoragePureHostRelationshipInterface interface{}
}

func (s StoragePureHostRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StoragePureHostRelationshipInterface)
}

func (s *StoragePureHostRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StoragePureHostRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStoragePureHost *StoragePureHost = &StoragePureHost{}
	err = json.Unmarshal(src, unmarshaledStoragePureHost)
	if err == nil {
		s.StoragePureHostRelationshipInterface = unmarshaledStoragePureHost
		return nil
	}
