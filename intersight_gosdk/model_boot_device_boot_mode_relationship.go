...
type BootDeviceBootModeRelationship struct {
	BootDeviceBootModeRelationshipInterface interface{}
}

func (s BootDeviceBootModeRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.BootDeviceBootModeRelationshipInterface)
}

func (s *BootDeviceBootModeRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledBootDeviceBootMode *BootDeviceBootMode = &BootDeviceBootMode{}
	err = json.Unmarshal(src, unmarshaledBootDeviceBootMode)
	if err == nil {
		s.BootDeviceBootModeRelationshipInterface = unmarshaledBootDeviceBootMode
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.BootDeviceBootModeRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
