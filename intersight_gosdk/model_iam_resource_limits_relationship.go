...
type IamResourceLimitsRelationship struct {
	IamResourceLimitsRelationshipInterface interface{}
}

func (s IamResourceLimitsRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamResourceLimitsRelationshipInterface)
}

func (s *IamResourceLimitsRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamResourceLimits *IamResourceLimits = &IamResourceLimits{}
	err = json.Unmarshal(src, unmarshaledIamResourceLimits)
	if err == nil {
		s.IamResourceLimitsRelationshipInterface = unmarshaledIamResourceLimits
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamResourceLimitsRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
