...
func (dst *ResourceMembershipResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ResourceMembershipResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ResourceMembershipResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ResourceMembershipResponse as MoTagSummary: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "resource.Membership.List" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ResourceMembershipResponse as ResourceMembershipList: %s", err.Error())
		}
	}
