...
// EquipmentChassisIdentity ChassisIdentity Object conatains connectivity information about IOMs of the chassis. ChassisID is uniquely allocated for the combination of vendor, model and serial number of the chassis.
type EquipmentChassisIdentity struct {
	EquipmentIdentity
...
type _EquipmentChassisIdentity EquipmentChassisIdentity
...
func (o EquipmentChassisIdentity) MarshalJSON() ([]byte, error) {
...
func (o *EquipmentChassisIdentity) UnmarshalJSON(bytes []byte) (err error) {
	type EquipmentChassisIdentityWithoutEmbeddedStruct struct {
		IoCardIdentityList *[]EquipmentIoCardIdentity    `json:"IoCardIdentityList,omitempty"`
		Chassis            *EquipmentChassisRelationship `json:"Chassis,omitempty"`
	}

	varEquipmentChassisIdentityWithoutEmbeddedStruct := EquipmentChassisIdentityWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varEquipmentChassisIdentityWithoutEmbeddedStruct)
	if err == nil {
		varEquipmentChassisIdentity := _EquipmentChassisIdentity{}
		varEquipmentChassisIdentity.IoCardIdentityList = varEquipmentChassisIdentityWithoutEmbeddedStruct.IoCardIdentityList
		varEquipmentChassisIdentity.Chassis = varEquipmentChassisIdentityWithoutEmbeddedStruct.Chassis
		*o = EquipmentChassisIdentity(varEquipmentChassisIdentity)
	} else {
		return err
	}
	...
	err = json.Unmarshal(bytes, &varEquipmentChassisIdentity)
	if err == nil {
		o.EquipmentIdentity = varEquipmentChassisIdentity.EquipmentIdentity
	} else {
		return err
	}
...
type NullableEquipmentChassisIdentity struct {
	value *EquipmentChassisIdentity
	isSet bool
}

func (v NullableEquipmentChassisIdentity) Get() *EquipmentChassisIdentity {
	return v.value
}

func (v *NullableEquipmentChassisIdentity) Set(val *EquipmentChassisIdentity) {
	v.value = val
	v.isSet = true
}

func (v NullableEquipmentChassisIdentity) IsSet() bool {
	return v.isSet
}

func (v *NullableEquipmentChassisIdentity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEquipmentChassisIdentity(val *EquipmentChassisIdentity) *NullableEquipmentChassisIdentity {
	return &NullableEquipmentChassisIdentity{value: val, isSet: true}
}

func (v NullableEquipmentChassisIdentity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEquipmentChassisIdentity) UnmarshalJSON(src []byte) error {
	v.isSet = true
