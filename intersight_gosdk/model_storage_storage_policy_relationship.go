...
type StorageStoragePolicyRelationship struct {
	StorageStoragePolicyRelationshipInterface interface{}
}

func (s StorageStoragePolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageStoragePolicyRelationshipInterface)
}

func (s *StorageStoragePolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StorageStoragePolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStorageStoragePolicy *StorageStoragePolicy = &StorageStoragePolicy{}
	err = json.Unmarshal(src, unmarshaledStorageStoragePolicy)
	if err == nil {
		s.StorageStoragePolicyRelationshipInterface = unmarshaledStorageStoragePolicy
		return nil
	}
