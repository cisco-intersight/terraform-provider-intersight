...
type _CapabilityIoCardCapabilityDefAllOf CapabilityIoCardCapabilityDefAllOf
...
func (o *CapabilityIoCardCapabilityDefAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCapabilityIoCardCapabilityDefAllOf := _CapabilityIoCardCapabilityDefAllOf{}

	if err = json.Unmarshal(bytes, &varCapabilityIoCardCapabilityDefAllOf); err == nil {
		*o = CapabilityIoCardCapabilityDefAllOf(varCapabilityIoCardCapabilityDefAllOf)
	}
