...
type _HclFirmwareAllOf HclFirmwareAllOf
...
func (o *HclFirmwareAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varHclFirmwareAllOf := _HclFirmwareAllOf{}

	if err = json.Unmarshal(bytes, &varHclFirmwareAllOf); err == nil {
		*o = HclFirmwareAllOf(varHclFirmwareAllOf)
	}
