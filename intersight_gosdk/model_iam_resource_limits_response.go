...
type IamResourceLimitsResponse struct {
	IamResourceLimitsResponseInterface interface{ GetObjectType() string }
}

func (s IamResourceLimitsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamResourceLimitsResponseInterface)
}

func (s *IamResourceLimitsResponse) UnmarshalJSON(src []byte) error {
	var err error
