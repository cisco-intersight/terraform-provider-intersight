...
type PortSubGroupResponse struct {
	PortSubGroupResponseInterface interface{ GetObjectType() string }
}

func (s PortSubGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.PortSubGroupResponseInterface)
}

func (s *PortSubGroupResponse) UnmarshalJSON(src []byte) error {
	var err error
