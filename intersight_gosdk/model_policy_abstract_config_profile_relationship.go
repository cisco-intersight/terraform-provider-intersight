...
type PolicyAbstractConfigProfileRelationship struct {
	PolicyAbstractConfigProfileRelationshipInterface interface{}
}

func (s PolicyAbstractConfigProfileRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.PolicyAbstractConfigProfileRelationshipInterface)
}

func (s *PolicyAbstractConfigProfileRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.PolicyAbstractConfigProfileRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledPolicyAbstractConfigProfile *PolicyAbstractConfigProfile = &PolicyAbstractConfigProfile{}
	err = json.Unmarshal(src, unmarshaledPolicyAbstractConfigProfile)
	if err == nil {
		s.PolicyAbstractConfigProfileRelationshipInterface = unmarshaledPolicyAbstractConfigProfile
		return nil
	}
