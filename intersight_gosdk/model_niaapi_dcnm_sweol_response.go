...
func (dst *NiaapiDcnmSweolResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal NiaapiDcnmSweolResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal NiaapiDcnmSweolResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal NiaapiDcnmSweolResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'niaapi.DcnmSweol.List'
	if jsonDict["ObjectType"] == "niaapi.DcnmSweol.List" {
		// try to unmarshal JSON data into NiaapiDcnmSweolList
		err = json.Unmarshal(data, &dst.NiaapiDcnmSweolList)
		if err == nil {
			return nil // data stored in dst.NiaapiDcnmSweolList, return on the first match
		} else {
			dst.NiaapiDcnmSweolList = nil
			return fmt.Errorf("Failed to unmarshal NiaapiDcnmSweolResponse as NiaapiDcnmSweolList: %s", err.Error())
		}
	}
...
func (src NiaapiDcnmSweolResponse) MarshalJSON() ([]byte, error) {
	...
	if src.NiaapiDcnmSweolList != nil {
		return json.Marshal(&src.NiaapiDcnmSweolList)
	}
...
func (obj *NiaapiDcnmSweolResponse) GetActualInstance() interface{} {
	...
	if obj.NiaapiDcnmSweolList != nil {
		return obj.NiaapiDcnmSweolList
	}
...
type NullableNiaapiDcnmSweolResponse struct {
	value *NiaapiDcnmSweolResponse
	isSet bool
}

func (v NullableNiaapiDcnmSweolResponse) Get() *NiaapiDcnmSweolResponse {
	return v.value
}

func (v *NullableNiaapiDcnmSweolResponse) Set(val *NiaapiDcnmSweolResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNiaapiDcnmSweolResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNiaapiDcnmSweolResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiaapiDcnmSweolResponse(val *NiaapiDcnmSweolResponse) *NullableNiaapiDcnmSweolResponse {
	return &NullableNiaapiDcnmSweolResponse{value: val, isSet: true}
}

func (v NullableNiaapiDcnmSweolResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiaapiDcnmSweolResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
