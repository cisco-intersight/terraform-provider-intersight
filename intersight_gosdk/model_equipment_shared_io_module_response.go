...
type EquipmentSharedIoModuleResponse struct {
	EquipmentSharedIoModuleResponseInterface interface{ GetObjectType() string }
}

func (s EquipmentSharedIoModuleResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.EquipmentSharedIoModuleResponseInterface)
}

func (s *EquipmentSharedIoModuleResponse) UnmarshalJSON(src []byte) error {
	var err error
