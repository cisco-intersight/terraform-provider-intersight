...
type HyperflexClusterNetworkPolicyRelationship struct {
	HyperflexClusterNetworkPolicyRelationshipInterface interface{}
}

func (s HyperflexClusterNetworkPolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexClusterNetworkPolicyRelationshipInterface)
}

func (s *HyperflexClusterNetworkPolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexClusterNetworkPolicy *HyperflexClusterNetworkPolicy = &HyperflexClusterNetworkPolicy{}
	err = json.Unmarshal(src, unmarshaledHyperflexClusterNetworkPolicy)
	if err == nil {
		s.HyperflexClusterNetworkPolicyRelationshipInterface = unmarshaledHyperflexClusterNetworkPolicy
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexClusterNetworkPolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
