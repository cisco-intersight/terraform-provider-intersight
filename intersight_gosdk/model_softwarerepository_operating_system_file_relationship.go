...
type SoftwarerepositoryOperatingSystemFileRelationship struct {
	SoftwarerepositoryOperatingSystemFileRelationshipInterface interface{}
}

func (s SoftwarerepositoryOperatingSystemFileRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.SoftwarerepositoryOperatingSystemFileRelationshipInterface)
}

func (s *SoftwarerepositoryOperatingSystemFileRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.SoftwarerepositoryOperatingSystemFileRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledSoftwarerepositoryOperatingSystemFile *SoftwarerepositoryOperatingSystemFile = &SoftwarerepositoryOperatingSystemFile{}
	err = json.Unmarshal(src, unmarshaledSoftwarerepositoryOperatingSystemFile)
	if err == nil {
		s.SoftwarerepositoryOperatingSystemFileRelationshipInterface = unmarshaledSoftwarerepositoryOperatingSystemFile
		return nil
	}
