...
type StorageDiskGroupPolicyRelationship struct {
	StorageDiskGroupPolicyRelationshipInterface interface{}
}

func (s StorageDiskGroupPolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageDiskGroupPolicyRelationshipInterface)
}

func (s *StorageDiskGroupPolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StorageDiskGroupPolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStorageDiskGroupPolicy *StorageDiskGroupPolicy = &StorageDiskGroupPolicy{}
	err = json.Unmarshal(src, unmarshaledStorageDiskGroupPolicy)
	if err == nil {
		s.StorageDiskGroupPolicyRelationshipInterface = unmarshaledStorageDiskGroupPolicy
		return nil
	}
