...
type HyperflexNodeProfileRelationship struct {
	HyperflexNodeProfileRelationshipInterface interface{}
}

func (s HyperflexNodeProfileRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexNodeProfileRelationshipInterface)
}

func (s *HyperflexNodeProfileRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexNodeProfile *HyperflexNodeProfile = &HyperflexNodeProfile{}
	err = json.Unmarshal(src, unmarshaledHyperflexNodeProfile)
	if err == nil {
		s.HyperflexNodeProfileRelationshipInterface = unmarshaledHyperflexNodeProfile
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexNodeProfileRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
