...
type IamUserGroupResponse struct {
	IamUserGroupResponseInterface interface{ GetObjectType() string }
}

func (s IamUserGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamUserGroupResponseInterface)
}

func (s *IamUserGroupResponse) UnmarshalJSON(src []byte) error {
	var err error
