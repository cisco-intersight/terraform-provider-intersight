...
type HyperflexExtFcStoragePolicyRelationship struct {
	HyperflexExtFcStoragePolicyRelationshipInterface interface{}
}

func (s HyperflexExtFcStoragePolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexExtFcStoragePolicyRelationshipInterface)
}

func (s *HyperflexExtFcStoragePolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexExtFcStoragePolicy *HyperflexExtFcStoragePolicy = &HyperflexExtFcStoragePolicy{}
	err = json.Unmarshal(src, unmarshaledHyperflexExtFcStoragePolicy)
	if err == nil {
		s.HyperflexExtFcStoragePolicyRelationshipInterface = unmarshaledHyperflexExtFcStoragePolicy
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexExtFcStoragePolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
