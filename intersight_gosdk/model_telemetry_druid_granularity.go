...
type TelemetryDruidGranularity struct {
	TelemetryDruidGranularityInterface interface{}
}

func (s TelemetryDruidGranularity) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.TelemetryDruidGranularityInterface)
}

func (s *TelemetryDruidGranularity) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledTelemetryDruidDurationGranularity *TelemetryDruidDurationGranularity = &TelemetryDruidDurationGranularity{}
	err = json.Unmarshal(src, unmarshaledTelemetryDruidDurationGranularity)
	if err == nil {
		s.TelemetryDruidGranularityInterface = unmarshaledTelemetryDruidDurationGranularity
		return nil
	}
	var unmarshaledTelemetryDruidPeriodGranularity *TelemetryDruidPeriodGranularity = &TelemetryDruidPeriodGranularity{}
	err = json.Unmarshal(src, unmarshaledTelemetryDruidPeriodGranularity)
	if err == nil {
		s.TelemetryDruidGranularityInterface = unmarshaledTelemetryDruidPeriodGranularity
		return nil
	}
