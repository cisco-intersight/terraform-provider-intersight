...
// VirtualizationVmCpuShareInfoAllOf Definition of the list of properties defined in 'virtualization.VmCpuShareInfo', excluding properties defined in parent classes.
type VirtualizationVmCpuShareInfoAllOf struct {
...
func NewVirtualizationVmCpuShareInfoAllOf() *VirtualizationVmCpuShareInfoAllOf {
	this := VirtualizationVmCpuShareInfoAllOf{}
	return &this
}
...
func (o VirtualizationVmCpuShareInfoAllOf) MarshalJSON() ([]byte, error) {
...
type NullableVirtualizationVmCpuShareInfoAllOf struct {
	value *VirtualizationVmCpuShareInfoAllOf
	isSet bool
}

func (v NullableVirtualizationVmCpuShareInfoAllOf) Get() *VirtualizationVmCpuShareInfoAllOf {
	return v.value
}

func (v *NullableVirtualizationVmCpuShareInfoAllOf) Set(val *VirtualizationVmCpuShareInfoAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVmCpuShareInfoAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVmCpuShareInfoAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVmCpuShareInfoAllOf(val *VirtualizationVmCpuShareInfoAllOf) *NullableVirtualizationVmCpuShareInfoAllOf {
	return &NullableVirtualizationVmCpuShareInfoAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationVmCpuShareInfoAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVmCpuShareInfoAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
