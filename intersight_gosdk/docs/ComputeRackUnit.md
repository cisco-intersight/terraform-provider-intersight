...
`func (o *ComputeRackUnit) GetUemConnection() InventoryUemConnectionRelationship`

GetUemConnection returns the UemConnection field if non-nil, zero value otherwise.

### GetUemConnectionOk

`func (o *ComputeRackUnit) GetUemConnectionOk() (*InventoryUemConnectionRelationship, bool)`
...
`func (o *ComputeRackUnit) SetUemConnection(v InventoryUemConnectionRelationship)`

SetUemConnection sets UemConnection field to given value.

### HasUemConnection

`func (o *ComputeRackUnit) HasUemConnection() bool`
