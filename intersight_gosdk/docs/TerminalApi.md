...
> TerminalAuditLog GetTerminalAuditLogByMoid(ctx, moid).Execute()
...
func main() {
    ...
    resp, r, err := api_client.TerminalApi.GetTerminalAuditLogByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TerminalApi.GetTerminalAuditLogByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTerminalAuditLogByMoid`: TerminalAuditLog
    fmt.Fprintf(os.Stdout, "Response from `TerminalApi.GetTerminalAuditLogByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTerminalAuditLogByMoidRequest struct via the builder pattern
...
## GetTerminalAuditLogList

> TerminalAuditLogResponse GetTerminalAuditLogList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TerminalApi.GetTerminalAuditLogList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TerminalApi.GetTerminalAuditLogList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTerminalAuditLogList`: TerminalAuditLogResponse
    fmt.Fprintf(os.Stdout, "Response from `TerminalApi.GetTerminalAuditLogList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTerminalAuditLogListRequest struct via the builder pattern
