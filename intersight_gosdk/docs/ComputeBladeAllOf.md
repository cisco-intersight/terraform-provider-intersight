...
`func (o *ComputeBladeAllOf) GetUemConnection() InventoryUemConnectionRelationship`

GetUemConnection returns the UemConnection field if non-nil, zero value otherwise.

### GetUemConnectionOk

`func (o *ComputeBladeAllOf) GetUemConnectionOk() (*InventoryUemConnectionRelationship, bool)`
...
`func (o *ComputeBladeAllOf) SetUemConnection(v InventoryUemConnectionRelationship)`

SetUemConnection sets UemConnection field to given value.

### HasUemConnection

`func (o *ComputeBladeAllOf) HasUemConnection() bool`
