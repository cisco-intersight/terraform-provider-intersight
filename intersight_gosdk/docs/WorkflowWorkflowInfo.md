...
**PauseReason** | Pointer to **string** | Denotes the reason workflow is in paused status. | [optional] [default to "None"]
...
`func (o *WorkflowWorkflowInfo) GetWorkflowCtx() interface{}`

GetWorkflowCtx returns the WorkflowCtx field if non-nil, zero value otherwise.

### GetWorkflowCtxOk

`func (o *WorkflowWorkflowInfo) GetWorkflowCtxOk() (*interface{}, bool)`
...
`func (o *WorkflowWorkflowInfo) SetWorkflowCtx(v interface{})`
