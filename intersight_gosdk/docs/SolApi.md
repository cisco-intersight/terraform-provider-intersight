...
------------- | ------------- | -------------
[**CreateSolPolicy**](SolApi.md#CreateSolPolicy) | **Post** /api/v1/sol/Policies | Create a &#39;sol.Policy&#39; resource.
[**DeleteSolPolicy**](SolApi.md#DeleteSolPolicy) | **Delete** /api/v1/sol/Policies/{Moid} | Delete a &#39;sol.Policy&#39; resource.
[**GetSolPolicyByMoid**](SolApi.md#GetSolPolicyByMoid) | **Get** /api/v1/sol/Policies/{Moid} | Read a &#39;sol.Policy&#39; resource.
[**GetSolPolicyList**](SolApi.md#GetSolPolicyList) | **Get** /api/v1/sol/Policies | Read a &#39;sol.Policy&#39; resource.
[**PatchSolPolicy**](SolApi.md#PatchSolPolicy) | **Patch** /api/v1/sol/Policies/{Moid} | Update a &#39;sol.Policy&#39; resource.
[**UpdateSolPolicy**](SolApi.md#UpdateSolPolicy) | **Post** /api/v1/sol/Policies/{Moid} | Update a &#39;sol.Policy&#39; resource.



## CreateSolPolicy

> SolPolicy CreateSolPolicy(ctx).SolPolicy(solPolicy).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
...
func main() {
    ...
    resp, r, err := api_client.SolApi.CreateSolPolicy(context.Background(), solPolicy).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SolApi.CreateSolPolicy``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CreateSolPolicy`: SolPolicy
    fmt.Fprintf(os.Stdout, "Response from `SolApi.CreateSolPolicy`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateSolPolicyRequest struct via the builder pattern
...
> DeleteSolPolicy(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SolApi.DeleteSolPolicy(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SolApi.DeleteSolPolicy``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDeleteSolPolicyRequest struct via the builder pattern
...
> SolPolicy GetSolPolicyByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SolApi.GetSolPolicyByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SolApi.GetSolPolicyByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetSolPolicyByMoid`: SolPolicy
    fmt.Fprintf(os.Stdout, "Response from `SolApi.GetSolPolicyByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSolPolicyByMoidRequest struct via the builder pattern
...
> SolPolicyResponse GetSolPolicyList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SolApi.GetSolPolicyList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SolApi.GetSolPolicyList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetSolPolicyList`: SolPolicyResponse
    fmt.Fprintf(os.Stdout, "Response from `SolApi.GetSolPolicyList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSolPolicyListRequest struct via the builder pattern
...
[**SolPolicyResponse**](sol.Policy.Response.md)
...
> SolPolicy PatchSolPolicy(ctx, moid).SolPolicy(solPolicy).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    solPolicy := openapiclient.sol.Policy{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, Description: "Description_example", Name: "Name_example", BaudRate: 123, ComPort: "ComPort_example", Enabled: false, SshPort: int64(123), Organization: , Profiles: []PolicyAbstractConfigProfileRelationship{)} // SolPolicy | The 'sol.Policy' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SolApi.PatchSolPolicy(context.Background(), moid, solPolicy).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SolApi.PatchSolPolicy``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchSolPolicy`: SolPolicy
    fmt.Fprintf(os.Stdout, "Response from `SolApi.PatchSolPolicy`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchSolPolicyRequest struct via the builder pattern
...
> SolPolicy UpdateSolPolicy(ctx, moid).SolPolicy(solPolicy).IfMatch(ifMatch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SolApi.UpdateSolPolicy(context.Background(), moid, solPolicy).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SolApi.UpdateSolPolicy``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateSolPolicy`: SolPolicy
    fmt.Fprintf(os.Stdout, "Response from `SolApi.UpdateSolPolicy`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateSolPolicyRequest struct via the builder pattern
