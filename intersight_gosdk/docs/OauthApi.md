...
------------- | ------------- | -------------
[**CreateOauthOauthUser**](OauthApi.md#CreateOauthOauthUser) | **Post** /api/v1/oauth/OauthUsers | Create a &#39;oauth.OauthUser&#39; resource.
[**DeleteOauthOauthUser**](OauthApi.md#DeleteOauthOauthUser) | **Delete** /api/v1/oauth/OauthUsers/{Moid} | Delete a &#39;oauth.OauthUser&#39; resource.
[**GetOauthOauthUserByMoid**](OauthApi.md#GetOauthOauthUserByMoid) | **Get** /api/v1/oauth/OauthUsers/{Moid} | Read a &#39;oauth.OauthUser&#39; resource.
[**GetOauthOauthUserList**](OauthApi.md#GetOauthOauthUserList) | **Get** /api/v1/oauth/OauthUsers | Read a &#39;oauth.OauthUser&#39; resource.
[**PatchOauthOauthUser**](OauthApi.md#PatchOauthOauthUser) | **Patch** /api/v1/oauth/OauthUsers/{Moid} | Update a &#39;oauth.OauthUser&#39; resource.
[**UpdateOauthOauthUser**](OauthApi.md#UpdateOauthOauthUser) | **Post** /api/v1/oauth/OauthUsers/{Moid} | Update a &#39;oauth.OauthUser&#39; resource.



## CreateOauthOauthUser

> OauthOauthUser CreateOauthOauthUser(ctx).OauthOauthUser(oauthOauthUser).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()

Create a 'oauth.OauthUser' resource.
...
func main() {
    ...
    resp, r, err := api_client.OauthApi.CreateOauthOauthUser(context.Background(), oauthOauthUser).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `OauthApi.CreateOauthOauthUser``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CreateOauthOauthUser`: OauthOauthUser
    fmt.Fprintf(os.Stdout, "Response from `OauthApi.CreateOauthOauthUser`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateOauthOauthUserRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **oauthOauthUser** | [**OauthOauthUser**](OauthOauthUser.md) | The &#39;oauth.OauthUser&#39; resource to create. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
 **ifNoneMatch** | **string** | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte. | 

### Return type

[**OauthOauthUser**](oauth.OauthUser.md)
...
## DeleteOauthOauthUser

> DeleteOauthOauthUser(ctx, moid).Execute()

Delete a 'oauth.OauthUser' resource.
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OauthApi.DeleteOauthOauthUser(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `OauthApi.DeleteOauthOauthUser``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDeleteOauthOauthUserRequest struct via the builder pattern
...
## GetOauthOauthUserByMoid

> OauthOauthUser GetOauthOauthUserByMoid(ctx, moid).Execute()

Read a 'oauth.OauthUser' resource.
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OauthApi.GetOauthOauthUserByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `OauthApi.GetOauthOauthUserByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetOauthOauthUserByMoid`: OauthOauthUser
    fmt.Fprintf(os.Stdout, "Response from `OauthApi.GetOauthOauthUserByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetOauthOauthUserByMoidRequest struct via the builder pattern
...
## GetOauthOauthUserList

> OauthOauthUserResponse GetOauthOauthUserList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OauthApi.GetOauthOauthUserList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `OauthApi.GetOauthOauthUserList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetOauthOauthUserList`: OauthOauthUserResponse
    fmt.Fprintf(os.Stdout, "Response from `OauthApi.GetOauthOauthUserList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetOauthOauthUserListRequest struct via the builder pattern
...
[**OauthOauthUserResponse**](oauth.OauthUser.Response.md)
...
> OauthOauthUser PatchOauthOauthUser(ctx, moid).OauthOauthUser(oauthOauthUser).IfMatch(ifMatch).Execute()

Update a 'oauth.OauthUser' resource.
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    oauthOauthUser := openapiclient.oauth.OauthUser{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, AccessTokens: []OauthAccessToken{openapiclient.oauth.AccessToken{ClassId: "ClassId_example", ObjectType: "ObjectType_example", ApiType: "ApiType_example", ExpiryTime: "TODO", Status: "Status_example", Token: "Token_example"}), UserId: "UserId_example", Account: } // OauthOauthUser | The 'oauth.OauthUser' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OauthApi.PatchOauthOauthUser(context.Background(), moid, oauthOauthUser).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `OauthApi.PatchOauthOauthUser``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchOauthOauthUser`: OauthOauthUser
    fmt.Fprintf(os.Stdout, "Response from `OauthApi.PatchOauthOauthUser`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchOauthOauthUserRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **oauthOauthUser** | [**OauthOauthUser**](OauthOauthUser.md) | The &#39;oauth.OauthUser&#39; resource to update. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
...
## UpdateOauthOauthUser

> OauthOauthUser UpdateOauthOauthUser(ctx, moid).OauthOauthUser(oauthOauthUser).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    oauthOauthUser :=  // OauthOauthUser | The 'oauth.OauthUser' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OauthApi.UpdateOauthOauthUser(context.Background(), moid, oauthOauthUser).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `OauthApi.UpdateOauthOauthUser``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateOauthOauthUser`: OauthOauthUser
    fmt.Fprintf(os.Stdout, "Response from `OauthApi.UpdateOauthOauthUser`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateOauthOauthUserRequest struct via the builder pattern
