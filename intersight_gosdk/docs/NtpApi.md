...
------------- | ------------- | -------------
[**CreateNtpPolicy**](NtpApi.md#CreateNtpPolicy) | **Post** /api/v1/ntp/Policies | Create a &#39;ntp.Policy&#39; resource.
[**DeleteNtpPolicy**](NtpApi.md#DeleteNtpPolicy) | **Delete** /api/v1/ntp/Policies/{Moid} | Delete a &#39;ntp.Policy&#39; resource.
[**GetNtpPolicyByMoid**](NtpApi.md#GetNtpPolicyByMoid) | **Get** /api/v1/ntp/Policies/{Moid} | Read a &#39;ntp.Policy&#39; resource.
[**GetNtpPolicyList**](NtpApi.md#GetNtpPolicyList) | **Get** /api/v1/ntp/Policies | Read a &#39;ntp.Policy&#39; resource.
[**PatchNtpPolicy**](NtpApi.md#PatchNtpPolicy) | **Patch** /api/v1/ntp/Policies/{Moid} | Update a &#39;ntp.Policy&#39; resource.
[**UpdateNtpPolicy**](NtpApi.md#UpdateNtpPolicy) | **Post** /api/v1/ntp/Policies/{Moid} | Update a &#39;ntp.Policy&#39; resource.



## CreateNtpPolicy

> NtpPolicy CreateNtpPolicy(ctx).NtpPolicy(ntpPolicy).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
...
func main() {
    ...
    resp, r, err := api_client.NtpApi.CreateNtpPolicy(context.Background(), ntpPolicy).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `NtpApi.CreateNtpPolicy``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CreateNtpPolicy`: NtpPolicy
    fmt.Fprintf(os.Stdout, "Response from `NtpApi.CreateNtpPolicy`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateNtpPolicyRequest struct via the builder pattern
...
> DeleteNtpPolicy(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.NtpApi.DeleteNtpPolicy(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `NtpApi.DeleteNtpPolicy``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDeleteNtpPolicyRequest struct via the builder pattern
...
> NtpPolicy GetNtpPolicyByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.NtpApi.GetNtpPolicyByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `NtpApi.GetNtpPolicyByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetNtpPolicyByMoid`: NtpPolicy
    fmt.Fprintf(os.Stdout, "Response from `NtpApi.GetNtpPolicyByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetNtpPolicyByMoidRequest struct via the builder pattern
...
> NtpPolicyResponse GetNtpPolicyList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.NtpApi.GetNtpPolicyList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `NtpApi.GetNtpPolicyList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetNtpPolicyList`: NtpPolicyResponse
    fmt.Fprintf(os.Stdout, "Response from `NtpApi.GetNtpPolicyList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetNtpPolicyListRequest struct via the builder pattern
...
> NtpPolicy PatchNtpPolicy(ctx, moid).NtpPolicy(ntpPolicy).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    ntpPolicy := openapiclient.ntp.Policy{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, Description: "Description_example", Name: "Name_example", Enabled: false, NtpServers: []string{"NtpServers_example"), Timezone: "Timezone_example", ApplianceAccount: , Organization: , Profiles: []PolicyAbstractConfigProfileRelationship{)} // NtpPolicy | The 'ntp.Policy' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.NtpApi.PatchNtpPolicy(context.Background(), moid, ntpPolicy).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `NtpApi.PatchNtpPolicy``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchNtpPolicy`: NtpPolicy
    fmt.Fprintf(os.Stdout, "Response from `NtpApi.PatchNtpPolicy`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchNtpPolicyRequest struct via the builder pattern
...
> NtpPolicy UpdateNtpPolicy(ctx, moid).NtpPolicy(ntpPolicy).IfMatch(ifMatch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.NtpApi.UpdateNtpPolicy(context.Background(), moid, ntpPolicy).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `NtpApi.UpdateNtpPolicy``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateNtpPolicy`: NtpPolicy
    fmt.Fprintf(os.Stdout, "Response from `NtpApi.UpdateNtpPolicy`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateNtpPolicyRequest struct via the builder pattern
