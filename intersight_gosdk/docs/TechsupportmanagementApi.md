# \TechsupportmanagementApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**CreateTechsupportmanagementTechSupportBundle**](TechsupportmanagementApi.md#CreateTechsupportmanagementTechSupportBundle) | **Post** /api/v1/techsupportmanagement/TechSupportBundles | Create a &#39;techsupportmanagement.TechSupportBundle&#39; resource.
[**DeleteTechsupportmanagementTechSupportBundle**](TechsupportmanagementApi.md#DeleteTechsupportmanagementTechSupportBundle) | **Delete** /api/v1/techsupportmanagement/TechSupportBundles/{Moid} | Delete a &#39;techsupportmanagement.TechSupportBundle&#39; resource.
[**GetTechsupportmanagementDownloadByMoid**](TechsupportmanagementApi.md#GetTechsupportmanagementDownloadByMoid) | **Get** /api/v1/techsupportmanagement/Downloads/{Moid} | Read a &#39;techsupportmanagement.Download&#39; resource.
[**GetTechsupportmanagementDownloadList**](TechsupportmanagementApi.md#GetTechsupportmanagementDownloadList) | **Get** /api/v1/techsupportmanagement/Downloads | Read a &#39;techsupportmanagement.Download&#39; resource.
[**GetTechsupportmanagementTechSupportBundleByMoid**](TechsupportmanagementApi.md#GetTechsupportmanagementTechSupportBundleByMoid) | **Get** /api/v1/techsupportmanagement/TechSupportBundles/{Moid} | Read a &#39;techsupportmanagement.TechSupportBundle&#39; resource.
[**GetTechsupportmanagementTechSupportBundleList**](TechsupportmanagementApi.md#GetTechsupportmanagementTechSupportBundleList) | **Get** /api/v1/techsupportmanagement/TechSupportBundles | Read a &#39;techsupportmanagement.TechSupportBundle&#39; resource.
[**GetTechsupportmanagementTechSupportStatusByMoid**](TechsupportmanagementApi.md#GetTechsupportmanagementTechSupportStatusByMoid) | **Get** /api/v1/techsupportmanagement/TechSupportStatuses/{Moid} | Read a &#39;techsupportmanagement.TechSupportStatus&#39; resource.
[**GetTechsupportmanagementTechSupportStatusList**](TechsupportmanagementApi.md#GetTechsupportmanagementTechSupportStatusList) | **Get** /api/v1/techsupportmanagement/TechSupportStatuses | Read a &#39;techsupportmanagement.TechSupportStatus&#39; resource.



## CreateTechsupportmanagementTechSupportBundle

> TechsupportmanagementTechSupportBundle CreateTechsupportmanagementTechSupportBundle(ctx).TechsupportmanagementTechSupportBundle(techsupportmanagementTechSupportBundle).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
...
func main() {
    ...
    resp, r, err := api_client.TechsupportmanagementApi.CreateTechsupportmanagementTechSupportBundle(context.Background(), techsupportmanagementTechSupportBundle).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TechsupportmanagementApi.CreateTechsupportmanagementTechSupportBundle``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CreateTechsupportmanagementTechSupportBundle`: TechsupportmanagementTechSupportBundle
    fmt.Fprintf(os.Stdout, "Response from `TechsupportmanagementApi.CreateTechsupportmanagementTechSupportBundle`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateTechsupportmanagementTechSupportBundleRequest struct via the builder pattern
...
## DeleteTechsupportmanagementTechSupportBundle

> DeleteTechsupportmanagementTechSupportBundle(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TechsupportmanagementApi.DeleteTechsupportmanagementTechSupportBundle(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TechsupportmanagementApi.DeleteTechsupportmanagementTechSupportBundle``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDeleteTechsupportmanagementTechSupportBundleRequest struct via the builder pattern
...
## GetTechsupportmanagementDownloadByMoid

> TechsupportmanagementDownload GetTechsupportmanagementDownloadByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TechsupportmanagementApi.GetTechsupportmanagementDownloadByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TechsupportmanagementApi.GetTechsupportmanagementDownloadByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTechsupportmanagementDownloadByMoid`: TechsupportmanagementDownload
    fmt.Fprintf(os.Stdout, "Response from `TechsupportmanagementApi.GetTechsupportmanagementDownloadByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTechsupportmanagementDownloadByMoidRequest struct via the builder pattern
...
## GetTechsupportmanagementDownloadList

> TechsupportmanagementDownloadResponse GetTechsupportmanagementDownloadList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TechsupportmanagementApi.GetTechsupportmanagementDownloadList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TechsupportmanagementApi.GetTechsupportmanagementDownloadList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTechsupportmanagementDownloadList`: TechsupportmanagementDownloadResponse
    fmt.Fprintf(os.Stdout, "Response from `TechsupportmanagementApi.GetTechsupportmanagementDownloadList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTechsupportmanagementDownloadListRequest struct via the builder pattern
...
## GetTechsupportmanagementTechSupportBundleByMoid

> TechsupportmanagementTechSupportBundle GetTechsupportmanagementTechSupportBundleByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TechsupportmanagementApi.GetTechsupportmanagementTechSupportBundleByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TechsupportmanagementApi.GetTechsupportmanagementTechSupportBundleByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTechsupportmanagementTechSupportBundleByMoid`: TechsupportmanagementTechSupportBundle
    fmt.Fprintf(os.Stdout, "Response from `TechsupportmanagementApi.GetTechsupportmanagementTechSupportBundleByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTechsupportmanagementTechSupportBundleByMoidRequest struct via the builder pattern
...
## GetTechsupportmanagementTechSupportBundleList

> TechsupportmanagementTechSupportBundleResponse GetTechsupportmanagementTechSupportBundleList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TechsupportmanagementApi.GetTechsupportmanagementTechSupportBundleList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TechsupportmanagementApi.GetTechsupportmanagementTechSupportBundleList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTechsupportmanagementTechSupportBundleList`: TechsupportmanagementTechSupportBundleResponse
    fmt.Fprintf(os.Stdout, "Response from `TechsupportmanagementApi.GetTechsupportmanagementTechSupportBundleList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTechsupportmanagementTechSupportBundleListRequest struct via the builder pattern
...
## GetTechsupportmanagementTechSupportStatusByMoid

> TechsupportmanagementTechSupportStatus GetTechsupportmanagementTechSupportStatusByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TechsupportmanagementApi.GetTechsupportmanagementTechSupportStatusByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TechsupportmanagementApi.GetTechsupportmanagementTechSupportStatusByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTechsupportmanagementTechSupportStatusByMoid`: TechsupportmanagementTechSupportStatus
    fmt.Fprintf(os.Stdout, "Response from `TechsupportmanagementApi.GetTechsupportmanagementTechSupportStatusByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTechsupportmanagementTechSupportStatusByMoidRequest struct via the builder pattern
...
## GetTechsupportmanagementTechSupportStatusList

> TechsupportmanagementTechSupportStatusResponse GetTechsupportmanagementTechSupportStatusList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TechsupportmanagementApi.GetTechsupportmanagementTechSupportStatusList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TechsupportmanagementApi.GetTechsupportmanagementTechSupportStatusList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTechsupportmanagementTechSupportStatusList`: TechsupportmanagementTechSupportStatusResponse
    fmt.Fprintf(os.Stdout, "Response from `TechsupportmanagementApi.GetTechsupportmanagementTechSupportStatusList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTechsupportmanagementTechSupportStatusListRequest struct via the builder pattern
