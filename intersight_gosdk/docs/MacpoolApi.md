...
[**GetMacpoolLeaseByMoid**](MacpoolApi.md#GetMacpoolLeaseByMoid) | **Get** /api/v1/macpool/Leases/{Moid} | Read a &#39;macpool.Lease&#39; resource.
[**GetMacpoolLeaseList**](MacpoolApi.md#GetMacpoolLeaseList) | **Get** /api/v1/macpool/Leases | Read a &#39;macpool.Lease&#39; resource.
[**GetMacpoolPoolByMoid**](MacpoolApi.md#GetMacpoolPoolByMoid) | **Get** /api/v1/macpool/Pools/{Moid} | Read a &#39;macpool.Pool&#39; resource.
[**GetMacpoolPoolList**](MacpoolApi.md#GetMacpoolPoolList) | **Get** /api/v1/macpool/Pools | Read a &#39;macpool.Pool&#39; resource.
[**GetMacpoolPoolMemberByMoid**](MacpoolApi.md#GetMacpoolPoolMemberByMoid) | **Get** /api/v1/macpool/PoolMembers/{Moid} | Read a &#39;macpool.PoolMember&#39; resource.
[**GetMacpoolPoolMemberList**](MacpoolApi.md#GetMacpoolPoolMemberList) | **Get** /api/v1/macpool/PoolMembers | Read a &#39;macpool.PoolMember&#39; resource.
...
> MacpoolPool CreateMacpoolPool(ctx).MacpoolPool(macpoolPool).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
...
func main() {
    ...
    resp, r, err := api_client.MacpoolApi.CreateMacpoolPool(context.Background(), macpoolPool).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MacpoolApi.CreateMacpoolPool``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CreateMacpoolPool`: MacpoolPool
    fmt.Fprintf(os.Stdout, "Response from `MacpoolApi.CreateMacpoolPool`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateMacpoolPoolRequest struct via the builder pattern
...
> DeleteMacpoolPool(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.MacpoolApi.DeleteMacpoolPool(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MacpoolApi.DeleteMacpoolPool``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDeleteMacpoolPoolRequest struct via the builder pattern
...
## GetMacpoolIdBlockByMoid

> MacpoolIdBlock GetMacpoolIdBlockByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.MacpoolApi.GetMacpoolIdBlockByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MacpoolApi.GetMacpoolIdBlockByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMacpoolIdBlockByMoid`: MacpoolIdBlock
    fmt.Fprintf(os.Stdout, "Response from `MacpoolApi.GetMacpoolIdBlockByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMacpoolIdBlockByMoidRequest struct via the builder pattern
...
## GetMacpoolIdBlockList

> MacpoolIdBlockResponse GetMacpoolIdBlockList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.MacpoolApi.GetMacpoolIdBlockList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MacpoolApi.GetMacpoolIdBlockList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMacpoolIdBlockList`: MacpoolIdBlockResponse
    fmt.Fprintf(os.Stdout, "Response from `MacpoolApi.GetMacpoolIdBlockList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMacpoolIdBlockListRequest struct via the builder pattern
...
## GetMacpoolLeaseByMoid

> MacpoolLease GetMacpoolLeaseByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.MacpoolApi.GetMacpoolLeaseByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MacpoolApi.GetMacpoolLeaseByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMacpoolLeaseByMoid`: MacpoolLease
    fmt.Fprintf(os.Stdout, "Response from `MacpoolApi.GetMacpoolLeaseByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMacpoolLeaseByMoidRequest struct via the builder pattern
...
> MacpoolLeaseResponse GetMacpoolLeaseList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.MacpoolApi.GetMacpoolLeaseList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MacpoolApi.GetMacpoolLeaseList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMacpoolLeaseList`: MacpoolLeaseResponse
    fmt.Fprintf(os.Stdout, "Response from `MacpoolApi.GetMacpoolLeaseList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMacpoolLeaseListRequest struct via the builder pattern
...
## GetMacpoolPoolByMoid

> MacpoolPool GetMacpoolPoolByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.MacpoolApi.GetMacpoolPoolByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MacpoolApi.GetMacpoolPoolByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMacpoolPoolByMoid`: MacpoolPool
    fmt.Fprintf(os.Stdout, "Response from `MacpoolApi.GetMacpoolPoolByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMacpoolPoolByMoidRequest struct via the builder pattern
...
> MacpoolPoolResponse GetMacpoolPoolList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.MacpoolApi.GetMacpoolPoolList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MacpoolApi.GetMacpoolPoolList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMacpoolPoolList`: MacpoolPoolResponse
    fmt.Fprintf(os.Stdout, "Response from `MacpoolApi.GetMacpoolPoolList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMacpoolPoolListRequest struct via the builder pattern
...
## GetMacpoolPoolMemberByMoid

> MacpoolPoolMember GetMacpoolPoolMemberByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.MacpoolApi.GetMacpoolPoolMemberByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MacpoolApi.GetMacpoolPoolMemberByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMacpoolPoolMemberByMoid`: MacpoolPoolMember
    fmt.Fprintf(os.Stdout, "Response from `MacpoolApi.GetMacpoolPoolMemberByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMacpoolPoolMemberByMoidRequest struct via the builder pattern
...
## GetMacpoolPoolMemberList

> MacpoolPoolMemberResponse GetMacpoolPoolMemberList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.MacpoolApi.GetMacpoolPoolMemberList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MacpoolApi.GetMacpoolPoolMemberList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMacpoolPoolMemberList`: MacpoolPoolMemberResponse
    fmt.Fprintf(os.Stdout, "Response from `MacpoolApi.GetMacpoolPoolMemberList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMacpoolPoolMemberListRequest struct via the builder pattern
...
## GetMacpoolUniverseByMoid

> MacpoolUniverse GetMacpoolUniverseByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.MacpoolApi.GetMacpoolUniverseByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MacpoolApi.GetMacpoolUniverseByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMacpoolUniverseByMoid`: MacpoolUniverse
    fmt.Fprintf(os.Stdout, "Response from `MacpoolApi.GetMacpoolUniverseByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMacpoolUniverseByMoidRequest struct via the builder pattern
...
## GetMacpoolUniverseList

> MacpoolUniverseResponse GetMacpoolUniverseList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.MacpoolApi.GetMacpoolUniverseList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MacpoolApi.GetMacpoolUniverseList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMacpoolUniverseList`: MacpoolUniverseResponse
    fmt.Fprintf(os.Stdout, "Response from `MacpoolApi.GetMacpoolUniverseList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMacpoolUniverseListRequest struct via the builder pattern
...
> MacpoolPool PatchMacpoolPool(ctx, moid).MacpoolPool(macpoolPool).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    macpoolPool := openapiclient.macpool.Pool{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, Description: "Description_example", Name: "Name_example", Assigned: int64(123), AssignmentOrder: "AssignmentOrder_example", Size: int64(123), MacBlocks: []MacpoolBlock{), BlockHeads: []MacpoolIdBlockRelationship{), Organization: } // MacpoolPool | The 'macpool.Pool' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.MacpoolApi.PatchMacpoolPool(context.Background(), moid, macpoolPool).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MacpoolApi.PatchMacpoolPool``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchMacpoolPool`: MacpoolPool
    fmt.Fprintf(os.Stdout, "Response from `MacpoolApi.PatchMacpoolPool`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchMacpoolPoolRequest struct via the builder pattern
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.MacpoolApi.UpdateMacpoolPool(context.Background(), moid, macpoolPool).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MacpoolApi.UpdateMacpoolPool``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateMacpoolPool`: MacpoolPool
    fmt.Fprintf(os.Stdout, "Response from `MacpoolApi.UpdateMacpoolPool`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateMacpoolPoolRequest struct via the builder pattern
