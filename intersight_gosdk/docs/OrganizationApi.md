...
------------- | ------------- | -------------
[**CreateOrganizationOrganization**](OrganizationApi.md#CreateOrganizationOrganization) | **Post** /api/v1/organization/Organizations | Create a &#39;organization.Organization&#39; resource.
[**DeleteOrganizationOrganization**](OrganizationApi.md#DeleteOrganizationOrganization) | **Delete** /api/v1/organization/Organizations/{Moid} | Delete a &#39;organization.Organization&#39; resource.
[**GetOrganizationOrganizationByMoid**](OrganizationApi.md#GetOrganizationOrganizationByMoid) | **Get** /api/v1/organization/Organizations/{Moid} | Read a &#39;organization.Organization&#39; resource.
[**GetOrganizationOrganizationList**](OrganizationApi.md#GetOrganizationOrganizationList) | **Get** /api/v1/organization/Organizations | Read a &#39;organization.Organization&#39; resource.
[**PatchOrganizationOrganization**](OrganizationApi.md#PatchOrganizationOrganization) | **Patch** /api/v1/organization/Organizations/{Moid} | Update a &#39;organization.Organization&#39; resource.
[**UpdateOrganizationOrganization**](OrganizationApi.md#UpdateOrganizationOrganization) | **Post** /api/v1/organization/Organizations/{Moid} | Update a &#39;organization.Organization&#39; resource.



## CreateOrganizationOrganization

> OrganizationOrganization CreateOrganizationOrganization(ctx).OrganizationOrganization(organizationOrganization).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
...
func main() {
    ...
    resp, r, err := api_client.OrganizationApi.CreateOrganizationOrganization(context.Background(), organizationOrganization).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `OrganizationApi.CreateOrganizationOrganization``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CreateOrganizationOrganization`: OrganizationOrganization
    fmt.Fprintf(os.Stdout, "Response from `OrganizationApi.CreateOrganizationOrganization`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateOrganizationOrganizationRequest struct via the builder pattern
...
[**OrganizationOrganization**](organization.Organization.md)
...
> DeleteOrganizationOrganization(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OrganizationApi.DeleteOrganizationOrganization(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `OrganizationApi.DeleteOrganizationOrganization``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDeleteOrganizationOrganizationRequest struct via the builder pattern
...
> OrganizationOrganization GetOrganizationOrganizationByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OrganizationApi.GetOrganizationOrganizationByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `OrganizationApi.GetOrganizationOrganizationByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetOrganizationOrganizationByMoid`: OrganizationOrganization
    fmt.Fprintf(os.Stdout, "Response from `OrganizationApi.GetOrganizationOrganizationByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetOrganizationOrganizationByMoidRequest struct via the builder pattern
...
> OrganizationOrganizationResponse GetOrganizationOrganizationList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OrganizationApi.GetOrganizationOrganizationList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `OrganizationApi.GetOrganizationOrganizationList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetOrganizationOrganizationList`: OrganizationOrganizationResponse
    fmt.Fprintf(os.Stdout, "Response from `OrganizationApi.GetOrganizationOrganizationList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetOrganizationOrganizationListRequest struct via the builder pattern
...
[**OrganizationOrganizationResponse**](organization.Organization.Response.md)
...
## PatchOrganizationOrganization

> OrganizationOrganization PatchOrganizationOrganization(ctx, moid).OrganizationOrganization(organizationOrganization).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    organizationOrganization := openapiclient.organization.Organization{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, Description: "Description_example", Name: "Name_example", Account: , ResourceGroups: []ResourceGroupRelationship{)} // OrganizationOrganization | The 'organization.Organization' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OrganizationApi.PatchOrganizationOrganization(context.Background(), moid, organizationOrganization).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `OrganizationApi.PatchOrganizationOrganization``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchOrganizationOrganization`: OrganizationOrganization
    fmt.Fprintf(os.Stdout, "Response from `OrganizationApi.PatchOrganizationOrganization`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchOrganizationOrganizationRequest struct via the builder pattern
...
> OrganizationOrganization UpdateOrganizationOrganization(ctx, moid).OrganizationOrganization(organizationOrganization).IfMatch(ifMatch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OrganizationApi.UpdateOrganizationOrganization(context.Background(), moid, organizationOrganization).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `OrganizationApi.UpdateOrganizationOrganization``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateOrganizationOrganization`: OrganizationOrganization
    fmt.Fprintf(os.Stdout, "Response from `OrganizationApi.UpdateOrganizationOrganization`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateOrganizationOrganizationRequest struct via the builder pattern
