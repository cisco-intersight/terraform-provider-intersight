...
------------- | ------------- | -------------
[**CreateSnmpPolicy**](SnmpApi.md#CreateSnmpPolicy) | **Post** /api/v1/snmp/Policies | Create a &#39;snmp.Policy&#39; resource.
[**DeleteSnmpPolicy**](SnmpApi.md#DeleteSnmpPolicy) | **Delete** /api/v1/snmp/Policies/{Moid} | Delete a &#39;snmp.Policy&#39; resource.
[**GetSnmpPolicyByMoid**](SnmpApi.md#GetSnmpPolicyByMoid) | **Get** /api/v1/snmp/Policies/{Moid} | Read a &#39;snmp.Policy&#39; resource.
[**GetSnmpPolicyList**](SnmpApi.md#GetSnmpPolicyList) | **Get** /api/v1/snmp/Policies | Read a &#39;snmp.Policy&#39; resource.
[**PatchSnmpPolicy**](SnmpApi.md#PatchSnmpPolicy) | **Patch** /api/v1/snmp/Policies/{Moid} | Update a &#39;snmp.Policy&#39; resource.
[**UpdateSnmpPolicy**](SnmpApi.md#UpdateSnmpPolicy) | **Post** /api/v1/snmp/Policies/{Moid} | Update a &#39;snmp.Policy&#39; resource.



## CreateSnmpPolicy

> SnmpPolicy CreateSnmpPolicy(ctx).SnmpPolicy(snmpPolicy).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
...
func main() {
    ...
    resp, r, err := api_client.SnmpApi.CreateSnmpPolicy(context.Background(), snmpPolicy).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SnmpApi.CreateSnmpPolicy``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CreateSnmpPolicy`: SnmpPolicy
    fmt.Fprintf(os.Stdout, "Response from `SnmpApi.CreateSnmpPolicy`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateSnmpPolicyRequest struct via the builder pattern
...
> DeleteSnmpPolicy(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SnmpApi.DeleteSnmpPolicy(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SnmpApi.DeleteSnmpPolicy``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDeleteSnmpPolicyRequest struct via the builder pattern
...
> SnmpPolicy GetSnmpPolicyByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SnmpApi.GetSnmpPolicyByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SnmpApi.GetSnmpPolicyByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetSnmpPolicyByMoid`: SnmpPolicy
    fmt.Fprintf(os.Stdout, "Response from `SnmpApi.GetSnmpPolicyByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSnmpPolicyByMoidRequest struct via the builder pattern
...
> SnmpPolicyResponse GetSnmpPolicyList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SnmpApi.GetSnmpPolicyList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SnmpApi.GetSnmpPolicyList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetSnmpPolicyList`: SnmpPolicyResponse
    fmt.Fprintf(os.Stdout, "Response from `SnmpApi.GetSnmpPolicyList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSnmpPolicyListRequest struct via the builder pattern
...
> SnmpPolicy PatchSnmpPolicy(ctx, moid).SnmpPolicy(snmpPolicy).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    snmpPolicy := openapiclient.snmp.Policy{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, Description: "Description_example", Name: "Name_example", AccessCommunityString: "AccessCommunityString_example", CommunityAccess: "CommunityAccess_example", Enabled: false, EngineId: "EngineId_example", SnmpPort: int64(123), SnmpTraps: []SnmpTrap{openapiclient.snmp.Trap{ClassId: "ClassId_example", ObjectType: "ObjectType_example", Destination: "Destination_example", Enabled: false, Port: int64(123), Type: "Type_example", User: "User_example", Version: "Version_example"}), SnmpUsers: []SnmpUser{openapiclient.snmp.User{ClassId: "ClassId_example", ObjectType: "ObjectType_example", AuthPassword: "AuthPassword_example", AuthType: "AuthType_example", IsAuthPasswordSet: false, IsPrivacyPasswordSet: false, Name: "Name_example", PrivacyPassword: "PrivacyPassword_example", PrivacyType: "PrivacyType_example", SecurityLevel: "SecurityLevel_example"}), SysContact: "SysContact_example", SysLocation: "SysLocation_example", TrapCommunity: "TrapCommunity_example", Organization: , Profiles: []PolicyAbstractConfigProfileRelationship{)} // SnmpPolicy | The 'snmp.Policy' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SnmpApi.PatchSnmpPolicy(context.Background(), moid, snmpPolicy).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SnmpApi.PatchSnmpPolicy``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchSnmpPolicy`: SnmpPolicy
    fmt.Fprintf(os.Stdout, "Response from `SnmpApi.PatchSnmpPolicy`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchSnmpPolicyRequest struct via the builder pattern
...
> SnmpPolicy UpdateSnmpPolicy(ctx, moid).SnmpPolicy(snmpPolicy).IfMatch(ifMatch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SnmpApi.UpdateSnmpPolicy(context.Background(), moid, snmpPolicy).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SnmpApi.UpdateSnmpPolicy``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateSnmpPolicy`: SnmpPolicy
    fmt.Fprintf(os.Stdout, "Response from `SnmpApi.UpdateSnmpPolicy`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateSnmpPolicyRequest struct via the builder pattern
