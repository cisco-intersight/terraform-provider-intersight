...
`func (o *FirmwareBaseDistributableAllOf) GetImageCategory() string`

GetImageCategory returns the ImageCategory field if non-nil, zero value otherwise.

### GetImageCategoryOk

`func (o *FirmwareBaseDistributableAllOf) GetImageCategoryOk() (*string, bool)`
...
`func (o *FirmwareBaseDistributableAllOf) SetImageCategory(v string)`

SetImageCategory sets ImageCategory field to given value.

### HasImageCategory

`func (o *FirmwareBaseDistributableAllOf) HasImageCategory() bool`
...
`func (o *FirmwareBaseDistributableAllOf) GetOrigin() string`

GetOrigin returns the Origin field if non-nil, zero value otherwise.

### GetOriginOk

`func (o *FirmwareBaseDistributableAllOf) GetOriginOk() (*string, bool)`
...
`func (o *FirmwareBaseDistributableAllOf) SetOrigin(v string)`

SetOrigin sets Origin field to given value.

### HasOrigin

`func (o *FirmwareBaseDistributableAllOf) HasOrigin() bool`
