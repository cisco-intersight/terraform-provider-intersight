...
func main() {
    ...
    resp, r, err := api_client.VmediaApi.CreateVmediaPolicy(context.Background(), vmediaPolicy).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    vmediaPolicy := openapiclient.vmedia.Policy{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, Description: "Description_example", Name: "Name_example", Enabled: false, Encryption: false, LowPowerUsb: false, Mappings: []VmediaMapping{openapiclient.vmedia.Mapping{ClassId: "ClassId_example", ObjectType: "ObjectType_example", AuthenticationProtocol: "AuthenticationProtocol_example", DeviceType: "DeviceType_example", HostName: "HostName_example", IsPasswordSet: false, MountOptions: "MountOptions_example", MountProtocol: "MountProtocol_example", Password: "Password_example", RemoteFile: "RemoteFile_example", RemotePath: "RemotePath_example", Username: "Username_example", VolumeName: "VolumeName_example"}), Organization: , Profiles: []PolicyAbstractConfigProfileRelationship{)} // VmediaPolicy | The 'vmedia.Policy' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.VmediaApi.PatchVmediaPolicy(context.Background(), moid, vmediaPolicy).IfMatch(ifMatch).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.VmediaApi.UpdateVmediaPolicy(context.Background(), moid, vmediaPolicy).IfMatch(ifMatch).Execute()
    if err != nil {
