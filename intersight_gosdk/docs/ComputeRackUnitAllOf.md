...
`func (o *ComputeRackUnitAllOf) GetUemConnection() InventoryUemConnectionRelationship`

GetUemConnection returns the UemConnection field if non-nil, zero value otherwise.

### GetUemConnectionOk

`func (o *ComputeRackUnitAllOf) GetUemConnectionOk() (*InventoryUemConnectionRelationship, bool)`
...
`func (o *ComputeRackUnitAllOf) SetUemConnection(v InventoryUemConnectionRelationship)`

SetUemConnection sets UemConnection field to given value.

### HasUemConnection

`func (o *ComputeRackUnitAllOf) HasUemConnection() bool`
