...
[**GetSoftwarerepositoryCategoryMapperModelByMoid**](SoftwarerepositoryApi.md#GetSoftwarerepositoryCategoryMapperModelByMoid) | **Get** /api/v1/softwarerepository/CategoryMapperModels/{Moid} | Read a &#39;softwarerepository.CategoryMapperModel&#39; resource.
...
## CreateSoftwarerepositoryCategoryMapper

> SoftwarerepositoryCategoryMapper CreateSoftwarerepositoryCategoryMapper(ctx).SoftwarerepositoryCategoryMapper(softwarerepositoryCategoryMapper).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
...
Other parameters are passed through a pointer to a apiCreateSoftwarerepositoryCategoryMapperRequest struct via the builder pattern
...
## CreateSoftwarerepositoryCategoryMapperModel

> SoftwarerepositoryCategoryMapperModel CreateSoftwarerepositoryCategoryMapperModel(ctx).SoftwarerepositoryCategoryMapperModel(softwarerepositoryCategoryMapperModel).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
...
func main() {
    softwarerepositoryCategoryMapperModel := openapiclient.softwarerepository.CategoryMapperModel{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, Name: "Name_example", Section: , Category: "Category_example", DistTag: "DistTag_example", RegexPattern: "RegexPattern_example", SeriesId: "SeriesId_example", SupportedModels: []string{"SupportedModels_example")} // SoftwarerepositoryCategoryMapperModel | The 'softwarerepository.CategoryMapperModel' resource to create.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
    ifNoneMatch := "ifNoneMatch_example" // string | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.CreateSoftwarerepositoryCategoryMapperModel(context.Background(), softwarerepositoryCategoryMapperModel).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.CreateSoftwarerepositoryCategoryMapperModel``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CreateSoftwarerepositoryCategoryMapperModel`: SoftwarerepositoryCategoryMapperModel
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.CreateSoftwarerepositoryCategoryMapperModel`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateSoftwarerepositoryCategoryMapperModelRequest struct via the builder pattern
...
## CreateSoftwarerepositoryRelease

> SoftwarerepositoryRelease CreateSoftwarerepositoryRelease(ctx).SoftwarerepositoryRelease(softwarerepositoryRelease).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
...
func main() {
    softwarerepositoryRelease := openapiclient.softwarerepository.Release{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, ReleaseDate: "TODO", ReleaseNotesUrl: "ReleaseNotesUrl_example", SupportedModels: []string{"SupportedModels_example"), Type: "Type_example", Version: "Version_example", Catalog: openapiclient.softwarerepository.Catalog.Relationship{ClassId: "ClassId_example", ObjectType: "ObjectType_example", Moid: "Moid_example", Selector: "Selector_example", Link: "Link_example", AccountMoid: "AccountMoid_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, Name: "Name_example", Organization: , System: }} // SoftwarerepositoryRelease | The 'softwarerepository.Release' resource to create.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
    ifNoneMatch := "ifNoneMatch_example" // string | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.CreateSoftwarerepositoryRelease(context.Background(), softwarerepositoryRelease).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.CreateSoftwarerepositoryRelease``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CreateSoftwarerepositoryRelease`: SoftwarerepositoryRelease
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.CreateSoftwarerepositoryRelease`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateSoftwarerepositoryReleaseRequest struct via the builder pattern
...
## DeleteSoftwarerepositoryCategoryMapper

> DeleteSoftwarerepositoryCategoryMapper(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.DeleteSoftwarerepositoryCategoryMapper(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.DeleteSoftwarerepositoryCategoryMapper``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDeleteSoftwarerepositoryCategoryMapperRequest struct via the builder pattern
...
## DeleteSoftwarerepositoryCategoryMapperModel

> DeleteSoftwarerepositoryCategoryMapperModel(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.DeleteSoftwarerepositoryCategoryMapperModel(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.DeleteSoftwarerepositoryCategoryMapperModel``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDeleteSoftwarerepositoryCategoryMapperModelRequest struct via the builder pattern
...
## DeleteSoftwarerepositoryRelease

> DeleteSoftwarerepositoryRelease(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.DeleteSoftwarerepositoryRelease(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.DeleteSoftwarerepositoryRelease``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDeleteSoftwarerepositoryReleaseRequest struct via the builder pattern
...
## GetSoftwarerepositoryCachedImageByMoid

> SoftwarerepositoryCachedImage GetSoftwarerepositoryCachedImageByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.GetSoftwarerepositoryCachedImageByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.GetSoftwarerepositoryCachedImageByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetSoftwarerepositoryCachedImageByMoid`: SoftwarerepositoryCachedImage
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.GetSoftwarerepositoryCachedImageByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSoftwarerepositoryCachedImageByMoidRequest struct via the builder pattern
...
## GetSoftwarerepositoryCachedImageList

> SoftwarerepositoryCachedImageResponse GetSoftwarerepositoryCachedImageList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.GetSoftwarerepositoryCachedImageList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.GetSoftwarerepositoryCachedImageList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetSoftwarerepositoryCachedImageList`: SoftwarerepositoryCachedImageResponse
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.GetSoftwarerepositoryCachedImageList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSoftwarerepositoryCachedImageListRequest struct via the builder pattern
...
## GetSoftwarerepositoryCategoryMapperByMoid

> SoftwarerepositoryCategoryMapper GetSoftwarerepositoryCategoryMapperByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.GetSoftwarerepositoryCategoryMapperByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.GetSoftwarerepositoryCategoryMapperByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetSoftwarerepositoryCategoryMapperByMoid`: SoftwarerepositoryCategoryMapper
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.GetSoftwarerepositoryCategoryMapperByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSoftwarerepositoryCategoryMapperByMoidRequest struct via the builder pattern
...
## GetSoftwarerepositoryCategoryMapperList

> SoftwarerepositoryCategoryMapperResponse GetSoftwarerepositoryCategoryMapperList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.GetSoftwarerepositoryCategoryMapperList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.GetSoftwarerepositoryCategoryMapperList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetSoftwarerepositoryCategoryMapperList`: SoftwarerepositoryCategoryMapperResponse
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.GetSoftwarerepositoryCategoryMapperList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSoftwarerepositoryCategoryMapperListRequest struct via the builder pattern
...
## GetSoftwarerepositoryCategoryMapperModelByMoid

> SoftwarerepositoryCategoryMapperModel GetSoftwarerepositoryCategoryMapperModelByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.GetSoftwarerepositoryCategoryMapperModelByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.GetSoftwarerepositoryCategoryMapperModelByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetSoftwarerepositoryCategoryMapperModelByMoid`: SoftwarerepositoryCategoryMapperModel
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.GetSoftwarerepositoryCategoryMapperModelByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSoftwarerepositoryCategoryMapperModelByMoidRequest struct via the builder pattern
...
## GetSoftwarerepositoryCategoryMapperModelList

> SoftwarerepositoryCategoryMapperModelResponse GetSoftwarerepositoryCategoryMapperModelList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.GetSoftwarerepositoryCategoryMapperModelList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.GetSoftwarerepositoryCategoryMapperModelList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetSoftwarerepositoryCategoryMapperModelList`: SoftwarerepositoryCategoryMapperModelResponse
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.GetSoftwarerepositoryCategoryMapperModelList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSoftwarerepositoryCategoryMapperModelListRequest struct via the builder pattern
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.GetSoftwarerepositoryDownloadSpecByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.GetSoftwarerepositoryDownloadSpecByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetSoftwarerepositoryDownloadSpecByMoid`: SoftwarerepositoryDownloadSpec
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.GetSoftwarerepositoryDownloadSpecByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSoftwarerepositoryDownloadSpecByMoidRequest struct via the builder pattern
...
## GetSoftwarerepositoryDownloadSpecList

> SoftwarerepositoryDownloadSpecResponse GetSoftwarerepositoryDownloadSpecList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.GetSoftwarerepositoryDownloadSpecList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.GetSoftwarerepositoryDownloadSpecList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetSoftwarerepositoryDownloadSpecList`: SoftwarerepositoryDownloadSpecResponse
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.GetSoftwarerepositoryDownloadSpecList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSoftwarerepositoryDownloadSpecListRequest struct via the builder pattern
...
## GetSoftwarerepositoryReleaseByMoid

> SoftwarerepositoryRelease GetSoftwarerepositoryReleaseByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.GetSoftwarerepositoryReleaseByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.GetSoftwarerepositoryReleaseByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetSoftwarerepositoryReleaseByMoid`: SoftwarerepositoryRelease
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.GetSoftwarerepositoryReleaseByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSoftwarerepositoryReleaseByMoidRequest struct via the builder pattern
...
## GetSoftwarerepositoryReleaseList

> SoftwarerepositoryReleaseResponse GetSoftwarerepositoryReleaseList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.GetSoftwarerepositoryReleaseList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.GetSoftwarerepositoryReleaseList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetSoftwarerepositoryReleaseList`: SoftwarerepositoryReleaseResponse
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.GetSoftwarerepositoryReleaseList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSoftwarerepositoryReleaseListRequest struct via the builder pattern
...
## PatchSoftwarerepositoryCategoryMapper

> SoftwarerepositoryCategoryMapper PatchSoftwarerepositoryCategoryMapper(ctx, moid).SoftwarerepositoryCategoryMapper(softwarerepositoryCategoryMapper).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    softwarerepositoryCategoryMapper := openapiclient.softwarerepository.CategoryMapper{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, Name: "Name_example", Section: , Category: "Category_example", FileType: "FileType_example", MdfId: "MdfId_example", RegexPattern: "RegexPattern_example", Source: "Source_example", SupportedModels: []string{"SupportedModels_example"), SwId: "SwId_example", TagTypes: []string{"TagTypes_example"), Version: "Version_example"} // SoftwarerepositoryCategoryMapper | The 'softwarerepository.CategoryMapper' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.PatchSoftwarerepositoryCategoryMapper(context.Background(), moid, softwarerepositoryCategoryMapper).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.PatchSoftwarerepositoryCategoryMapper``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchSoftwarerepositoryCategoryMapper`: SoftwarerepositoryCategoryMapper
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.PatchSoftwarerepositoryCategoryMapper`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchSoftwarerepositoryCategoryMapperRequest struct via the builder pattern
...
## PatchSoftwarerepositoryCategoryMapperModel

> SoftwarerepositoryCategoryMapperModel PatchSoftwarerepositoryCategoryMapperModel(ctx, moid).SoftwarerepositoryCategoryMapperModel(softwarerepositoryCategoryMapperModel).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    softwarerepositoryCategoryMapperModel := openapiclient.softwarerepository.CategoryMapperModel{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, Name: "Name_example", Section: , Category: "Category_example", DistTag: "DistTag_example", RegexPattern: "RegexPattern_example", SeriesId: "SeriesId_example", SupportedModels: []string{"SupportedModels_example")} // SoftwarerepositoryCategoryMapperModel | The 'softwarerepository.CategoryMapperModel' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.PatchSoftwarerepositoryCategoryMapperModel(context.Background(), moid, softwarerepositoryCategoryMapperModel).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.PatchSoftwarerepositoryCategoryMapperModel``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchSoftwarerepositoryCategoryMapperModel`: SoftwarerepositoryCategoryMapperModel
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.PatchSoftwarerepositoryCategoryMapperModel`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchSoftwarerepositoryCategoryMapperModelRequest struct via the builder pattern
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    softwarerepositoryOperatingSystemFile := openapiclient.softwarerepository.OperatingSystemFile{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, Description: "Description_example", DownloadCount: int64(123), ImportAction: "ImportAction_example", ImportState: "ImportState_example", ImportedTime: "TODO", LastAccessTime: "TODO", Md5sum: "Md5sum_example", Name: "Name_example", ReleaseDate: "TODO", Sha512sum: "Sha512sum_example", Size: int64(123), SoftwareAdvisoryUrl: "SoftwareAdvisoryUrl_example", Source: openapiclient.softwarerepository.FileServer{ClassId: "ClassId_example", ObjectType: "ObjectType_example"}, Version: "Version_example", Vendor: "Vendor_example", Catalog: } // SoftwarerepositoryOperatingSystemFile | The 'softwarerepository.OperatingSystemFile' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
...
## PatchSoftwarerepositoryRelease

> SoftwarerepositoryRelease PatchSoftwarerepositoryRelease(ctx, moid).SoftwarerepositoryRelease(softwarerepositoryRelease).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    softwarerepositoryRelease := openapiclient.softwarerepository.Release{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, ReleaseDate: "TODO", ReleaseNotesUrl: "ReleaseNotesUrl_example", SupportedModels: []string{"SupportedModels_example"), Type: "Type_example", Version: "Version_example", Catalog: } // SoftwarerepositoryRelease | The 'softwarerepository.Release' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.PatchSoftwarerepositoryRelease(context.Background(), moid, softwarerepositoryRelease).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.PatchSoftwarerepositoryRelease``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchSoftwarerepositoryRelease`: SoftwarerepositoryRelease
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.PatchSoftwarerepositoryRelease`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchSoftwarerepositoryReleaseRequest struct via the builder pattern
...
## UpdateSoftwarerepositoryCategoryMapper

> SoftwarerepositoryCategoryMapper UpdateSoftwarerepositoryCategoryMapper(ctx, moid).SoftwarerepositoryCategoryMapper(softwarerepositoryCategoryMapper).IfMatch(ifMatch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.UpdateSoftwarerepositoryCategoryMapper(context.Background(), moid, softwarerepositoryCategoryMapper).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.UpdateSoftwarerepositoryCategoryMapper``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateSoftwarerepositoryCategoryMapper`: SoftwarerepositoryCategoryMapper
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.UpdateSoftwarerepositoryCategoryMapper`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateSoftwarerepositoryCategoryMapperRequest struct via the builder pattern
...
## UpdateSoftwarerepositoryCategoryMapperModel

> SoftwarerepositoryCategoryMapperModel UpdateSoftwarerepositoryCategoryMapperModel(ctx, moid).SoftwarerepositoryCategoryMapperModel(softwarerepositoryCategoryMapperModel).IfMatch(ifMatch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.UpdateSoftwarerepositoryCategoryMapperModel(context.Background(), moid, softwarerepositoryCategoryMapperModel).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.UpdateSoftwarerepositoryCategoryMapperModel``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateSoftwarerepositoryCategoryMapperModel`: SoftwarerepositoryCategoryMapperModel
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.UpdateSoftwarerepositoryCategoryMapperModel`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateSoftwarerepositoryCategoryMapperModelRequest struct via the builder pattern
...
## UpdateSoftwarerepositoryRelease

> SoftwarerepositoryRelease UpdateSoftwarerepositoryRelease(ctx, moid).SoftwarerepositoryRelease(softwarerepositoryRelease).IfMatch(ifMatch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SoftwarerepositoryApi.UpdateSoftwarerepositoryRelease(context.Background(), moid, softwarerepositoryRelease).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SoftwarerepositoryApi.UpdateSoftwarerepositoryRelease``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateSoftwarerepositoryRelease`: SoftwarerepositoryRelease
    fmt.Fprintf(os.Stdout, "Response from `SoftwarerepositoryApi.UpdateSoftwarerepositoryRelease`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateSoftwarerepositoryReleaseRequest struct via the builder pattern
