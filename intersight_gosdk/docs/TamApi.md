...
[**UpdateTamAdvisoryInstance**](TamApi.md#UpdateTamAdvisoryInstance) | **Post** /api/v1/tam/AdvisoryInstances/{Moid} | Update a &#39;tam.AdvisoryInstance&#39; resource.
...
> DeleteTamAdvisoryCount(ctx, moid).Execute()
...
Other parameters are passed through a pointer to a apiDeleteTamAdvisoryDefinitionRequest struct via the builder pattern
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.DeleteTamSecurityAdvisory(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.DeleteTamSecurityAdvisory``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDeleteTamSecurityAdvisoryRequest struct via the builder pattern
...
## GetTamAdvisoryCountByMoid

> TamAdvisoryCount GetTamAdvisoryCountByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.GetTamAdvisoryCountByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.GetTamAdvisoryCountByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTamAdvisoryCountByMoid`: TamAdvisoryCount
    fmt.Fprintf(os.Stdout, "Response from `TamApi.GetTamAdvisoryCountByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTamAdvisoryCountByMoidRequest struct via the builder pattern
...
## GetTamAdvisoryCountList

> TamAdvisoryCountResponse GetTamAdvisoryCountList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.GetTamAdvisoryCountList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.GetTamAdvisoryCountList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTamAdvisoryCountList`: TamAdvisoryCountResponse
    fmt.Fprintf(os.Stdout, "Response from `TamApi.GetTamAdvisoryCountList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTamAdvisoryCountListRequest struct via the builder pattern
...
> TamAdvisoryDefinition GetTamAdvisoryDefinitionByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.GetTamAdvisoryDefinitionByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.GetTamAdvisoryDefinitionByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTamAdvisoryDefinitionByMoid`: TamAdvisoryDefinition
    fmt.Fprintf(os.Stdout, "Response from `TamApi.GetTamAdvisoryDefinitionByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTamAdvisoryDefinitionByMoidRequest struct via the builder pattern
...
## GetTamAdvisoryDefinitionList

> TamAdvisoryDefinitionResponse GetTamAdvisoryDefinitionList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.GetTamAdvisoryDefinitionList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.GetTamAdvisoryDefinitionList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTamAdvisoryDefinitionList`: TamAdvisoryDefinitionResponse
    fmt.Fprintf(os.Stdout, "Response from `TamApi.GetTamAdvisoryDefinitionList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTamAdvisoryDefinitionListRequest struct via the builder pattern
...
## GetTamAdvisoryInfoByMoid

> TamAdvisoryInfo GetTamAdvisoryInfoByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.GetTamAdvisoryInfoByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.GetTamAdvisoryInfoByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTamAdvisoryInfoByMoid`: TamAdvisoryInfo
    fmt.Fprintf(os.Stdout, "Response from `TamApi.GetTamAdvisoryInfoByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTamAdvisoryInfoByMoidRequest struct via the builder pattern
...
## GetTamAdvisoryInfoList

> TamAdvisoryInfoResponse GetTamAdvisoryInfoList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.GetTamAdvisoryInfoList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.GetTamAdvisoryInfoList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTamAdvisoryInfoList`: TamAdvisoryInfoResponse
    fmt.Fprintf(os.Stdout, "Response from `TamApi.GetTamAdvisoryInfoList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTamAdvisoryInfoListRequest struct via the builder pattern
...
## GetTamAdvisoryInstanceByMoid

> TamAdvisoryInstance GetTamAdvisoryInstanceByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.GetTamAdvisoryInstanceByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.GetTamAdvisoryInstanceByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTamAdvisoryInstanceByMoid`: TamAdvisoryInstance
    fmt.Fprintf(os.Stdout, "Response from `TamApi.GetTamAdvisoryInstanceByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTamAdvisoryInstanceByMoidRequest struct via the builder pattern
...
## GetTamAdvisoryInstanceList

> TamAdvisoryInstanceResponse GetTamAdvisoryInstanceList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.GetTamAdvisoryInstanceList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.GetTamAdvisoryInstanceList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTamAdvisoryInstanceList`: TamAdvisoryInstanceResponse
    fmt.Fprintf(os.Stdout, "Response from `TamApi.GetTamAdvisoryInstanceList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTamAdvisoryInstanceListRequest struct via the builder pattern
...
## GetTamSecurityAdvisoryByMoid

> TamSecurityAdvisory GetTamSecurityAdvisoryByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.GetTamSecurityAdvisoryByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.GetTamSecurityAdvisoryByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTamSecurityAdvisoryByMoid`: TamSecurityAdvisory
    fmt.Fprintf(os.Stdout, "Response from `TamApi.GetTamSecurityAdvisoryByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTamSecurityAdvisoryByMoidRequest struct via the builder pattern
...
## GetTamSecurityAdvisoryList

> TamSecurityAdvisoryResponse GetTamSecurityAdvisoryList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.GetTamSecurityAdvisoryList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.GetTamSecurityAdvisoryList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTamSecurityAdvisoryList`: TamSecurityAdvisoryResponse
    fmt.Fprintf(os.Stdout, "Response from `TamApi.GetTamSecurityAdvisoryList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTamSecurityAdvisoryListRequest struct via the builder pattern
...
## PatchTamAdvisoryCount

> TamAdvisoryCount PatchTamAdvisoryCount(ctx, moid).TamAdvisoryCount(tamAdvisoryCount).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    tamAdvisoryCount := openapiclient.tam.AdvisoryCount{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, AdvisoryCount: int64(123), Account: } // TamAdvisoryCount | The 'tam.AdvisoryCount' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.PatchTamAdvisoryCount(context.Background(), moid, tamAdvisoryCount).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.PatchTamAdvisoryCount``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchTamAdvisoryCount`: TamAdvisoryCount
    fmt.Fprintf(os.Stdout, "Response from `TamApi.PatchTamAdvisoryCount`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchTamAdvisoryCountRequest struct via the builder pattern
...
## PatchTamAdvisoryDefinition

> TamAdvisoryDefinition PatchTamAdvisoryDefinition(ctx, moid).TamAdvisoryDefinition(tamAdvisoryDefinition).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    tamAdvisoryDefinition := openapiclient.tam.AdvisoryDefinition{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, Description: "Description_example", Name: "Name_example", Severity: , State: "State_example", Actions: []TamAction{), AdvisoryDetails: openapiclient.tam.BaseAdvisoryDetails{ClassId: "ClassId_example", ObjectType: "ObjectType_example", Description: "Description_example"}, AdvisoryId: "AdvisoryId_example", ApiDataSources: []TamApiDataSource{), DatePublished: "TODO", DateUpdated: "TODO", ExternalUrl: "ExternalUrl_example", Recommendation: "Recommendation_example", Type: "Type_example", Version: "Version_example", Workaround: "Workaround_example", Organization: } // TamAdvisoryDefinition | The 'tam.AdvisoryDefinition' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.PatchTamAdvisoryDefinition(context.Background(), moid, tamAdvisoryDefinition).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.PatchTamAdvisoryDefinition``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchTamAdvisoryDefinition`: TamAdvisoryDefinition
    fmt.Fprintf(os.Stdout, "Response from `TamApi.PatchTamAdvisoryDefinition`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchTamAdvisoryDefinitionRequest struct via the builder pattern
...
## PatchTamAdvisoryInfo

> TamAdvisoryInfo PatchTamAdvisoryInfo(ctx, moid).TamAdvisoryInfo(tamAdvisoryInfo).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    tamAdvisoryInfo := openapiclient.tam.AdvisoryInfo{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, State: "State_example", Account: , Advisory: } // TamAdvisoryInfo | The 'tam.AdvisoryInfo' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.PatchTamAdvisoryInfo(context.Background(), moid, tamAdvisoryInfo).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.PatchTamAdvisoryInfo``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchTamAdvisoryInfo`: TamAdvisoryInfo
    fmt.Fprintf(os.Stdout, "Response from `TamApi.PatchTamAdvisoryInfo`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchTamAdvisoryInfoRequest struct via the builder pattern
...
## PatchTamAdvisoryInstance

> TamAdvisoryInstance PatchTamAdvisoryInstance(ctx, moid).TamAdvisoryInstance(tamAdvisoryInstance).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    tamAdvisoryInstance := openapiclient.tam.AdvisoryInstance{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, AffectedObjectMoid: "AffectedObjectMoid_example", AffectedObjectType: "AffectedObjectType_example", LastStateChangeTime: "TODO", LastVerifiedTime: "TODO", State: "State_example", Advisory: , AffectedObject: , DeviceRegistration: } // TamAdvisoryInstance | The 'tam.AdvisoryInstance' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.PatchTamAdvisoryInstance(context.Background(), moid, tamAdvisoryInstance).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.PatchTamAdvisoryInstance``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchTamAdvisoryInstance`: TamAdvisoryInstance
    fmt.Fprintf(os.Stdout, "Response from `TamApi.PatchTamAdvisoryInstance`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchTamAdvisoryInstanceRequest struct via the builder pattern
...
## PatchTamSecurityAdvisory

> TamSecurityAdvisory PatchTamSecurityAdvisory(ctx, moid).TamSecurityAdvisory(tamSecurityAdvisory).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    tamSecurityAdvisory := openapiclient.tam.SecurityAdvisory{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, Description: "Description_example", Name: "Name_example", Severity: , State: "State_example", Actions: []TamAction{), AdvisoryId: "AdvisoryId_example", ApiDataSources: []TamApiDataSource{), BaseScore: 123, CveIds: []string{"CveIds_example"), DatePublished: "TODO", DateUpdated: "TODO", EnvironmentalScore: 123, ExternalUrl: "ExternalUrl_example", Recommendation: "Recommendation_example", Status: "Status_example", TemporalScore: 123, Version: "Version_example", Workaround: "Workaround_example", Organization: } // TamSecurityAdvisory | The 'tam.SecurityAdvisory' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.PatchTamSecurityAdvisory(context.Background(), moid, tamSecurityAdvisory).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.PatchTamSecurityAdvisory``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchTamSecurityAdvisory`: TamSecurityAdvisory
    fmt.Fprintf(os.Stdout, "Response from `TamApi.PatchTamSecurityAdvisory`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchTamSecurityAdvisoryRequest struct via the builder pattern
...
## UpdateTamAdvisoryCount

> TamAdvisoryCount UpdateTamAdvisoryCount(ctx, moid).TamAdvisoryCount(tamAdvisoryCount).IfMatch(ifMatch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.UpdateTamAdvisoryCount(context.Background(), moid, tamAdvisoryCount).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.UpdateTamAdvisoryCount``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateTamAdvisoryCount`: TamAdvisoryCount
    fmt.Fprintf(os.Stdout, "Response from `TamApi.UpdateTamAdvisoryCount`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateTamAdvisoryCountRequest struct via the builder pattern
...
## UpdateTamAdvisoryDefinition

> TamAdvisoryDefinition UpdateTamAdvisoryDefinition(ctx, moid).TamAdvisoryDefinition(tamAdvisoryDefinition).IfMatch(ifMatch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.UpdateTamAdvisoryDefinition(context.Background(), moid, tamAdvisoryDefinition).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.UpdateTamAdvisoryDefinition``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateTamAdvisoryDefinition`: TamAdvisoryDefinition
    fmt.Fprintf(os.Stdout, "Response from `TamApi.UpdateTamAdvisoryDefinition`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateTamAdvisoryDefinitionRequest struct via the builder pattern
...
## UpdateTamAdvisoryInfo

> TamAdvisoryInfo UpdateTamAdvisoryInfo(ctx, moid).TamAdvisoryInfo(tamAdvisoryInfo).IfMatch(ifMatch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.UpdateTamAdvisoryInfo(context.Background(), moid, tamAdvisoryInfo).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.UpdateTamAdvisoryInfo``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateTamAdvisoryInfo`: TamAdvisoryInfo
    fmt.Fprintf(os.Stdout, "Response from `TamApi.UpdateTamAdvisoryInfo`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateTamAdvisoryInfoRequest struct via the builder pattern
...
## UpdateTamAdvisoryInstance

> TamAdvisoryInstance UpdateTamAdvisoryInstance(ctx, moid).TamAdvisoryInstance(tamAdvisoryInstance).IfMatch(ifMatch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.UpdateTamAdvisoryInstance(context.Background(), moid, tamAdvisoryInstance).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.UpdateTamAdvisoryInstance``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateTamAdvisoryInstance`: TamAdvisoryInstance
    fmt.Fprintf(os.Stdout, "Response from `TamApi.UpdateTamAdvisoryInstance`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateTamAdvisoryInstanceRequest struct via the builder pattern
...
## UpdateTamSecurityAdvisory

> TamSecurityAdvisory UpdateTamSecurityAdvisory(ctx, moid).TamSecurityAdvisory(tamSecurityAdvisory).IfMatch(ifMatch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.TamApi.UpdateTamSecurityAdvisory(context.Background(), moid, tamSecurityAdvisory).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `TamApi.UpdateTamSecurityAdvisory``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateTamSecurityAdvisory`: TamSecurityAdvisory
    fmt.Fprintf(os.Stdout, "Response from `TamApi.UpdateTamSecurityAdvisory`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateTamSecurityAdvisoryRequest struct via the builder pattern
