...
`func (o *WorkflowPendingDynamicWorkflowInfoAllOf) GetWorkflowCtx() interface{}`

GetWorkflowCtx returns the WorkflowCtx field if non-nil, zero value otherwise.

### GetWorkflowCtxOk

`func (o *WorkflowPendingDynamicWorkflowInfoAllOf) GetWorkflowCtxOk() (*interface{}, bool)`
...
`func (o *WorkflowPendingDynamicWorkflowInfoAllOf) SetWorkflowCtx(v interface{})`
