...
type VnicFcQosPolicyRelationship struct {
	VnicFcQosPolicyRelationshipInterface interface{}
}

func (s VnicFcQosPolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.VnicFcQosPolicyRelationshipInterface)
}

func (s *VnicFcQosPolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.VnicFcQosPolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledVnicFcQosPolicy *VnicFcQosPolicy = &VnicFcQosPolicy{}
	err = json.Unmarshal(src, unmarshaledVnicFcQosPolicy)
	if err == nil {
		s.VnicFcQosPolicyRelationshipInterface = unmarshaledVnicFcQosPolicy
		return nil
	}
