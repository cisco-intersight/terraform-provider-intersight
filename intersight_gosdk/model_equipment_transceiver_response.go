...
func (dst *EquipmentTransceiverResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "equipment.Transceiver.List" {
		// try to unmarshal JSON data into EquipmentTransceiverList
		err = json.Unmarshal(data, &dst.EquipmentTransceiverList)
		if err == nil {
			return nil // data stored in dst.EquipmentTransceiverList, return on the first match
		} else {
			dst.EquipmentTransceiverList = nil
			return fmt.Errorf("Failed to unmarshal EquipmentTransceiverResponse as EquipmentTransceiverList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal EquipmentTransceiverResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal EquipmentTransceiverResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal EquipmentTransceiverResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src EquipmentTransceiverResponse) MarshalJSON() ([]byte, error) {
	if src.EquipmentTransceiverList != nil {
		return json.Marshal(&src.EquipmentTransceiverList)
	}
...
type NullableEquipmentTransceiverResponse struct {
	value *EquipmentTransceiverResponse
	isSet bool
}

func (v NullableEquipmentTransceiverResponse) Get() *EquipmentTransceiverResponse {
	return v.value
}

func (v *NullableEquipmentTransceiverResponse) Set(val *EquipmentTransceiverResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEquipmentTransceiverResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEquipmentTransceiverResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEquipmentTransceiverResponse(val *EquipmentTransceiverResponse) *NullableEquipmentTransceiverResponse {
	return &NullableEquipmentTransceiverResponse{value: val, isSet: true}
}

func (v NullableEquipmentTransceiverResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEquipmentTransceiverResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
