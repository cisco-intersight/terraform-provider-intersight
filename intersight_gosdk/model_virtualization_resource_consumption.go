...
// VirtualizationResourceConsumption Stats on the resources consumed by this host.
...
func NewVirtualizationResourceConsumption() *VirtualizationResourceConsumption {
	this := VirtualizationResourceConsumption{}
	return &this
}
...
func (o VirtualizationResourceConsumption) MarshalJSON() ([]byte, error) {
...
type NullableVirtualizationResourceConsumption struct {
	value *VirtualizationResourceConsumption
	isSet bool
}

func (v NullableVirtualizationResourceConsumption) Get() *VirtualizationResourceConsumption {
	return v.value
}

func (v *NullableVirtualizationResourceConsumption) Set(val *VirtualizationResourceConsumption) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationResourceConsumption) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationResourceConsumption) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationResourceConsumption(val *VirtualizationResourceConsumption) *NullableVirtualizationResourceConsumption {
	return &NullableVirtualizationResourceConsumption{value: val, isSet: true}
}

func (v NullableVirtualizationResourceConsumption) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationResourceConsumption) UnmarshalJSON(src []byte) error {
	v.isSet = true
