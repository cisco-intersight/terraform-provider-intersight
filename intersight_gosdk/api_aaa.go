...
func (r apiGetAaaAuditRecordByMoidRequest) Execute() (AaaAuditRecord, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "AaaApiService.GetAaaAuditRecordByMoid")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/aaa/AuditRecords/{Moid}"
...
func (r apiGetAaaAuditRecordListRequest) Execute() (AaaAuditRecordResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "AaaApiService.GetAaaAuditRecordList")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/aaa/AuditRecords"
