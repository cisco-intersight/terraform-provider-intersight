...
type CondAlarmResponse struct {
	CondAlarmResponseInterface interface{ GetObjectType() string }
}

func (s CondAlarmResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.CondAlarmResponseInterface)
}

func (s *CondAlarmResponse) UnmarshalJSON(src []byte) error {
	var err error
