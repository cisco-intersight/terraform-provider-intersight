...
type CondHclStatusJobResponse struct {
	CondHclStatusJobResponseInterface interface{ GetObjectType() string }
}

func (s CondHclStatusJobResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.CondHclStatusJobResponseInterface)
}

func (s *CondHclStatusJobResponse) UnmarshalJSON(src []byte) error {
	var err error
