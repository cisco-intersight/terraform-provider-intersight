...
type RecoveryConfigResultRelationship struct {
	RecoveryConfigResultRelationshipInterface interface{}
}

func (s RecoveryConfigResultRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.RecoveryConfigResultRelationshipInterface)
}

func (s *RecoveryConfigResultRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.RecoveryConfigResultRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledRecoveryConfigResult *RecoveryConfigResult = &RecoveryConfigResult{}
	err = json.Unmarshal(src, unmarshaledRecoveryConfigResult)
	if err == nil {
		s.RecoveryConfigResultRelationshipInterface = unmarshaledRecoveryConfigResult
		return nil
	}
