...
type ApplianceDataExportPolicyRelationship struct {
	ApplianceDataExportPolicyRelationshipInterface interface{}
}

func (s ApplianceDataExportPolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.ApplianceDataExportPolicyRelationshipInterface)
}

func (s *ApplianceDataExportPolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledApplianceDataExportPolicy *ApplianceDataExportPolicy = &ApplianceDataExportPolicy{}
	err = json.Unmarshal(src, unmarshaledApplianceDataExportPolicy)
	if err == nil {
		s.ApplianceDataExportPolicyRelationshipInterface = unmarshaledApplianceDataExportPolicy
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.ApplianceDataExportPolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
