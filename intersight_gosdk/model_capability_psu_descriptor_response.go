...
func (dst *CapabilityPsuDescriptorResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "capability.PsuDescriptor.List" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CapabilityPsuDescriptorResponse as CapabilityPsuDescriptorList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CapabilityPsuDescriptorResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CapabilityPsuDescriptorResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CapabilityPsuDescriptorResponse as MoTagSummary: %s", err.Error())
		}
	}
