...
func StorageEnclosureDiskListAsStorageEnclosureDiskResponse(v *StorageEnclosureDiskList) StorageEnclosureDiskResponse {
	return StorageEnclosureDiskResponse{StorageEnclosureDiskList: v}
}

// Unmarshal JSON data into one of the pointers in the struct
func (dst *StorageEnclosureDiskResponse) UnmarshalJSON(data []byte) error {
	var err error
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StorageEnclosureDiskResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StorageEnclosureDiskResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StorageEnclosureDiskResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'storage.EnclosureDisk.List'
	if jsonDict["ObjectType"] == "storage.EnclosureDisk.List" {
		// try to unmarshal JSON data into StorageEnclosureDiskList
		err = json.Unmarshal(data, &dst.StorageEnclosureDiskList)
		if err == nil {
			return nil // data stored in dst.StorageEnclosureDiskList, return on the first match
		} else {
			dst.StorageEnclosureDiskList = nil
			return fmt.Errorf("Failed to unmarshal StorageEnclosureDiskResponse as StorageEnclosureDiskList: %s", err.Error())
		}
	}
...
func (src StorageEnclosureDiskResponse) MarshalJSON() ([]byte, error) {
	...
	if src.StorageEnclosureDiskList != nil {
		return json.Marshal(&src.StorageEnclosureDiskList)
	}
...
func (obj *StorageEnclosureDiskResponse) GetActualInstance() interface{} {
	...
	if obj.StorageEnclosureDiskList != nil {
		return obj.StorageEnclosureDiskList
	}
...
type NullableStorageEnclosureDiskResponse struct {
	value *StorageEnclosureDiskResponse
	isSet bool
}

func (v NullableStorageEnclosureDiskResponse) Get() *StorageEnclosureDiskResponse {
	return v.value
}

func (v *NullableStorageEnclosureDiskResponse) Set(val *StorageEnclosureDiskResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageEnclosureDiskResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageEnclosureDiskResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageEnclosureDiskResponse(val *StorageEnclosureDiskResponse) *NullableStorageEnclosureDiskResponse {
	return &NullableStorageEnclosureDiskResponse{value: val, isSet: true}
}

func (v NullableStorageEnclosureDiskResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageEnclosureDiskResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
