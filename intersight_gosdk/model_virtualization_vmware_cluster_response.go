...
type VirtualizationVmwareClusterResponse struct {
	VirtualizationVmwareClusterResponseInterface interface{ GetObjectType() string }
}

func (s VirtualizationVmwareClusterResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.VirtualizationVmwareClusterResponseInterface)
}

func (s *VirtualizationVmwareClusterResponse) UnmarshalJSON(src []byte) error {
	var err error
