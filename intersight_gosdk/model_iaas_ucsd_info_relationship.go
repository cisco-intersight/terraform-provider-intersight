...
type IaasUcsdInfoRelationship struct {
	IaasUcsdInfoRelationshipInterface interface{}
}

func (s IaasUcsdInfoRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IaasUcsdInfoRelationshipInterface)
}

func (s *IaasUcsdInfoRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIaasUcsdInfo *IaasUcsdInfo = &IaasUcsdInfo{}
	err = json.Unmarshal(src, unmarshaledIaasUcsdInfo)
	if err == nil {
		s.IaasUcsdInfoRelationshipInterface = unmarshaledIaasUcsdInfo
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IaasUcsdInfoRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
