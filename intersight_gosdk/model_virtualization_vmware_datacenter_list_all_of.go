...
type _VirtualizationVmwareDatacenterListAllOf VirtualizationVmwareDatacenterListAllOf
...
func (o *VirtualizationVmwareDatacenterListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationVmwareDatacenterListAllOf := _VirtualizationVmwareDatacenterListAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationVmwareDatacenterListAllOf); err == nil {
		*o = VirtualizationVmwareDatacenterListAllOf(varVirtualizationVmwareDatacenterListAllOf)
	}
