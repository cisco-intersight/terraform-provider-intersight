...
type IaasLicenseInfoResponse struct {
	IaasLicenseInfoResponseInterface interface{ GetObjectType() string }
}

func (s IaasLicenseInfoResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IaasLicenseInfoResponseInterface)
}

func (s *IaasLicenseInfoResponse) UnmarshalJSON(src []byte) error {
	var err error
