...
type StorageSasExpanderRelationship struct {
	StorageSasExpanderRelationshipInterface interface{}
}

func (s StorageSasExpanderRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageSasExpanderRelationshipInterface)
}

func (s *StorageSasExpanderRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StorageSasExpanderRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStorageSasExpander *StorageSasExpander = &StorageSasExpander{}
	err = json.Unmarshal(src, unmarshaledStorageSasExpander)
	if err == nil {
		s.StorageSasExpanderRelationshipInterface = unmarshaledStorageSasExpander
		return nil
	}
