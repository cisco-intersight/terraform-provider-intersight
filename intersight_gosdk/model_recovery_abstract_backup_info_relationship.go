...
type RecoveryAbstractBackupInfoRelationship struct {
	RecoveryAbstractBackupInfoRelationshipInterface interface{}
}

func (s RecoveryAbstractBackupInfoRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.RecoveryAbstractBackupInfoRelationshipInterface)
}

func (s *RecoveryAbstractBackupInfoRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.RecoveryAbstractBackupInfoRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledRecoveryAbstractBackupInfo *RecoveryAbstractBackupInfo = &RecoveryAbstractBackupInfo{}
	err = json.Unmarshal(src, unmarshaledRecoveryAbstractBackupInfo)
	if err == nil {
		s.RecoveryAbstractBackupInfoRelationshipInterface = unmarshaledRecoveryAbstractBackupInfo
		return nil
	}
