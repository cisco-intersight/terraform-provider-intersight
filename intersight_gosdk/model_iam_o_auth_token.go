...
// GetUserMeta returns the UserMeta field value if set, zero value otherwise.
func (o *IamOAuthToken) GetUserMeta() IamClientMeta {
	if o == nil || o.UserMeta == nil {
...
// SetUserMeta gets a reference to the given IamClientMeta and assigns it to the UserMeta field.
...
func (o IamOAuthToken) MarshalJSON() ([]byte, error) {
	...
	if o.UserMeta != nil {
		toSerialize["UserMeta"] = o.UserMeta
	}
...
// AsIamOAuthTokenRelationship wraps this instance of IamOAuthToken in IamOAuthTokenRelationship
func (s *IamOAuthToken) AsIamOAuthTokenRelationship() IamOAuthTokenRelationship {
