...
type _StorageControllerAllOf StorageControllerAllOf
...
func (o *StorageControllerAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageControllerAllOf := _StorageControllerAllOf{}

	if err = json.Unmarshal(bytes, &varStorageControllerAllOf); err == nil {
		*o = StorageControllerAllOf(varStorageControllerAllOf)
	}
