...
type NiatelemetryNiaLicenseStateRelationship struct {
	NiatelemetryNiaLicenseStateRelationshipInterface interface{}
}

func (s NiatelemetryNiaLicenseStateRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.NiatelemetryNiaLicenseStateRelationshipInterface)
}

func (s *NiatelemetryNiaLicenseStateRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.NiatelemetryNiaLicenseStateRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledNiatelemetryNiaLicenseState *NiatelemetryNiaLicenseState = &NiatelemetryNiaLicenseState{}
	err = json.Unmarshal(src, unmarshaledNiatelemetryNiaLicenseState)
	if err == nil {
		s.NiatelemetryNiaLicenseStateRelationshipInterface = unmarshaledNiatelemetryNiaLicenseState
		return nil
	}
