...
func (o *WorkflowWebApiAllOf) GetHeaders() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *WorkflowWebApiAllOf) GetHeadersOk() (*map[string]interface{}, bool) {
	if o == nil || o.Headers == nil {
		return nil, false
	}
...
func (o *WorkflowWebApiAllOf) SetHeaders(v map[string]interface{}) {
	o.Headers = &v
}
