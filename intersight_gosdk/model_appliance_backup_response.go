...
type ApplianceBackupResponse struct {
	ApplianceBackupResponseInterface interface{ GetObjectType() string }
}

func (s ApplianceBackupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.ApplianceBackupResponseInterface)
}

func (s *ApplianceBackupResponse) UnmarshalJSON(src []byte) error {
	var err error
