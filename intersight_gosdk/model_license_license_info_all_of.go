...
// LicenseLicenseInfoAllOf Definition of the list of properties defined in 'license.LicenseInfo', excluding properties defined in parent classes.
type LicenseLicenseInfoAllOf struct {
...
type _LicenseLicenseInfoAllOf LicenseLicenseInfoAllOf
...
func (o LicenseLicenseInfoAllOf) MarshalJSON() ([]byte, error) {
...
func (o *LicenseLicenseInfoAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varLicenseLicenseInfoAllOf := _LicenseLicenseInfoAllOf{}

	if err = json.Unmarshal(bytes, &varLicenseLicenseInfoAllOf); err == nil {
		*o = LicenseLicenseInfoAllOf(varLicenseLicenseInfoAllOf)
	}
...
type NullableLicenseLicenseInfoAllOf struct {
	value *LicenseLicenseInfoAllOf
	isSet bool
}

func (v NullableLicenseLicenseInfoAllOf) Get() *LicenseLicenseInfoAllOf {
	return v.value
}

func (v *NullableLicenseLicenseInfoAllOf) Set(val *LicenseLicenseInfoAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableLicenseLicenseInfoAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableLicenseLicenseInfoAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLicenseLicenseInfoAllOf(val *LicenseLicenseInfoAllOf) *NullableLicenseLicenseInfoAllOf {
	return &NullableLicenseLicenseInfoAllOf{value: val, isSet: true}
}

func (v NullableLicenseLicenseInfoAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLicenseLicenseInfoAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
