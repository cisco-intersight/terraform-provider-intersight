...
// StorageProtectionGroupAllOf Definition of the list of properties defined in 'storage.ProtectionGroup', excluding properties defined in parent classes.
type StorageProtectionGroupAllOf struct {
...
func NewStorageProtectionGroupAllOf() *StorageProtectionGroupAllOf {
	this := StorageProtectionGroupAllOf{}
	return &this
}
...
func (o StorageProtectionGroupAllOf) MarshalJSON() ([]byte, error) {
...
type NullableStorageProtectionGroupAllOf struct {
	value *StorageProtectionGroupAllOf
	isSet bool
}

func (v NullableStorageProtectionGroupAllOf) Get() *StorageProtectionGroupAllOf {
	return v.value
}

func (v *NullableStorageProtectionGroupAllOf) Set(val *StorageProtectionGroupAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageProtectionGroupAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageProtectionGroupAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageProtectionGroupAllOf(val *StorageProtectionGroupAllOf) *NullableStorageProtectionGroupAllOf {
	return &NullableStorageProtectionGroupAllOf{value: val, isSet: true}
}

func (v NullableStorageProtectionGroupAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageProtectionGroupAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
