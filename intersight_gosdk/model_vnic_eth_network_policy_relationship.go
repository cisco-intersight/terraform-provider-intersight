...
type VnicEthNetworkPolicyRelationship struct {
	VnicEthNetworkPolicyRelationshipInterface interface{}
}

func (s VnicEthNetworkPolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.VnicEthNetworkPolicyRelationshipInterface)
}

func (s *VnicEthNetworkPolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.VnicEthNetworkPolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledVnicEthNetworkPolicy *VnicEthNetworkPolicy = &VnicEthNetworkPolicy{}
	err = json.Unmarshal(src, unmarshaledVnicEthNetworkPolicy)
	if err == nil {
		s.VnicEthNetworkPolicyRelationshipInterface = unmarshaledVnicEthNetworkPolicy
		return nil
	}
