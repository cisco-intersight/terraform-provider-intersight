...
type EquipmentIoExpanderRelationship struct {
	EquipmentIoExpanderRelationshipInterface interface{}
}

func (s EquipmentIoExpanderRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.EquipmentIoExpanderRelationshipInterface)
}

func (s *EquipmentIoExpanderRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledEquipmentIoExpander *EquipmentIoExpander = &EquipmentIoExpander{}
	err = json.Unmarshal(src, unmarshaledEquipmentIoExpander)
	if err == nil {
		s.EquipmentIoExpanderRelationshipInterface = unmarshaledEquipmentIoExpander
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.EquipmentIoExpanderRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
