...
// FabricEthNetworkControlPolicy An Ethernet Network Control policy determines the features that are applied on a vethernet that is connected to the vNIC.
...
func (o *FabricEthNetworkControlPolicy) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varFabricEthNetworkControlPolicy.MacRegisterMode = varFabricEthNetworkControlPolicyWithoutEmbeddedStruct.MacRegisterMode
