...
type VnicEthQosPolicyRelationship struct {
	VnicEthQosPolicyRelationshipInterface interface{}
}

func (s VnicEthQosPolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.VnicEthQosPolicyRelationshipInterface)
}

func (s *VnicEthQosPolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.VnicEthQosPolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledVnicEthQosPolicy *VnicEthQosPolicy = &VnicEthQosPolicy{}
	err = json.Unmarshal(src, unmarshaledVnicEthQosPolicy)
	if err == nil {
		s.VnicEthQosPolicyRelationshipInterface = unmarshaledVnicEthQosPolicy
		return nil
	}
