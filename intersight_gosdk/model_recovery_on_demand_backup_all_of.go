...
// RecoveryOnDemandBackupAllOf Definition of the list of properties defined in 'recovery.OnDemandBackup', excluding properties defined in parent classes.
type RecoveryOnDemandBackupAllOf struct {
...
type _RecoveryOnDemandBackupAllOf RecoveryOnDemandBackupAllOf
...
func NewRecoveryOnDemandBackupAllOf() *RecoveryOnDemandBackupAllOf {
	this := RecoveryOnDemandBackupAllOf{}
	return &this
}
...
func (o RecoveryOnDemandBackupAllOf) MarshalJSON() ([]byte, error) {
...
func (o *RecoveryOnDemandBackupAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varRecoveryOnDemandBackupAllOf := _RecoveryOnDemandBackupAllOf{}

	if err = json.Unmarshal(bytes, &varRecoveryOnDemandBackupAllOf); err == nil {
		*o = RecoveryOnDemandBackupAllOf(varRecoveryOnDemandBackupAllOf)
	}
...
type NullableRecoveryOnDemandBackupAllOf struct {
	value *RecoveryOnDemandBackupAllOf
	isSet bool
}

func (v NullableRecoveryOnDemandBackupAllOf) Get() *RecoveryOnDemandBackupAllOf {
	return v.value
}

func (v *NullableRecoveryOnDemandBackupAllOf) Set(val *RecoveryOnDemandBackupAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryOnDemandBackupAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryOnDemandBackupAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryOnDemandBackupAllOf(val *RecoveryOnDemandBackupAllOf) *NullableRecoveryOnDemandBackupAllOf {
	return &NullableRecoveryOnDemandBackupAllOf{value: val, isSet: true}
}

func (v NullableRecoveryOnDemandBackupAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryOnDemandBackupAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
