...
// EquipmentPsuListAllOf struct for EquipmentPsuListAllOf
type EquipmentPsuListAllOf struct {
...
type _EquipmentPsuListAllOf EquipmentPsuListAllOf
...
func (o EquipmentPsuListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *EquipmentPsuListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varEquipmentPsuListAllOf := _EquipmentPsuListAllOf{}

	if err = json.Unmarshal(bytes, &varEquipmentPsuListAllOf); err == nil {
		*o = EquipmentPsuListAllOf(varEquipmentPsuListAllOf)
	}
...
type NullableEquipmentPsuListAllOf struct {
	value *EquipmentPsuListAllOf
	isSet bool
}

func (v NullableEquipmentPsuListAllOf) Get() *EquipmentPsuListAllOf {
	return v.value
}

func (v *NullableEquipmentPsuListAllOf) Set(val *EquipmentPsuListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableEquipmentPsuListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableEquipmentPsuListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEquipmentPsuListAllOf(val *EquipmentPsuListAllOf) *NullableEquipmentPsuListAllOf {
	return &NullableEquipmentPsuListAllOf{value: val, isSet: true}
}

func (v NullableEquipmentPsuListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEquipmentPsuListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
