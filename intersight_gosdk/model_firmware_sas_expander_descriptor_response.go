...
func (dst *FirmwareSasExpanderDescriptorResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "firmware.SasExpanderDescriptor.List" {
		// try to unmarshal JSON data into FirmwareSasExpanderDescriptorList
		err = json.Unmarshal(data, &dst.FirmwareSasExpanderDescriptorList)
		if err == nil {
			return nil // data stored in dst.FirmwareSasExpanderDescriptorList, return on the first match
		} else {
			dst.FirmwareSasExpanderDescriptorList = nil
			return fmt.Errorf("Failed to unmarshal FirmwareSasExpanderDescriptorResponse as FirmwareSasExpanderDescriptorList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FirmwareSasExpanderDescriptorResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FirmwareSasExpanderDescriptorResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FirmwareSasExpanderDescriptorResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src FirmwareSasExpanderDescriptorResponse) MarshalJSON() ([]byte, error) {
	if src.FirmwareSasExpanderDescriptorList != nil {
		return json.Marshal(&src.FirmwareSasExpanderDescriptorList)
	}
...
type NullableFirmwareSasExpanderDescriptorResponse struct {
	value *FirmwareSasExpanderDescriptorResponse
	isSet bool
}

func (v NullableFirmwareSasExpanderDescriptorResponse) Get() *FirmwareSasExpanderDescriptorResponse {
	return v.value
}

func (v *NullableFirmwareSasExpanderDescriptorResponse) Set(val *FirmwareSasExpanderDescriptorResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFirmwareSasExpanderDescriptorResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFirmwareSasExpanderDescriptorResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFirmwareSasExpanderDescriptorResponse(val *FirmwareSasExpanderDescriptorResponse) *NullableFirmwareSasExpanderDescriptorResponse {
	return &NullableFirmwareSasExpanderDescriptorResponse{value: val, isSet: true}
}

func (v NullableFirmwareSasExpanderDescriptorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFirmwareSasExpanderDescriptorResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
