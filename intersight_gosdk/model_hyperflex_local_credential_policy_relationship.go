...
type HyperflexLocalCredentialPolicyRelationship struct {
	HyperflexLocalCredentialPolicyRelationshipInterface interface{}
}

func (s HyperflexLocalCredentialPolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexLocalCredentialPolicyRelationshipInterface)
}

func (s *HyperflexLocalCredentialPolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexLocalCredentialPolicy *HyperflexLocalCredentialPolicy = &HyperflexLocalCredentialPolicy{}
	err = json.Unmarshal(src, unmarshaledHyperflexLocalCredentialPolicy)
	if err == nil {
		s.HyperflexLocalCredentialPolicyRelationshipInterface = unmarshaledHyperflexLocalCredentialPolicy
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexLocalCredentialPolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
