...
func (o *HyperflexStPlatformClusterHealingInfo) GetMessagesIterator() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *HyperflexStPlatformClusterHealingInfo) GetMessagesIteratorOk() (*map[string]interface{}, bool) {
	if o == nil || o.MessagesIterator == nil {
		return nil, false
	}
...
func (o *HyperflexStPlatformClusterHealingInfo) SetMessagesIterator(v map[string]interface{}) {
