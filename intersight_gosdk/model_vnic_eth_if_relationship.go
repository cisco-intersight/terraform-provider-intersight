...
type VnicEthIfRelationship struct {
	VnicEthIfRelationshipInterface interface{}
}

func (s VnicEthIfRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.VnicEthIfRelationshipInterface)
}

func (s *VnicEthIfRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.VnicEthIfRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledVnicEthIf *VnicEthIf = &VnicEthIf{}
	err = json.Unmarshal(src, unmarshaledVnicEthIf)
	if err == nil {
		s.VnicEthIfRelationshipInterface = unmarshaledVnicEthIf
		return nil
	}
