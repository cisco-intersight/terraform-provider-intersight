...
type EquipmentPsuResponse struct {
	EquipmentPsuResponseInterface interface{ GetObjectType() string }
}

func (s EquipmentPsuResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.EquipmentPsuResponseInterface)
}

func (s *EquipmentPsuResponse) UnmarshalJSON(src []byte) error {
	var err error
