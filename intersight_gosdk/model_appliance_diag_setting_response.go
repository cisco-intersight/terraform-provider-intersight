...
type ApplianceDiagSettingResponse struct {
	ApplianceDiagSettingResponseInterface interface{ GetObjectType() string }
}

func (s ApplianceDiagSettingResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.ApplianceDiagSettingResponseInterface)
}

func (s *ApplianceDiagSettingResponse) UnmarshalJSON(src []byte) error {
	var err error
