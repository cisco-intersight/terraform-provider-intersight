...
type HyperflexAppCatalogResponse struct {
	HyperflexAppCatalogResponseInterface interface{ GetObjectType() string }
}

func (s HyperflexAppCatalogResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexAppCatalogResponseInterface)
}

func (s *HyperflexAppCatalogResponse) UnmarshalJSON(src []byte) error {
	var err error
