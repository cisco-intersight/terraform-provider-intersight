...
type IamOAuthTokenRelationship struct {
	IamOAuthTokenRelationshipInterface interface{}
}

func (s IamOAuthTokenRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamOAuthTokenRelationshipInterface)
}

func (s *IamOAuthTokenRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamOAuthToken *IamOAuthToken = &IamOAuthToken{}
	err = json.Unmarshal(src, unmarshaledIamOAuthToken)
	if err == nil {
		s.IamOAuthTokenRelationshipInterface = unmarshaledIamOAuthToken
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamOAuthTokenRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
