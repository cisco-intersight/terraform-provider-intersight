...
type HyperflexClusterRelationship struct {
	HyperflexClusterRelationshipInterface interface{}
}

func (s HyperflexClusterRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexClusterRelationshipInterface)
}

func (s *HyperflexClusterRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexCluster *HyperflexCluster = &HyperflexCluster{}
	err = json.Unmarshal(src, unmarshaledHyperflexCluster)
	if err == nil {
		s.HyperflexClusterRelationshipInterface = unmarshaledHyperflexCluster
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexClusterRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
