...
type NiaapiApicCcoPostResponse struct {
	NiaapiApicCcoPostResponseInterface interface{ GetObjectType() string }
}

func (s NiaapiApicCcoPostResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.NiaapiApicCcoPostResponseInterface)
}

func (s *NiaapiApicCcoPostResponse) UnmarshalJSON(src []byte) error {
	var err error
