...
type StorageVdMemberEpRelationship struct {
	StorageVdMemberEpRelationshipInterface interface{}
}

func (s StorageVdMemberEpRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageVdMemberEpRelationshipInterface)
}

func (s *StorageVdMemberEpRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StorageVdMemberEpRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStorageVdMemberEp *StorageVdMemberEp = &StorageVdMemberEp{}
	err = json.Unmarshal(src, unmarshaledStorageVdMemberEp)
	if err == nil {
		s.StorageVdMemberEpRelationshipInterface = unmarshaledStorageVdMemberEp
		return nil
	}
