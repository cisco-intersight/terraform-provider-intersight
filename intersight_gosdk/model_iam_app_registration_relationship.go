...
type IamAppRegistrationRelationship struct {
	IamAppRegistrationRelationshipInterface interface{}
}

func (s IamAppRegistrationRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamAppRegistrationRelationshipInterface)
}

func (s *IamAppRegistrationRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamAppRegistration *IamAppRegistration = &IamAppRegistration{}
	err = json.Unmarshal(src, unmarshaledIamAppRegistration)
	if err == nil {
		s.IamAppRegistrationRelationshipInterface = unmarshaledIamAppRegistration
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamAppRegistrationRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
