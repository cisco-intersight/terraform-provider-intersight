...
type MemoryPersistentMemoryNamespaceConfigResultRelationship struct {
	MemoryPersistentMemoryNamespaceConfigResultRelationshipInterface interface{}
}

func (s MemoryPersistentMemoryNamespaceConfigResultRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.MemoryPersistentMemoryNamespaceConfigResultRelationshipInterface)
}

func (s *MemoryPersistentMemoryNamespaceConfigResultRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMemoryPersistentMemoryNamespaceConfigResult *MemoryPersistentMemoryNamespaceConfigResult = &MemoryPersistentMemoryNamespaceConfigResult{}
	err = json.Unmarshal(src, unmarshaledMemoryPersistentMemoryNamespaceConfigResult)
	if err == nil {
		s.MemoryPersistentMemoryNamespaceConfigResultRelationshipInterface = unmarshaledMemoryPersistentMemoryNamespaceConfigResult
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.MemoryPersistentMemoryNamespaceConfigResultRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
