...
type StorageFlexUtilControllerRelationship struct {
	StorageFlexUtilControllerRelationshipInterface interface{}
}

func (s StorageFlexUtilControllerRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageFlexUtilControllerRelationshipInterface)
}

func (s *StorageFlexUtilControllerRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StorageFlexUtilControllerRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStorageFlexUtilController *StorageFlexUtilController = &StorageFlexUtilController{}
	err = json.Unmarshal(src, unmarshaledStorageFlexUtilController)
	if err == nil {
		s.StorageFlexUtilControllerRelationshipInterface = unmarshaledStorageFlexUtilController
		return nil
	}
