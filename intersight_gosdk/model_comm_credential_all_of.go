...
type _CommCredentialAllOf CommCredentialAllOf
...
func (o *CommCredentialAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCommCredentialAllOf := _CommCredentialAllOf{}

	if err = json.Unmarshal(bytes, &varCommCredentialAllOf); err == nil {
		*o = CommCredentialAllOf(varCommCredentialAllOf)
	}
