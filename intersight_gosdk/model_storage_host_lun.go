...
// StorageHostLun Generic storage host lun object. It exists only if the volume is associated to host initiator.
type StorageHostLun struct {
	...
	Host         *StorageHostRelationship         `json:"Host,omitempty"`
...
func (o StorageHostLun) MarshalJSON() ([]byte, error) {
...
type NullableStorageHostLun struct {
	value *StorageHostLun
	isSet bool
}

func (v NullableStorageHostLun) Get() *StorageHostLun {
	return v.value
}

func (v *NullableStorageHostLun) Set(val *StorageHostLun) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageHostLun) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageHostLun) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageHostLun(val *StorageHostLun) *NullableStorageHostLun {
	return &NullableStorageHostLun{value: val, isSet: true}
}

func (v NullableStorageHostLun) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageHostLun) UnmarshalJSON(src []byte) error {
	v.isSet = true
