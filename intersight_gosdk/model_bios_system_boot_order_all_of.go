...
type BiosSystemBootOrderAllOf struct {
	// The BIOS boot mode. UEFI uses the GUID Partition Table (GPT) whereas Legacy mode uses the Master Boot Record (MBR) partitioning scheme.
	BootMode *string `json:"BootMode,omitempty"`
	// The Distinguished Name for this object, used to uniquely identify this object.
	Dn *string `json:"Dn,omitempty"`
	// Secure boot if set to enabled, enforces that device boots using only software that is trusted by the Original Equipment Manufacturer (OEM).
...
func NewBiosSystemBootOrderAllOf() *BiosSystemBootOrderAllOf {
	...
	var secureBoot string = "Disabled"
