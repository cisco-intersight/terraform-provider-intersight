...
func (o VirtualizationVmwareVcenter) MarshalJSON() ([]byte, error) {
	...
	serializedVirtualizationHypervisorManager, errVirtualizationHypervisorManager := json.Marshal(o.VirtualizationHypervisorManager)
	if errVirtualizationHypervisorManager != nil {
		return []byte{}, errVirtualizationHypervisorManager
	}
	errVirtualizationHypervisorManager = json.Unmarshal([]byte(serializedVirtualizationHypervisorManager), &toSerialize)
	if errVirtualizationHypervisorManager != nil {
		return []byte{}, errVirtualizationHypervisorManager
	}
...
// AsVirtualizationVmwareVcenterRelationship wraps this instance of VirtualizationVmwareVcenter in VirtualizationVmwareVcenterRelationship
func (s *VirtualizationVmwareVcenter) AsVirtualizationVmwareVcenterRelationship() VirtualizationVmwareVcenterRelationship {
