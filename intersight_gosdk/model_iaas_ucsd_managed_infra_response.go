...
type IaasUcsdManagedInfraResponse struct {
	IaasUcsdManagedInfraResponseInterface interface{ GetObjectType() string }
}

func (s IaasUcsdManagedInfraResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IaasUcsdManagedInfraResponseInterface)
}

func (s *IaasUcsdManagedInfraResponse) UnmarshalJSON(src []byte) error {
	var err error
