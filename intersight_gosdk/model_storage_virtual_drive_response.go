...
type StorageVirtualDriveResponse struct {
	StorageVirtualDriveResponseInterface interface{ GetObjectType() string }
}

func (s StorageVirtualDriveResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageVirtualDriveResponseInterface)
}

func (s *StorageVirtualDriveResponse) UnmarshalJSON(src []byte) error {
	var err error
