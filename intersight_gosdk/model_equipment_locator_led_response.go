...
type EquipmentLocatorLedResponse struct {
	EquipmentLocatorLedResponseInterface interface{ GetObjectType() string }
}

func (s EquipmentLocatorLedResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.EquipmentLocatorLedResponseInterface)
}

func (s *EquipmentLocatorLedResponse) UnmarshalJSON(src []byte) error {
	var err error
