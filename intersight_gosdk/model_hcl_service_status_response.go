...
type HclServiceStatusResponse struct {
	HclServiceStatusResponseInterface interface{ GetObjectType() string }
}

func (s HclServiceStatusResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HclServiceStatusResponseInterface)
}

func (s *HclServiceStatusResponse) UnmarshalJSON(src []byte) error {
	var err error
