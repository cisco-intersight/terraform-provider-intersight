...
type IamUserGroupRelationship struct {
	IamUserGroupRelationshipInterface interface{}
}

func (s IamUserGroupRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamUserGroupRelationshipInterface)
}

func (s *IamUserGroupRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamUserGroup *IamUserGroup = &IamUserGroup{}
	err = json.Unmarshal(src, unmarshaledIamUserGroup)
	if err == nil {
		s.IamUserGroupRelationshipInterface = unmarshaledIamUserGroup
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamUserGroupRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
