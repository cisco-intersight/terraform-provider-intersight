...
type HyperflexServerModelRelationship struct {
	HyperflexServerModelRelationshipInterface interface{}
}

func (s HyperflexServerModelRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexServerModelRelationshipInterface)
}

func (s *HyperflexServerModelRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexServerModel *HyperflexServerModel = &HyperflexServerModel{}
	err = json.Unmarshal(src, unmarshaledHyperflexServerModel)
	if err == nil {
		s.HyperflexServerModelRelationshipInterface = unmarshaledHyperflexServerModel
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexServerModelRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
