...
type IamEndPointUserPolicyResponse struct {
	IamEndPointUserPolicyResponseInterface interface{ GetObjectType() string }
}

func (s IamEndPointUserPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamEndPointUserPolicyResponseInterface)
}

func (s *IamEndPointUserPolicyResponse) UnmarshalJSON(src []byte) error {
	var err error
