...
func (o StoragePureSnapshotSchedule) MarshalJSON() ([]byte, error) {
	...
	serializedStorageSnapshotSchedule, errStorageSnapshotSchedule := json.Marshal(o.StorageSnapshotSchedule)
	if errStorageSnapshotSchedule != nil {
		return []byte{}, errStorageSnapshotSchedule
	}
	errStorageSnapshotSchedule = json.Unmarshal([]byte(serializedStorageSnapshotSchedule), &toSerialize)
	if errStorageSnapshotSchedule != nil {
		return []byte{}, errStorageSnapshotSchedule
	}
	if o.DailyLimit != nil {
