...
func (o *WorkflowWorkflowMetaAllOf) GetOutputParameters() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *WorkflowWorkflowMetaAllOf) GetOutputParametersOk() (*map[string]interface{}, bool) {
	if o == nil || o.OutputParameters == nil {
		return nil, false
	}
...
func (o *WorkflowWorkflowMetaAllOf) SetOutputParameters(v map[string]interface{}) {
...
func (o *WorkflowWorkflowMetaAllOf) GetTasks() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *WorkflowWorkflowMetaAllOf) GetTasksOk() (*map[string]interface{}, bool) {
	if o == nil || o.Tasks == nil {
		return nil, false
	}
	return o.Tasks, true
...
func (o *WorkflowWorkflowMetaAllOf) SetTasks(v map[string]interface{}) {
	o.Tasks = &v
}
