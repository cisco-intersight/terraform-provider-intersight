...
// StorageHostGroupAllOf Definition of the list of properties defined in 'storage.HostGroup', excluding properties defined in parent classes.
type StorageHostGroupAllOf struct {
...
func (o StorageHostGroupAllOf) MarshalJSON() ([]byte, error) {
...
type NullableStorageHostGroupAllOf struct {
	value *StorageHostGroupAllOf
	isSet bool
}

func (v NullableStorageHostGroupAllOf) Get() *StorageHostGroupAllOf {
	return v.value
}

func (v *NullableStorageHostGroupAllOf) Set(val *StorageHostGroupAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageHostGroupAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageHostGroupAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageHostGroupAllOf(val *StorageHostGroupAllOf) *NullableStorageHostGroupAllOf {
	return &NullableStorageHostGroupAllOf{value: val, isSet: true}
}

func (v NullableStorageHostGroupAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageHostGroupAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
