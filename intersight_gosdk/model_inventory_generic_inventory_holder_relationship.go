...
type InventoryGenericInventoryHolderRelationship struct {
	InventoryGenericInventoryHolderRelationshipInterface interface{}
}

func (s InventoryGenericInventoryHolderRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.InventoryGenericInventoryHolderRelationshipInterface)
}

func (s *InventoryGenericInventoryHolderRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledInventoryGenericInventoryHolder *InventoryGenericInventoryHolder = &InventoryGenericInventoryHolder{}
	err = json.Unmarshal(src, unmarshaledInventoryGenericInventoryHolder)
	if err == nil {
		s.InventoryGenericInventoryHolderRelationshipInterface = unmarshaledInventoryGenericInventoryHolder
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.InventoryGenericInventoryHolderRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
