...
func (dst *HclHyperflexSoftwareCompatibilityInfoResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "hcl.HyperflexSoftwareCompatibilityInfo.List" {
		...
		if err == nil {
			jsonHclHyperflexSoftwareCompatibilityInfoList, _ := json.Marshal(dst.HclHyperflexSoftwareCompatibilityInfoList)
			if string(jsonHclHyperflexSoftwareCompatibilityInfoList) == "{}" { // empty struct
	...
	// try to unmarshal data into HclHyperflexSoftwareCompatibilityInfoList
	err = json.Unmarshal(data, &dst.HclHyperflexSoftwareCompatibilityInfoList)
	if err == nil {
		jsonHclHyperflexSoftwareCompatibilityInfoList, _ := json.Marshal(dst.HclHyperflexSoftwareCompatibilityInfoList)
		if string(jsonHclHyperflexSoftwareCompatibilityInfoList) == "{}" { // empty struct
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(HclHyperflexSoftwareCompatibilityInfoResponse)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(HclHyperflexSoftwareCompatibilityInfoResponse)")
	}
}
