...
type HclHyperflexSoftwareCompatibilityInfoResponse struct {
	HclHyperflexSoftwareCompatibilityInfoResponseInterface interface{ GetObjectType() string }
}

func (s HclHyperflexSoftwareCompatibilityInfoResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HclHyperflexSoftwareCompatibilityInfoResponseInterface)
}

func (s *HclHyperflexSoftwareCompatibilityInfoResponse) UnmarshalJSON(src []byte) error {
	var err error
