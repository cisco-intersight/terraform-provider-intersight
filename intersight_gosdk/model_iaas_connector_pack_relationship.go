...
type IaasConnectorPackRelationship struct {
	IaasConnectorPackRelationshipInterface interface{}
}

func (s IaasConnectorPackRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IaasConnectorPackRelationshipInterface)
}

func (s *IaasConnectorPackRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIaasConnectorPack *IaasConnectorPack = &IaasConnectorPack{}
	err = json.Unmarshal(src, unmarshaledIaasConnectorPack)
	if err == nil {
		s.IaasConnectorPackRelationshipInterface = unmarshaledIaasConnectorPack
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IaasConnectorPackRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
