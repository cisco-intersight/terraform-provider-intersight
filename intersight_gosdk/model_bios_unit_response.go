...
func (dst *BiosUnitResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "bios.Unit.List" {
		// try to unmarshal JSON data into BiosUnitList
		err = json.Unmarshal(data, &dst.BiosUnitList)
		if err == nil {
			return nil // data stored in dst.BiosUnitList, return on the first match
		} else {
			dst.BiosUnitList = nil
			return fmt.Errorf("Failed to unmarshal BiosUnitResponse as BiosUnitList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal BiosUnitResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal BiosUnitResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal BiosUnitResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src BiosUnitResponse) MarshalJSON() ([]byte, error) {
	if src.BiosUnitList != nil {
		return json.Marshal(&src.BiosUnitList)
	}
...
type NullableBiosUnitResponse struct {
	value *BiosUnitResponse
	isSet bool
}

func (v NullableBiosUnitResponse) Get() *BiosUnitResponse {
	return v.value
}

func (v *NullableBiosUnitResponse) Set(val *BiosUnitResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBiosUnitResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBiosUnitResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBiosUnitResponse(val *BiosUnitResponse) *NullableBiosUnitResponse {
	return &NullableBiosUnitResponse{value: val, isSet: true}
}

func (v NullableBiosUnitResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBiosUnitResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
