...
func (o *CondHclStatusJobList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCondHclStatusJobListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varCondHclStatusJobList)
	if err == nil {
