...
type HyperflexAppCatalogRelationship struct {
	HyperflexAppCatalogRelationshipInterface interface{}
}

func (s HyperflexAppCatalogRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexAppCatalogRelationshipInterface)
}

func (s *HyperflexAppCatalogRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexAppCatalog *HyperflexAppCatalog = &HyperflexAppCatalog{}
	err = json.Unmarshal(src, unmarshaledHyperflexAppCatalog)
	if err == nil {
		s.HyperflexAppCatalogRelationshipInterface = unmarshaledHyperflexAppCatalog
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexAppCatalogRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
