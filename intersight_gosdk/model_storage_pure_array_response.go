...
type StoragePureArrayResponse struct {
	StoragePureArrayResponseInterface interface{ GetObjectType() string }
}

func (s StoragePureArrayResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StoragePureArrayResponseInterface)
}

func (s *StoragePureArrayResponse) UnmarshalJSON(src []byte) error {
	var err error
