...
type StoragePhysicalDiskUsageRelationship struct {
	StoragePhysicalDiskUsageRelationshipInterface interface{}
}

func (s StoragePhysicalDiskUsageRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StoragePhysicalDiskUsageRelationshipInterface)
}

func (s *StoragePhysicalDiskUsageRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StoragePhysicalDiskUsageRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStoragePhysicalDiskUsage *StoragePhysicalDiskUsage = &StoragePhysicalDiskUsage{}
	err = json.Unmarshal(src, unmarshaledStoragePhysicalDiskUsage)
	if err == nil {
		s.StoragePhysicalDiskUsageRelationshipInterface = unmarshaledStoragePhysicalDiskUsage
		return nil
	}
