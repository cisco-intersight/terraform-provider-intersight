...
type EtherPhysicalPortRelationship struct {
	EtherPhysicalPortRelationshipInterface interface{}
}

func (s EtherPhysicalPortRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.EtherPhysicalPortRelationshipInterface)
}

func (s *EtherPhysicalPortRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledEtherPhysicalPort *EtherPhysicalPort = &EtherPhysicalPort{}
	err = json.Unmarshal(src, unmarshaledEtherPhysicalPort)
	if err == nil {
		s.EtherPhysicalPortRelationshipInterface = unmarshaledEtherPhysicalPort
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.EtherPhysicalPortRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
