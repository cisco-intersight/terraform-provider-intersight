...
type HyperflexNodeConfigPolicyRelationship struct {
	HyperflexNodeConfigPolicyRelationshipInterface interface{}
}

func (s HyperflexNodeConfigPolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexNodeConfigPolicyRelationshipInterface)
}

func (s *HyperflexNodeConfigPolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexNodeConfigPolicy *HyperflexNodeConfigPolicy = &HyperflexNodeConfigPolicy{}
	err = json.Unmarshal(src, unmarshaledHyperflexNodeConfigPolicy)
	if err == nil {
		s.HyperflexNodeConfigPolicyRelationshipInterface = unmarshaledHyperflexNodeConfigPolicy
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexNodeConfigPolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
