...
type IamRoleRelationship struct {
	IamRoleRelationshipInterface interface{}
}

func (s IamRoleRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamRoleRelationshipInterface)
}

func (s *IamRoleRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamRole *IamRole = &IamRole{}
	err = json.Unmarshal(src, unmarshaledIamRole)
	if err == nil {
		s.IamRoleRelationshipInterface = unmarshaledIamRole
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamRoleRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
