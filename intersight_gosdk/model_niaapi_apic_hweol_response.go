...
type NiaapiApicHweolResponse struct {
	NiaapiApicHweolResponseInterface interface{ GetObjectType() string }
}

func (s NiaapiApicHweolResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.NiaapiApicHweolResponseInterface)
}

func (s *NiaapiApicHweolResponse) UnmarshalJSON(src []byte) error {
	var err error
