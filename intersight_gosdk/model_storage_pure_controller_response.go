...
type StoragePureControllerResponse struct {
	StoragePureControllerResponseInterface interface{ GetObjectType() string }
}

func (s StoragePureControllerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StoragePureControllerResponseInterface)
}

func (s *StoragePureControllerResponse) UnmarshalJSON(src []byte) error {
	var err error
