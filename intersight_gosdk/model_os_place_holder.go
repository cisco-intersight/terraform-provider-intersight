...
func (o *OsPlaceHolder) GetValue() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *OsPlaceHolder) GetValueOk() (*map[string]interface{}, bool) {
	if o == nil || o.Value == nil {
		return nil, false
	}
	return o.Value, true
...
func (o *OsPlaceHolder) SetValue(v map[string]interface{}) {
	o.Value = &v
}
