...
type PciDeviceResponse struct {
	PciDeviceResponseInterface interface{ GetObjectType() string }
}

func (s PciDeviceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.PciDeviceResponseInterface)
}

func (s *PciDeviceResponse) UnmarshalJSON(src []byte) error {
	var err error
