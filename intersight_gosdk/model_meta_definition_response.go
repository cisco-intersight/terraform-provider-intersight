...
type MetaDefinitionResponse struct {
	MetaDefinitionResponseInterface interface{ GetObjectType() string }
}

func (s MetaDefinitionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.MetaDefinitionResponseInterface)
}

func (s *MetaDefinitionResponse) UnmarshalJSON(src []byte) error {
	var err error
