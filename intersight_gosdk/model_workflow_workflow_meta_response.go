...
type WorkflowWorkflowMetaResponse struct {
	WorkflowWorkflowMetaResponseInterface interface{ GetObjectType() string }
}

func (s WorkflowWorkflowMetaResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.WorkflowWorkflowMetaResponseInterface)
}

func (s *WorkflowWorkflowMetaResponse) UnmarshalJSON(src []byte) error {
	var err error
