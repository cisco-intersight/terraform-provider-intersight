...
type IamPrivilegeSetRelationship struct {
	IamPrivilegeSetRelationshipInterface interface{}
}

func (s IamPrivilegeSetRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamPrivilegeSetRelationshipInterface)
}

func (s *IamPrivilegeSetRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamPrivilegeSet *IamPrivilegeSet = &IamPrivilegeSet{}
	err = json.Unmarshal(src, unmarshaledIamPrivilegeSet)
	if err == nil {
		s.IamPrivilegeSetRelationshipInterface = unmarshaledIamPrivilegeSet
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamPrivilegeSetRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
