...
type HyperflexHealthResponse struct {
	HyperflexHealthResponseInterface interface{ GetObjectType() string }
}

func (s HyperflexHealthResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexHealthResponseInterface)
}

func (s *HyperflexHealthResponse) UnmarshalJSON(src []byte) error {
	var err error
