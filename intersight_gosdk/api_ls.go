...
func (r apiGetLsServiceProfileByMoidRequest) Execute() (LsServiceProfile, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "LsApiService.GetLsServiceProfileByMoid")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/ls/ServiceProfiles/{Moid}"
...
func (r apiGetLsServiceProfileListRequest) Execute() (LsServiceProfileResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "LsApiService.GetLsServiceProfileList")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/ls/ServiceProfiles"
...
func (r apiPatchLsServiceProfileRequest) Execute() (LsServiceProfile, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "LsApiService.PatchLsServiceProfile")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiUpdateLsServiceProfileRequest) Execute() (LsServiceProfile, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "LsApiService.UpdateLsServiceProfile")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
