...
type EquipmentIoCardRelationship struct {
	EquipmentIoCardRelationshipInterface interface{}
}

func (s EquipmentIoCardRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.EquipmentIoCardRelationshipInterface)
}

func (s *EquipmentIoCardRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledEquipmentIoCard *EquipmentIoCard = &EquipmentIoCard{}
	err = json.Unmarshal(src, unmarshaledEquipmentIoCard)
	if err == nil {
		s.EquipmentIoCardRelationshipInterface = unmarshaledEquipmentIoCard
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.EquipmentIoCardRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
