...
type IaasLicenseInfoRelationship struct {
	IaasLicenseInfoRelationshipInterface interface{}
}

func (s IaasLicenseInfoRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IaasLicenseInfoRelationshipInterface)
}

func (s *IaasLicenseInfoRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIaasLicenseInfo *IaasLicenseInfo = &IaasLicenseInfo{}
	err = json.Unmarshal(src, unmarshaledIaasLicenseInfo)
	if err == nil {
		s.IaasLicenseInfoRelationshipInterface = unmarshaledIaasLicenseInfo
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IaasLicenseInfoRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
