...
type IamSessionRelationship struct {
	IamSessionRelationshipInterface interface{}
}

func (s IamSessionRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamSessionRelationshipInterface)
}

func (s *IamSessionRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamSession *IamSession = &IamSession{}
	err = json.Unmarshal(src, unmarshaledIamSession)
	if err == nil {
		s.IamSessionRelationshipInterface = unmarshaledIamSession
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamSessionRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
