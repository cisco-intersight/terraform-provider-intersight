...
type VirtualizationVmwareDatastoreRelationship struct {
	VirtualizationVmwareDatastoreRelationshipInterface interface{}
}

func (s VirtualizationVmwareDatastoreRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.VirtualizationVmwareDatastoreRelationshipInterface)
}

func (s *VirtualizationVmwareDatastoreRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.VirtualizationVmwareDatastoreRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledVirtualizationVmwareDatastore *VirtualizationVmwareDatastore = &VirtualizationVmwareDatastore{}
	err = json.Unmarshal(src, unmarshaledVirtualizationVmwareDatastore)
	if err == nil {
		s.VirtualizationVmwareDatastoreRelationshipInterface = unmarshaledVirtualizationVmwareDatastore
		return nil
	}
