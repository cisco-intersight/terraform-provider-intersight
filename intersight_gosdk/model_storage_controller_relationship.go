...
type StorageControllerRelationship struct {
	StorageControllerRelationshipInterface interface{}
}

func (s StorageControllerRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageControllerRelationshipInterface)
}

func (s *StorageControllerRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StorageControllerRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStorageController *StorageController = &StorageController{}
	err = json.Unmarshal(src, unmarshaledStorageController)
	if err == nil {
		s.StorageControllerRelationshipInterface = unmarshaledStorageController
		return nil
	}
