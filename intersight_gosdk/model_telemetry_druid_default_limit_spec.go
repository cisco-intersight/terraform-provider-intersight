...
func (o TelemetryDruidDefaultLimitSpec) MarshalJSON() ([]byte, error) {
	...
	serializedTelemetryDruidBaseLimitSpec, errTelemetryDruidBaseLimitSpec := json.Marshal(o.TelemetryDruidBaseLimitSpec)
	if errTelemetryDruidBaseLimitSpec != nil {
		return []byte{}, errTelemetryDruidBaseLimitSpec
	}
	errTelemetryDruidBaseLimitSpec = json.Unmarshal([]byte(serializedTelemetryDruidBaseLimitSpec), &toSerialize)
	if errTelemetryDruidBaseLimitSpec != nil {
		return []byte{}, errTelemetryDruidBaseLimitSpec
	}
	if true {
