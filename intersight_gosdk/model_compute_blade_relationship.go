...
type ComputeBladeRelationship struct {
	ComputeBladeRelationshipInterface interface{}
}

func (s ComputeBladeRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.ComputeBladeRelationshipInterface)
}

func (s *ComputeBladeRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledComputeBlade *ComputeBlade = &ComputeBlade{}
	err = json.Unmarshal(src, unmarshaledComputeBlade)
	if err == nil {
		s.ComputeBladeRelationshipInterface = unmarshaledComputeBlade
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.ComputeBladeRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
