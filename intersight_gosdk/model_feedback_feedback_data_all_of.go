...
type FeedbackFeedbackDataAllOf struct {
	...
	TraceIds *map[string]interface{} `json:"TraceIds,omitempty"`
...
func (o *FeedbackFeedbackDataAllOf) GetTraceIds() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *FeedbackFeedbackDataAllOf) GetTraceIdsOk() (*map[string]interface{}, bool) {
	if o == nil || o.TraceIds == nil {
		return nil, false
	}
...
// SetTraceIds gets a reference to the given map[string]interface{} and assigns it to the TraceIds field.
func (o *FeedbackFeedbackDataAllOf) SetTraceIds(v map[string]interface{}) {
	o.TraceIds = &v
}
