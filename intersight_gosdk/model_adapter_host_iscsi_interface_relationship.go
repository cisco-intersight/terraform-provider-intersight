...
type AdapterHostIscsiInterfaceRelationship struct {
	AdapterHostIscsiInterfaceRelationshipInterface interface{}
}

func (s AdapterHostIscsiInterfaceRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.AdapterHostIscsiInterfaceRelationshipInterface)
}

func (s *AdapterHostIscsiInterfaceRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledAdapterHostIscsiInterface *AdapterHostIscsiInterface = &AdapterHostIscsiInterface{}
	err = json.Unmarshal(src, unmarshaledAdapterHostIscsiInterface)
	if err == nil {
		s.AdapterHostIscsiInterfaceRelationshipInterface = unmarshaledAdapterHostIscsiInterface
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.AdapterHostIscsiInterfaceRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
