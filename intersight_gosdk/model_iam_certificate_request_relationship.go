...
type IamCertificateRequestRelationship struct {
	IamCertificateRequestRelationshipInterface interface{}
}

func (s IamCertificateRequestRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamCertificateRequestRelationshipInterface)
}

func (s *IamCertificateRequestRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamCertificateRequest *IamCertificateRequest = &IamCertificateRequest{}
	err = json.Unmarshal(src, unmarshaledIamCertificateRequest)
	if err == nil {
		s.IamCertificateRequestRelationshipInterface = unmarshaledIamCertificateRequest
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamCertificateRequestRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
