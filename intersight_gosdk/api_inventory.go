...
type apiGetInventoryUemConnectionByMoidRequest struct {
	ctx        _context.Context
	apiService *InventoryApiService
	moid       string
}
...
/*
GetInventoryUemConnectionByMoid Read a 'inventory.UemConnection' resource.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param moid The unique Moid identifier of a resource instance.
@return apiGetInventoryUemConnectionByMoidRequest
*/
func (a *InventoryApiService) GetInventoryUemConnectionByMoid(ctx _context.Context, moid string) apiGetInventoryUemConnectionByMoidRequest {
	return apiGetInventoryUemConnectionByMoidRequest{
		apiService: a,
		ctx:        ctx,
		moid:       moid,
...
/*
Execute executes the request
 @return InventoryUemConnection
*/
func (r apiGetInventoryUemConnectionByMoidRequest) Execute() (InventoryUemConnection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  InventoryUemConnection
	)

	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "InventoryApiService.GetInventoryUemConnectionByMoid")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/inventory/UemConnections/{Moid}"
	localVarPath = strings.Replace(localVarPath, "{"+"Moid"+"}", _neturl.PathEscape(parameterToString(r.moid, "")), -1)
...
type apiGetInventoryUemConnectionListRequest struct {
	ctx         _context.Context
	apiService  *InventoryApiService
	filter      *string
	orderby     *string
...
func (r apiGetInventoryUemConnectionListRequest) Filter(filter string) apiGetInventoryUemConnectionListRequest {
	r.filter = &filter
	return r
}

func (r apiGetInventoryUemConnectionListRequest) Orderby(orderby string) apiGetInventoryUemConnectionListRequest {
	r.orderby = &orderby
	return r
}

func (r apiGetInventoryUemConnectionListRequest) Top(top int32) apiGetInventoryUemConnectionListRequest {
	r.top = &top
	return r
}

func (r apiGetInventoryUemConnectionListRequest) Skip(skip int32) apiGetInventoryUemConnectionListRequest {
	r.skip = &skip
	return r
}

func (r apiGetInventoryUemConnectionListRequest) Select_(select_ string) apiGetInventoryUemConnectionListRequest {
	r.select_ = &select_
	return r
}

func (r apiGetInventoryUemConnectionListRequest) Expand(expand string) apiGetInventoryUemConnectionListRequest {
	r.expand = &expand
	return r
}

func (r apiGetInventoryUemConnectionListRequest) Apply(apply string) apiGetInventoryUemConnectionListRequest {
	r.apply = &apply
	return r
}

func (r apiGetInventoryUemConnectionListRequest) Count(count bool) apiGetInventoryUemConnectionListRequest {
	r.count = &count
	return r
}

func (r apiGetInventoryUemConnectionListRequest) Inlinecount(inlinecount string) apiGetInventoryUemConnectionListRequest {
	r.inlinecount = &inlinecount
	return r
}

func (r apiGetInventoryUemConnectionListRequest) At(at string) apiGetInventoryUemConnectionListRequest {
	r.at = &at
	return r
}

func (r apiGetInventoryUemConnectionListRequest) Tags(tags string) apiGetInventoryUemConnectionListRequest {
	r.tags = &tags
	return r
}

/*
GetInventoryUemConnectionList Read a 'inventory.UemConnection' resource.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return apiGetInventoryUemConnectionListRequest
*/
func (a *InventoryApiService) GetInventoryUemConnectionList(ctx _context.Context) apiGetInventoryUemConnectionListRequest {
	return apiGetInventoryUemConnectionListRequest{
		apiService: a,
		ctx:        ctx,
	}
...
/*
Execute executes the request
 @return InventoryUemConnectionResponse
*/
func (r apiGetInventoryUemConnectionListRequest) Execute() (InventoryUemConnectionResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  InventoryUemConnectionResponse
	)

	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "InventoryApiService.GetInventoryUemConnectionList")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/inventory/UemConnections"
