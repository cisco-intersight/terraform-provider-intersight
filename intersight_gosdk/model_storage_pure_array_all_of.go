...
type _StoragePureArrayAllOf StoragePureArrayAllOf
...
func (o *StoragePureArrayAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStoragePureArrayAllOf := _StoragePureArrayAllOf{}

	if err = json.Unmarshal(bytes, &varStoragePureArrayAllOf); err == nil {
		*o = StoragePureArrayAllOf(varStoragePureArrayAllOf)
	}
