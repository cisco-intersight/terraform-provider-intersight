...
type ServerProfileRelationship struct {
	ServerProfileRelationshipInterface interface{}
}

func (s ServerProfileRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.ServerProfileRelationshipInterface)
}

func (s *ServerProfileRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.ServerProfileRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledServerProfile *ServerProfile = &ServerProfile{}
	err = json.Unmarshal(src, unmarshaledServerProfile)
	if err == nil {
		s.ServerProfileRelationshipInterface = unmarshaledServerProfile
		return nil
	}
