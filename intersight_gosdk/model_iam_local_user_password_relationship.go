...
type IamLocalUserPasswordRelationship struct {
	IamLocalUserPasswordRelationshipInterface interface{}
}

func (s IamLocalUserPasswordRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamLocalUserPasswordRelationshipInterface)
}

func (s *IamLocalUserPasswordRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamLocalUserPassword *IamLocalUserPassword = &IamLocalUserPassword{}
	err = json.Unmarshal(src, unmarshaledIamLocalUserPassword)
	if err == nil {
		s.IamLocalUserPasswordRelationshipInterface = unmarshaledIamLocalUserPassword
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamLocalUserPasswordRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
