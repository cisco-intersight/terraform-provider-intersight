...
func (o TelemetryDruidDurationGranularity) MarshalJSON() ([]byte, error) {
	...
	serializedTelemetryDruidBaseGranularity, errTelemetryDruidBaseGranularity := json.Marshal(o.TelemetryDruidBaseGranularity)
	if errTelemetryDruidBaseGranularity != nil {
		return []byte{}, errTelemetryDruidBaseGranularity
	}
	errTelemetryDruidBaseGranularity = json.Unmarshal([]byte(serializedTelemetryDruidBaseGranularity), &toSerialize)
	if errTelemetryDruidBaseGranularity != nil {
		return []byte{}, errTelemetryDruidBaseGranularity
	}
	if true {
...
// AsTelemetryDruidGranularity wraps this instance of TelemetryDruidDurationGranularity in TelemetryDruidGranularity
func (s *TelemetryDruidDurationGranularity) AsTelemetryDruidGranularity() TelemetryDruidGranularity {
	return TelemetryDruidGranularity{TelemetryDruidGranularityInterface: s}
}
