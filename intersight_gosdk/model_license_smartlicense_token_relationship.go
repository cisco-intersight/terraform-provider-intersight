...
type LicenseSmartlicenseTokenRelationship struct {
	LicenseSmartlicenseTokenRelationshipInterface interface{}
}

func (s LicenseSmartlicenseTokenRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.LicenseSmartlicenseTokenRelationshipInterface)
}

func (s *LicenseSmartlicenseTokenRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledLicenseSmartlicenseToken *LicenseSmartlicenseToken = &LicenseSmartlicenseToken{}
	err = json.Unmarshal(src, unmarshaledLicenseSmartlicenseToken)
	if err == nil {
		s.LicenseSmartlicenseTokenRelationshipInterface = unmarshaledLicenseSmartlicenseToken
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.LicenseSmartlicenseTokenRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
