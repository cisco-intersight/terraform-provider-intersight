...
// HyperflexAlarmListAllOf struct for HyperflexAlarmListAllOf
type HyperflexAlarmListAllOf struct {
...
type _HyperflexAlarmListAllOf HyperflexAlarmListAllOf
...
func (o HyperflexAlarmListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *HyperflexAlarmListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varHyperflexAlarmListAllOf := _HyperflexAlarmListAllOf{}

	if err = json.Unmarshal(bytes, &varHyperflexAlarmListAllOf); err == nil {
		*o = HyperflexAlarmListAllOf(varHyperflexAlarmListAllOf)
	}
...
type NullableHyperflexAlarmListAllOf struct {
	value *HyperflexAlarmListAllOf
	isSet bool
}

func (v NullableHyperflexAlarmListAllOf) Get() *HyperflexAlarmListAllOf {
	return v.value
}

func (v *NullableHyperflexAlarmListAllOf) Set(val *HyperflexAlarmListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperflexAlarmListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperflexAlarmListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperflexAlarmListAllOf(val *HyperflexAlarmListAllOf) *NullableHyperflexAlarmListAllOf {
	return &NullableHyperflexAlarmListAllOf{value: val, isSet: true}
}

func (v NullableHyperflexAlarmListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperflexAlarmListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
