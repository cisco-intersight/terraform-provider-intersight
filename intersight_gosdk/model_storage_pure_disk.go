...
func (o StoragePureDisk) MarshalJSON() ([]byte, error) {
	...
	serializedStorageArrayDisk, errStorageArrayDisk := json.Marshal(o.StorageArrayDisk)
	if errStorageArrayDisk != nil {
		return []byte{}, errStorageArrayDisk
	}
	errStorageArrayDisk = json.Unmarshal([]byte(serializedStorageArrayDisk), &toSerialize)
	if errStorageArrayDisk != nil {
		return []byte{}, errStorageArrayDisk
	}
