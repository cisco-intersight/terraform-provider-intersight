...
type StorageSasPortResponse struct {
	StorageSasPortResponseInterface interface{ GetObjectType() string }
}

func (s StorageSasPortResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageSasPortResponseInterface)
}

func (s *StorageSasPortResponse) UnmarshalJSON(src []byte) error {
	var err error
