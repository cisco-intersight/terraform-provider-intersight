...
type NiaapiNiaMetadataResponse struct {
	NiaapiNiaMetadataResponseInterface interface{ GetObjectType() string }
}

func (s NiaapiNiaMetadataResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.NiaapiNiaMetadataResponseInterface)
}

func (s *NiaapiNiaMetadataResponse) UnmarshalJSON(src []byte) error {
	var err error
