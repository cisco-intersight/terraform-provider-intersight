...
// FcPhysicalPortListAllOf struct for FcPhysicalPortListAllOf
type FcPhysicalPortListAllOf struct {
...
type _FcPhysicalPortListAllOf FcPhysicalPortListAllOf
...
func (o FcPhysicalPortListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FcPhysicalPortListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFcPhysicalPortListAllOf := _FcPhysicalPortListAllOf{}

	if err = json.Unmarshal(bytes, &varFcPhysicalPortListAllOf); err == nil {
		*o = FcPhysicalPortListAllOf(varFcPhysicalPortListAllOf)
	}
...
type NullableFcPhysicalPortListAllOf struct {
	value *FcPhysicalPortListAllOf
	isSet bool
}

func (v NullableFcPhysicalPortListAllOf) Get() *FcPhysicalPortListAllOf {
	return v.value
}

func (v *NullableFcPhysicalPortListAllOf) Set(val *FcPhysicalPortListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFcPhysicalPortListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFcPhysicalPortListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFcPhysicalPortListAllOf(val *FcPhysicalPortListAllOf) *NullableFcPhysicalPortListAllOf {
	return &NullableFcPhysicalPortListAllOf{value: val, isSet: true}
}

func (v NullableFcPhysicalPortListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFcPhysicalPortListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
