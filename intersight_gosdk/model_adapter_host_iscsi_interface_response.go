...
type AdapterHostIscsiInterfaceResponse struct {
	AdapterHostIscsiInterfaceResponseInterface interface{ GetObjectType() string }
}

func (s AdapterHostIscsiInterfaceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.AdapterHostIscsiInterfaceResponseInterface)
}

func (s *AdapterHostIscsiInterfaceResponse) UnmarshalJSON(src []byte) error {
	var err error
