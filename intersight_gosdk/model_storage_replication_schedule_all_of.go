...
// StorageReplicationScheduleAllOf Definition of the list of properties defined in 'storage.ReplicationSchedule', excluding properties defined in parent classes.
type StorageReplicationScheduleAllOf struct {
...
func NewStorageReplicationScheduleAllOf() *StorageReplicationScheduleAllOf {
	this := StorageReplicationScheduleAllOf{}
	return &this
}
...
func (o StorageReplicationScheduleAllOf) MarshalJSON() ([]byte, error) {
...
type NullableStorageReplicationScheduleAllOf struct {
	value *StorageReplicationScheduleAllOf
	isSet bool
}

func (v NullableStorageReplicationScheduleAllOf) Get() *StorageReplicationScheduleAllOf {
	return v.value
}

func (v *NullableStorageReplicationScheduleAllOf) Set(val *StorageReplicationScheduleAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageReplicationScheduleAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageReplicationScheduleAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageReplicationScheduleAllOf(val *StorageReplicationScheduleAllOf) *NullableStorageReplicationScheduleAllOf {
	return &NullableStorageReplicationScheduleAllOf{value: val, isSet: true}
}

func (v NullableStorageReplicationScheduleAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageReplicationScheduleAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
