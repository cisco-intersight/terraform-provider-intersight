...
func (dst *CapabilityIoCardManufacturingDefResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "capability.IoCardManufacturingDef.List" {
		...
		if err == nil {
			jsonCapabilityIoCardManufacturingDefList, _ := json.Marshal(dst.CapabilityIoCardManufacturingDefList)
			if string(jsonCapabilityIoCardManufacturingDefList) == "{}" { // empty struct
	...
	// try to unmarshal data into CapabilityIoCardManufacturingDefList
	err = json.Unmarshal(data, &dst.CapabilityIoCardManufacturingDefList)
	if err == nil {
		jsonCapabilityIoCardManufacturingDefList, _ := json.Marshal(dst.CapabilityIoCardManufacturingDefList)
		if string(jsonCapabilityIoCardManufacturingDefList) == "{}" { // empty struct
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(CapabilityIoCardManufacturingDefResponse)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(CapabilityIoCardManufacturingDefResponse)")
	}
}
