...
func (dst *ConnectorpackConnectorPackUpgradeResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "connectorpack.ConnectorPackUpgrade.List" {
		// try to unmarshal JSON data into ConnectorpackConnectorPackUpgradeList
		err = json.Unmarshal(data, &dst.ConnectorpackConnectorPackUpgradeList)
		if err == nil {
			return nil // data stored in dst.ConnectorpackConnectorPackUpgradeList, return on the first match
		} else {
			dst.ConnectorpackConnectorPackUpgradeList = nil
			return fmt.Errorf("Failed to unmarshal ConnectorpackConnectorPackUpgradeResponse as ConnectorpackConnectorPackUpgradeList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ConnectorpackConnectorPackUpgradeResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ConnectorpackConnectorPackUpgradeResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ConnectorpackConnectorPackUpgradeResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src ConnectorpackConnectorPackUpgradeResponse) MarshalJSON() ([]byte, error) {
	if src.ConnectorpackConnectorPackUpgradeList != nil {
		return json.Marshal(&src.ConnectorpackConnectorPackUpgradeList)
	}
...
type NullableConnectorpackConnectorPackUpgradeResponse struct {
	value *ConnectorpackConnectorPackUpgradeResponse
	isSet bool
}

func (v NullableConnectorpackConnectorPackUpgradeResponse) Get() *ConnectorpackConnectorPackUpgradeResponse {
	return v.value
}

func (v *NullableConnectorpackConnectorPackUpgradeResponse) Set(val *ConnectorpackConnectorPackUpgradeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectorpackConnectorPackUpgradeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectorpackConnectorPackUpgradeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectorpackConnectorPackUpgradeResponse(val *ConnectorpackConnectorPackUpgradeResponse) *NullableConnectorpackConnectorPackUpgradeResponse {
	return &NullableConnectorpackConnectorPackUpgradeResponse{value: val, isSet: true}
}

func (v NullableConnectorpackConnectorPackUpgradeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectorpackConnectorPackUpgradeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
