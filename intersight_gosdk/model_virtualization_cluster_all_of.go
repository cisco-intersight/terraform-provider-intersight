...
// VirtualizationClusterAllOf Definition of the list of properties defined in 'virtualization.Cluster', excluding properties defined in parent classes.
type VirtualizationClusterAllOf struct {
...
func NewVirtualizationClusterAllOf() *VirtualizationClusterAllOf {
	this := VirtualizationClusterAllOf{}
...
func (o VirtualizationClusterAllOf) MarshalJSON() ([]byte, error) {
...
type NullableVirtualizationClusterAllOf struct {
	value *VirtualizationClusterAllOf
	isSet bool
}

func (v NullableVirtualizationClusterAllOf) Get() *VirtualizationClusterAllOf {
	return v.value
}

func (v *NullableVirtualizationClusterAllOf) Set(val *VirtualizationClusterAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationClusterAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationClusterAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationClusterAllOf(val *VirtualizationClusterAllOf) *NullableVirtualizationClusterAllOf {
	return &NullableVirtualizationClusterAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationClusterAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationClusterAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
