...
type WorkflowBuildTaskMetaResponse struct {
	WorkflowBuildTaskMetaResponseInterface interface{ GetObjectType() string }
}

func (s WorkflowBuildTaskMetaResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.WorkflowBuildTaskMetaResponseInterface)
}

func (s *WorkflowBuildTaskMetaResponse) UnmarshalJSON(src []byte) error {
	var err error
