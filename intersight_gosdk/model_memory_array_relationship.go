...
type MemoryArrayRelationship struct {
	MemoryArrayRelationshipInterface interface{}
}

func (s MemoryArrayRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.MemoryArrayRelationshipInterface)
}

func (s *MemoryArrayRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMemoryArray *MemoryArray = &MemoryArray{}
	err = json.Unmarshal(src, unmarshaledMemoryArray)
	if err == nil {
		s.MemoryArrayRelationshipInterface = unmarshaledMemoryArray
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.MemoryArrayRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
