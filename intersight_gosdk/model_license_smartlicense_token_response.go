...
type LicenseSmartlicenseTokenResponse struct {
	LicenseSmartlicenseTokenResponseInterface interface{ GetObjectType() string }
}

func (s LicenseSmartlicenseTokenResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.LicenseSmartlicenseTokenResponseInterface)
}

func (s *LicenseSmartlicenseTokenResponse) UnmarshalJSON(src []byte) error {
	var err error
