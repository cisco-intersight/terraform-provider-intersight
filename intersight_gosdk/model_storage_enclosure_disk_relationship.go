...
type StorageEnclosureDiskRelationship struct {
	StorageEnclosureDiskRelationshipInterface interface{}
}

func (s StorageEnclosureDiskRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageEnclosureDiskRelationshipInterface)
}

func (s *StorageEnclosureDiskRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StorageEnclosureDiskRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStorageEnclosureDisk *StorageEnclosureDisk = &StorageEnclosureDisk{}
	err = json.Unmarshal(src, unmarshaledStorageEnclosureDisk)
	if err == nil {
		s.StorageEnclosureDiskRelationshipInterface = unmarshaledStorageEnclosureDisk
		return nil
	}
