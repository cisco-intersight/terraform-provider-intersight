...
type IamPrivilegeRelationship struct {
	IamPrivilegeRelationshipInterface interface{}
}

func (s IamPrivilegeRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamPrivilegeRelationshipInterface)
}

func (s *IamPrivilegeRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamPrivilege *IamPrivilege = &IamPrivilege{}
	err = json.Unmarshal(src, unmarshaledIamPrivilege)
	if err == nil {
		s.IamPrivilegeRelationshipInterface = unmarshaledIamPrivilege
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamPrivilegeRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
