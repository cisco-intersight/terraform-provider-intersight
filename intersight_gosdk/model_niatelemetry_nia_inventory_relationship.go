...
type NiatelemetryNiaInventoryRelationship struct {
	NiatelemetryNiaInventoryRelationshipInterface interface{}
}

func (s NiatelemetryNiaInventoryRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.NiatelemetryNiaInventoryRelationshipInterface)
}

func (s *NiatelemetryNiaInventoryRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.NiatelemetryNiaInventoryRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledNiatelemetryNiaInventory *NiatelemetryNiaInventory = &NiatelemetryNiaInventory{}
	err = json.Unmarshal(src, unmarshaledNiatelemetryNiaInventory)
	if err == nil {
		s.NiatelemetryNiaInventoryRelationshipInterface = unmarshaledNiatelemetryNiaInventory
		return nil
	}
