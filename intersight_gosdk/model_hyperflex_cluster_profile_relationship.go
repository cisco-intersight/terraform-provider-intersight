...
type HyperflexClusterProfileRelationship struct {
	HyperflexClusterProfileRelationshipInterface interface{}
}

func (s HyperflexClusterProfileRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexClusterProfileRelationshipInterface)
}

func (s *HyperflexClusterProfileRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexClusterProfile *HyperflexClusterProfile = &HyperflexClusterProfile{}
	err = json.Unmarshal(src, unmarshaledHyperflexClusterProfile)
	if err == nil {
		s.HyperflexClusterProfileRelationshipInterface = unmarshaledHyperflexClusterProfile
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexClusterProfileRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
