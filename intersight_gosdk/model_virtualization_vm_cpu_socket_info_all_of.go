...
// VirtualizationVmCpuSocketInfoAllOf Definition of the list of properties defined in 'virtualization.VmCpuSocketInfo', excluding properties defined in parent classes.
type VirtualizationVmCpuSocketInfoAllOf struct {
...
func NewVirtualizationVmCpuSocketInfoAllOf() *VirtualizationVmCpuSocketInfoAllOf {
	this := VirtualizationVmCpuSocketInfoAllOf{}
	return &this
}
...
func (o VirtualizationVmCpuSocketInfoAllOf) MarshalJSON() ([]byte, error) {
...
type NullableVirtualizationVmCpuSocketInfoAllOf struct {
	value *VirtualizationVmCpuSocketInfoAllOf
	isSet bool
}

func (v NullableVirtualizationVmCpuSocketInfoAllOf) Get() *VirtualizationVmCpuSocketInfoAllOf {
	return v.value
}

func (v *NullableVirtualizationVmCpuSocketInfoAllOf) Set(val *VirtualizationVmCpuSocketInfoAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVmCpuSocketInfoAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVmCpuSocketInfoAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVmCpuSocketInfoAllOf(val *VirtualizationVmCpuSocketInfoAllOf) *NullableVirtualizationVmCpuSocketInfoAllOf {
	return &NullableVirtualizationVmCpuSocketInfoAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationVmCpuSocketInfoAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVmCpuSocketInfoAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
