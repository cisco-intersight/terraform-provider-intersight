...
type SearchSearchItemResponse struct {
	SearchSearchItemResponseInterface interface{ GetObjectType() string }
}

func (s SearchSearchItemResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.SearchSearchItemResponseInterface)
}

func (s *SearchSearchItemResponse) UnmarshalJSON(src []byte) error {
	var err error
