...
// VnicEthAdapterPolicy An Ethernet adapter policy governs the host-side behavior of the adapter, including how the adapter handles traffic. For each VIC Virtual Ethernet Interface you can configure various features like VXLAN, NVGRE, ARFS, Interrupt settings, and TCP Offload settings.
...
// AsVnicEthAdapterPolicyRelationship wraps this instance of VnicEthAdapterPolicy in VnicEthAdapterPolicyRelationship
func (s *VnicEthAdapterPolicy) AsVnicEthAdapterPolicyRelationship() VnicEthAdapterPolicyRelationship {
