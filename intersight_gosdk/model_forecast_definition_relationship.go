...
type ForecastDefinitionRelationship struct {
	ForecastDefinitionRelationshipInterface interface{}
}

func (s ForecastDefinitionRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.ForecastDefinitionRelationshipInterface)
}

func (s *ForecastDefinitionRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledForecastDefinition *ForecastDefinition = &ForecastDefinition{}
	err = json.Unmarshal(src, unmarshaledForecastDefinition)
	if err == nil {
		s.ForecastDefinitionRelationshipInterface = unmarshaledForecastDefinition
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.ForecastDefinitionRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
