...
func (o StoragePureReplicationBlackout) MarshalJSON() ([]byte, error) {
	...
	serializedStorageReplicationBlackout, errStorageReplicationBlackout := json.Marshal(o.StorageReplicationBlackout)
	if errStorageReplicationBlackout != nil {
		return []byte{}, errStorageReplicationBlackout
	}
	errStorageReplicationBlackout = json.Unmarshal([]byte(serializedStorageReplicationBlackout), &toSerialize)
	if errStorageReplicationBlackout != nil {
		return []byte{}, errStorageReplicationBlackout
	}
