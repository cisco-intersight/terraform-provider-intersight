...
type StoragePureVolumeRelationship struct {
	StoragePureVolumeRelationshipInterface interface{}
}

func (s StoragePureVolumeRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StoragePureVolumeRelationshipInterface)
}

func (s *StoragePureVolumeRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StoragePureVolumeRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStoragePureVolume *StoragePureVolume = &StoragePureVolume{}
	err = json.Unmarshal(src, unmarshaledStoragePureVolume)
	if err == nil {
		s.StoragePureVolumeRelationshipInterface = unmarshaledStoragePureVolume
		return nil
	}
