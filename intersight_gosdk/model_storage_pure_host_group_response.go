...
func (dst *StoragePureHostGroupResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StoragePureHostGroupResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StoragePureHostGroupResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StoragePureHostGroupResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'storage.PureHostGroup.List'
	if jsonDict["ObjectType"] == "storage.PureHostGroup.List" {
		// try to unmarshal JSON data into StoragePureHostGroupList
		err = json.Unmarshal(data, &dst.StoragePureHostGroupList)
		if err == nil {
			return nil // data stored in dst.StoragePureHostGroupList, return on the first match
		} else {
			dst.StoragePureHostGroupList = nil
			return fmt.Errorf("Failed to unmarshal StoragePureHostGroupResponse as StoragePureHostGroupList: %s", err.Error())
		}
	}
...
func (src StoragePureHostGroupResponse) MarshalJSON() ([]byte, error) {
	...
	if src.StoragePureHostGroupList != nil {
		return json.Marshal(&src.StoragePureHostGroupList)
	}
...
func (obj *StoragePureHostGroupResponse) GetActualInstance() interface{} {
	...
	if obj.StoragePureHostGroupList != nil {
		return obj.StoragePureHostGroupList
	}
...
type NullableStoragePureHostGroupResponse struct {
	value *StoragePureHostGroupResponse
	isSet bool
}

func (v NullableStoragePureHostGroupResponse) Get() *StoragePureHostGroupResponse {
	return v.value
}

func (v *NullableStoragePureHostGroupResponse) Set(val *StoragePureHostGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePureHostGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePureHostGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePureHostGroupResponse(val *StoragePureHostGroupResponse) *NullableStoragePureHostGroupResponse {
	return &NullableStoragePureHostGroupResponse{value: val, isSet: true}
}

func (v NullableStoragePureHostGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePureHostGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
