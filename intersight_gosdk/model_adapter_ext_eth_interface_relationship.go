...
type AdapterExtEthInterfaceRelationship struct {
	AdapterExtEthInterfaceRelationshipInterface interface{}
}

func (s AdapterExtEthInterfaceRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.AdapterExtEthInterfaceRelationshipInterface)
}

func (s *AdapterExtEthInterfaceRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledAdapterExtEthInterface *AdapterExtEthInterface = &AdapterExtEthInterface{}
	err = json.Unmarshal(src, unmarshaledAdapterExtEthInterface)
	if err == nil {
		s.AdapterExtEthInterfaceRelationshipInterface = unmarshaledAdapterExtEthInterface
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.AdapterExtEthInterfaceRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
