...
type IamAccount struct {
	...
	Var1LicenseReservationOp *LicenseLicenseReservationOpRelationship `json:"_1_LicenseReservationOp,omitempty"`
...
// GetVar1LicenseReservationOp returns the Var1LicenseReservationOp field value if set, zero value otherwise.
func (o *IamAccount) GetVar1LicenseReservationOp() LicenseLicenseReservationOpRelationship {
	if o == nil || o.Var1LicenseReservationOp == nil {
		var ret LicenseLicenseReservationOpRelationship
		return ret
	}
	return *o.Var1LicenseReservationOp
}

// GetVar1LicenseReservationOpOk returns a tuple with the Var1LicenseReservationOp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IamAccount) GetVar1LicenseReservationOpOk() (*LicenseLicenseReservationOpRelationship, bool) {
	if o == nil || o.Var1LicenseReservationOp == nil {
		return nil, false
	}
	return o.Var1LicenseReservationOp, true
}
...
// SetVar1LicenseReservationOp gets a reference to the given LicenseLicenseReservationOpRelationship and assigns it to the Var1LicenseReservationOp field.
func (o *IamAccount) SetVar1LicenseReservationOp(v LicenseLicenseReservationOpRelationship) {
	o.Var1LicenseReservationOp = &v
}
...
func (o IamAccount) MarshalJSON() ([]byte, error) {
	...
	if o.Var1LicenseReservationOp != nil {
		toSerialize["_1_LicenseReservationOp"] = o.Var1LicenseReservationOp
	}
