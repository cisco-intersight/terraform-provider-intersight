...
type IamAccount struct {
	...
	Var3LicenseReservationOp *LicenseLicenseReservationOpRelationship `json:"_3_LicenseReservationOp,omitempty"`
...
// GetVar3LicenseReservationOp returns the Var3LicenseReservationOp field value if set, zero value otherwise.
func (o *IamAccount) GetVar3LicenseReservationOp() LicenseLicenseReservationOpRelationship {
	if o == nil || o.Var3LicenseReservationOp == nil {
		var ret LicenseLicenseReservationOpRelationship
		return ret
	}
	return *o.Var3LicenseReservationOp
}

// GetVar3LicenseReservationOpOk returns a tuple with the Var3LicenseReservationOp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IamAccount) GetVar3LicenseReservationOpOk() (*LicenseLicenseReservationOpRelationship, bool) {
	if o == nil || o.Var3LicenseReservationOp == nil {
		return nil, false
	}
	return o.Var3LicenseReservationOp, true
}
...
// SetVar3LicenseReservationOp gets a reference to the given LicenseLicenseReservationOpRelationship and assigns it to the Var3LicenseReservationOp field.
func (o *IamAccount) SetVar3LicenseReservationOp(v LicenseLicenseReservationOpRelationship) {
	o.Var3LicenseReservationOp = &v
}
...
func (o IamAccount) MarshalJSON() ([]byte, error) {
	...
	if o.Var3LicenseReservationOp != nil {
		toSerialize["_3_LicenseReservationOp"] = o.Var3LicenseReservationOp
	}
...
func (o *IamAccount) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varIamAccount.Var3LicenseReservationOp = varIamAccountWithoutEmbeddedStruct.Var3LicenseReservationOp
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_3_LicenseReservationOp")
