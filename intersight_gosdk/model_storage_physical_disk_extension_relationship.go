...
type StoragePhysicalDiskExtensionRelationship struct {
	StoragePhysicalDiskExtensionRelationshipInterface interface{}
}

func (s StoragePhysicalDiskExtensionRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StoragePhysicalDiskExtensionRelationshipInterface)
}

func (s *StoragePhysicalDiskExtensionRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StoragePhysicalDiskExtensionRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStoragePhysicalDiskExtension *StoragePhysicalDiskExtension = &StoragePhysicalDiskExtension{}
	err = json.Unmarshal(src, unmarshaledStoragePhysicalDiskExtension)
	if err == nil {
		s.StoragePhysicalDiskExtensionRelationshipInterface = unmarshaledStoragePhysicalDiskExtension
		return nil
	}
