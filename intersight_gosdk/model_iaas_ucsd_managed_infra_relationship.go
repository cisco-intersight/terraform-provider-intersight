...
type IaasUcsdManagedInfraRelationship struct {
	IaasUcsdManagedInfraRelationshipInterface interface{}
}

func (s IaasUcsdManagedInfraRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IaasUcsdManagedInfraRelationshipInterface)
}

func (s *IaasUcsdManagedInfraRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIaasUcsdManagedInfra *IaasUcsdManagedInfra = &IaasUcsdManagedInfra{}
	err = json.Unmarshal(src, unmarshaledIaasUcsdManagedInfra)
	if err == nil {
		s.IaasUcsdManagedInfraRelationshipInterface = unmarshaledIaasUcsdManagedInfra
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IaasUcsdManagedInfraRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
