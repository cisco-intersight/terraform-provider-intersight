...
type ForecastInstanceResponse struct {
	ForecastInstanceResponseInterface interface{ GetObjectType() string }
}

func (s ForecastInstanceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.ForecastInstanceResponseInterface)
}

func (s *ForecastInstanceResponse) UnmarshalJSON(src []byte) error {
	var err error
