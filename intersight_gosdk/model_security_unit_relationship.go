...
type SecurityUnitRelationship struct {
	SecurityUnitRelationshipInterface interface{}
}

func (s SecurityUnitRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.SecurityUnitRelationshipInterface)
}

func (s *SecurityUnitRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.SecurityUnitRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledSecurityUnit *SecurityUnit = &SecurityUnit{}
	err = json.Unmarshal(src, unmarshaledSecurityUnit)
	if err == nil {
		s.SecurityUnitRelationshipInterface = unmarshaledSecurityUnit
		return nil
	}
