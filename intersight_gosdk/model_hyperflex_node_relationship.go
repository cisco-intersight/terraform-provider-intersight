...
type HyperflexNodeRelationship struct {
	HyperflexNodeRelationshipInterface interface{}
}

func (s HyperflexNodeRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexNodeRelationshipInterface)
}

func (s *HyperflexNodeRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexNode *HyperflexNode = &HyperflexNode{}
	err = json.Unmarshal(src, unmarshaledHyperflexNode)
	if err == nil {
		s.HyperflexNodeRelationshipInterface = unmarshaledHyperflexNode
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexNodeRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
