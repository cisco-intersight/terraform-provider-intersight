...
type PortGroupResponse struct {
	PortGroupResponseInterface interface{ GetObjectType() string }
}

func (s PortGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.PortGroupResponseInterface)
}

func (s *PortGroupResponse) UnmarshalJSON(src []byte) error {
	var err error
