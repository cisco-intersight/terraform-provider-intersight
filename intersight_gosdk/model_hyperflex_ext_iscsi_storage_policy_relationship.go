...
type HyperflexExtIscsiStoragePolicyRelationship struct {
	HyperflexExtIscsiStoragePolicyRelationshipInterface interface{}
}

func (s HyperflexExtIscsiStoragePolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.HyperflexExtIscsiStoragePolicyRelationshipInterface)
}

func (s *HyperflexExtIscsiStoragePolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledHyperflexExtIscsiStoragePolicy *HyperflexExtIscsiStoragePolicy = &HyperflexExtIscsiStoragePolicy{}
	err = json.Unmarshal(src, unmarshaledHyperflexExtIscsiStoragePolicy)
	if err == nil {
		s.HyperflexExtIscsiStoragePolicyRelationshipInterface = unmarshaledHyperflexExtIscsiStoragePolicy
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.HyperflexExtIscsiStoragePolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
