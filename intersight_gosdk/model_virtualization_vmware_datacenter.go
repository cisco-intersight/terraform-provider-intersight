...
func (o VirtualizationVmwareDatacenter) MarshalJSON() ([]byte, error) {
	...
	serializedVirtualizationDatacenter, errVirtualizationDatacenter := json.Marshal(o.VirtualizationDatacenter)
	if errVirtualizationDatacenter != nil {
		return []byte{}, errVirtualizationDatacenter
	}
	errVirtualizationDatacenter = json.Unmarshal([]byte(serializedVirtualizationDatacenter), &toSerialize)
	if errVirtualizationDatacenter != nil {
		return []byte{}, errVirtualizationDatacenter
	}
...
// AsVirtualizationVmwareDatacenterRelationship wraps this instance of VirtualizationVmwareDatacenter in VirtualizationVmwareDatacenterRelationship
func (s *VirtualizationVmwareDatacenter) AsVirtualizationVmwareDatacenterRelationship() VirtualizationVmwareDatacenterRelationship {
