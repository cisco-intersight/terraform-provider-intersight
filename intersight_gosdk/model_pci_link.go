...
// PciLink PCI Switch Link connected to PCIe Switch.
type PciLink struct {
	EquipmentBase
...
// AsPciLinkRelationship wraps this instance of PciLink in PciLinkRelationship
func (s *PciLink) AsPciLinkRelationship() PciLinkRelationship {
