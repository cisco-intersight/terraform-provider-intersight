...
func (o StoragePureReplicationSchedule) MarshalJSON() ([]byte, error) {
	...
	serializedStorageReplicationSchedule, errStorageReplicationSchedule := json.Marshal(o.StorageReplicationSchedule)
	if errStorageReplicationSchedule != nil {
		return []byte{}, errStorageReplicationSchedule
	}
	errStorageReplicationSchedule = json.Unmarshal([]byte(serializedStorageReplicationSchedule), &toSerialize)
	if errStorageReplicationSchedule != nil {
		return []byte{}, errStorageReplicationSchedule
	}
	if o.DailyLimit != nil {
