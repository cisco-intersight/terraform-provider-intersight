...
type IamCertificateRequestResponse struct {
	IamCertificateRequestResponseInterface interface{ GetObjectType() string }
}

func (s IamCertificateRequestResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamCertificateRequestResponseInterface)
}

func (s *IamCertificateRequestResponse) UnmarshalJSON(src []byte) error {
	var err error
