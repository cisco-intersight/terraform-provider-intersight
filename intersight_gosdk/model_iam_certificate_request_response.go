...
func IamCertificateRequestListAsIamCertificateRequestResponse(v *IamCertificateRequestList) IamCertificateRequestResponse {
	return IamCertificateRequestResponse{IamCertificateRequestList: v}
}
...
func MoAggregateTransformAsIamCertificateRequestResponse(v *MoAggregateTransform) IamCertificateRequestResponse {
	return IamCertificateRequestResponse{MoAggregateTransform: v}
}
...
func MoDocumentCountAsIamCertificateRequestResponse(v *MoDocumentCount) IamCertificateRequestResponse {
	return IamCertificateRequestResponse{MoDocumentCount: v}
}
...
func MoTagSummaryAsIamCertificateRequestResponse(v *MoTagSummary) IamCertificateRequestResponse {
	return IamCertificateRequestResponse{MoTagSummary: v}
}
...
func (dst *IamCertificateRequestResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "iam.CertificateRequest.List" {
		...
		if err == nil {
			jsonIamCertificateRequestList, _ := json.Marshal(dst.IamCertificateRequestList)
			if string(jsonIamCertificateRequestList) == "{}" { // empty struct
	...
	// try to unmarshal data into IamCertificateRequestList
	err = json.Unmarshal(data, &dst.IamCertificateRequestList)
	if err == nil {
		jsonIamCertificateRequestList, _ := json.Marshal(dst.IamCertificateRequestList)
		if string(jsonIamCertificateRequestList) == "{}" { // empty struct
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(IamCertificateRequestResponse)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(IamCertificateRequestResponse)")
	}
}
