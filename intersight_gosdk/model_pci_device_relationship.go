...
type PciDeviceRelationship struct {
	PciDeviceRelationshipInterface interface{}
}

func (s PciDeviceRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.PciDeviceRelationshipInterface)
}

func (s *PciDeviceRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.PciDeviceRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledPciDevice *PciDevice = &PciDevice{}
	err = json.Unmarshal(src, unmarshaledPciDevice)
	if err == nil {
		s.PciDeviceRelationshipInterface = unmarshaledPciDevice
		return nil
	}
