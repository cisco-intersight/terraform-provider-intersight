...
type IamLdapPolicyRelationship struct {
	IamLdapPolicyRelationshipInterface interface{}
}

func (s IamLdapPolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamLdapPolicyRelationshipInterface)
}

func (s *IamLdapPolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamLdapPolicy *IamLdapPolicy = &IamLdapPolicy{}
	err = json.Unmarshal(src, unmarshaledIamLdapPolicy)
	if err == nil {
		s.IamLdapPolicyRelationshipInterface = unmarshaledIamLdapPolicy
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamLdapPolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
