...
type BiosUnitRelationship struct {
	BiosUnitRelationshipInterface interface{}
}

func (s BiosUnitRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.BiosUnitRelationshipInterface)
}

func (s *BiosUnitRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledBiosUnit *BiosUnit = &BiosUnit{}
	err = json.Unmarshal(src, unmarshaledBiosUnit)
	if err == nil {
		s.BiosUnitRelationshipInterface = unmarshaledBiosUnit
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.BiosUnitRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
