...
type MoBaseMoRelationship struct {
	MoBaseMoRelationshipInterface interface{}
}

func (s MoBaseMoRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.MoBaseMoRelationshipInterface)
}

func (s *MoBaseMoRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoBaseMo *MoBaseMo = &MoBaseMo{}
	err = json.Unmarshal(src, unmarshaledMoBaseMo)
	if err == nil {
		s.MoBaseMoRelationshipInterface = unmarshaledMoBaseMo
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.MoBaseMoRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
