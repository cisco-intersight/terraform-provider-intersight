...
type PciCoprocessorCardResponse struct {
	PciCoprocessorCardResponseInterface interface{ GetObjectType() string }
}

func (s PciCoprocessorCardResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.PciCoprocessorCardResponseInterface)
}

func (s *PciCoprocessorCardResponse) UnmarshalJSON(src []byte) error {
	var err error
