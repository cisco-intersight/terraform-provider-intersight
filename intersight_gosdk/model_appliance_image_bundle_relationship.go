...
type ApplianceImageBundleRelationship struct {
	ApplianceImageBundleRelationshipInterface interface{}
}

func (s ApplianceImageBundleRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.ApplianceImageBundleRelationshipInterface)
}

func (s *ApplianceImageBundleRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledApplianceImageBundle *ApplianceImageBundle = &ApplianceImageBundle{}
	err = json.Unmarshal(src, unmarshaledApplianceImageBundle)
	if err == nil {
		s.ApplianceImageBundleRelationshipInterface = unmarshaledApplianceImageBundle
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.ApplianceImageBundleRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
