...
type IamLdapPolicyResponse struct {
	IamLdapPolicyResponseInterface interface{ GetObjectType() string }
}

func (s IamLdapPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamLdapPolicyResponseInterface)
}

func (s *IamLdapPolicyResponse) UnmarshalJSON(src []byte) error {
	var err error
