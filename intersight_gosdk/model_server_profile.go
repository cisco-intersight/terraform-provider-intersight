...
type ServerProfile struct {
	...
	AssignedServer              *ComputeRackUnitRelationship `json:"AssignedServer,omitempty"`
	AssociatedServer            *ComputeRackUnitRelationship `json:"AssociatedServer,omitempty"`
...
// SetAssociatedServer gets a reference to the given ComputeRackUnitRelationship and assigns it to the AssociatedServer field.
func (o *ServerProfile) SetAssociatedServer(v ComputeRackUnitRelationship) {
	o.AssociatedServer = &v
}

// GetConfigChangeDetails returns the ConfigChangeDetails field value if set, zero value otherwise.
...
// AsServerProfileRelationship wraps this instance of ServerProfile in ServerProfileRelationship
func (s *ServerProfile) AsServerProfileRelationship() ServerProfileRelationship {
