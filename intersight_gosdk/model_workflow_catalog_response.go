...
type WorkflowCatalogResponse struct {
	WorkflowCatalogResponseInterface interface{ GetObjectType() string }
}

func (s WorkflowCatalogResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.WorkflowCatalogResponseInterface)
}

func (s *WorkflowCatalogResponse) UnmarshalJSON(src []byte) error {
	var err error
