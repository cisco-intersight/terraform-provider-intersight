...
type ManagementInterfaceResponse struct {
	ManagementInterfaceResponseInterface interface{ GetObjectType() string }
}

func (s ManagementInterfaceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.ManagementInterfaceResponseInterface)
}

func (s *ManagementInterfaceResponse) UnmarshalJSON(src []byte) error {
	var err error
