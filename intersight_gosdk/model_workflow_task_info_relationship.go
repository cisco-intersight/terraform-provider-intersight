...
type WorkflowTaskInfoRelationship struct {
	WorkflowTaskInfoRelationshipInterface interface{}
}

func (s WorkflowTaskInfoRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.WorkflowTaskInfoRelationshipInterface)
}

func (s *WorkflowTaskInfoRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.WorkflowTaskInfoRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledWorkflowTaskInfo *WorkflowTaskInfo = &WorkflowTaskInfo{}
	err = json.Unmarshal(src, unmarshaledWorkflowTaskInfo)
	if err == nil {
		s.WorkflowTaskInfoRelationshipInterface = unmarshaledWorkflowTaskInfo
		return nil
	}
