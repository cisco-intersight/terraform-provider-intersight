...
func (o *BiosUnitList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varBiosUnitListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varBiosUnitList)
	if err == nil {
