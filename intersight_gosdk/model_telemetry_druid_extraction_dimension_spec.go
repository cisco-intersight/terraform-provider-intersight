...
func (o TelemetryDruidExtractionDimensionSpec) MarshalJSON() ([]byte, error) {
	...
	serializedTelemetryDruidBaseDimensionSpec, errTelemetryDruidBaseDimensionSpec := json.Marshal(o.TelemetryDruidBaseDimensionSpec)
	if errTelemetryDruidBaseDimensionSpec != nil {
		return []byte{}, errTelemetryDruidBaseDimensionSpec
	}
	errTelemetryDruidBaseDimensionSpec = json.Unmarshal([]byte(serializedTelemetryDruidBaseDimensionSpec), &toSerialize)
	if errTelemetryDruidBaseDimensionSpec != nil {
		return []byte{}, errTelemetryDruidBaseDimensionSpec
	}
	if true {
...
// AsTelemetryDruidDimensionSpec wraps this instance of TelemetryDruidExtractionDimensionSpec in TelemetryDruidDimensionSpec
func (s *TelemetryDruidExtractionDimensionSpec) AsTelemetryDruidDimensionSpec() TelemetryDruidDimensionSpec {
	return TelemetryDruidDimensionSpec{TelemetryDruidDimensionSpecInterface: s}
}
