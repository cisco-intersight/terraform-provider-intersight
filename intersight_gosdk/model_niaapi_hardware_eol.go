...
func (o *NiaapiHardwareEol) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varNiaapiHardwareEolWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varNiaapiHardwareEol)
	if err == nil {
