...
type IamQualifierRelationship struct {
	IamQualifierRelationshipInterface interface{}
}

func (s IamQualifierRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.IamQualifierRelationshipInterface)
}

func (s *IamQualifierRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledIamQualifier *IamQualifier = &IamQualifier{}
	err = json.Unmarshal(src, unmarshaledIamQualifier)
	if err == nil {
		s.IamQualifierRelationshipInterface = unmarshaledIamQualifier
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.IamQualifierRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
