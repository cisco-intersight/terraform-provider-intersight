...
type VnicLanConnectivityPolicyResponse struct {
	VnicLanConnectivityPolicyResponseInterface interface{ GetObjectType() string }
}

func (s VnicLanConnectivityPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.VnicLanConnectivityPolicyResponseInterface)
}

func (s *VnicLanConnectivityPolicyResponse) UnmarshalJSON(src []byte) error {
	var err error
