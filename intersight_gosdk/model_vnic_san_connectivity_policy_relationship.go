...
type VnicSanConnectivityPolicyRelationship struct {
	VnicSanConnectivityPolicyRelationshipInterface interface{}
}

func (s VnicSanConnectivityPolicyRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.VnicSanConnectivityPolicyRelationshipInterface)
}

func (s *VnicSanConnectivityPolicyRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.VnicSanConnectivityPolicyRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledVnicSanConnectivityPolicy *VnicSanConnectivityPolicy = &VnicSanConnectivityPolicy{}
	err = json.Unmarshal(src, unmarshaledVnicSanConnectivityPolicy)
	if err == nil {
		s.VnicSanConnectivityPolicyRelationshipInterface = unmarshaledVnicSanConnectivityPolicy
		return nil
	}
