...
func (o *VnicArfsSettings) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varVnicArfsSettingsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varVnicArfsSettings)
	if err == nil {
