...
type FirmwareUpgradeStatusRelationship struct {
	FirmwareUpgradeStatusRelationshipInterface interface{}
}

func (s FirmwareUpgradeStatusRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.FirmwareUpgradeStatusRelationshipInterface)
}

func (s *FirmwareUpgradeStatusRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledFirmwareUpgradeStatus *FirmwareUpgradeStatus = &FirmwareUpgradeStatus{}
	err = json.Unmarshal(src, unmarshaledFirmwareUpgradeStatus)
	if err == nil {
		s.FirmwareUpgradeStatusRelationshipInterface = unmarshaledFirmwareUpgradeStatus
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.FirmwareUpgradeStatusRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
