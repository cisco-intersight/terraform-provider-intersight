...
type EquipmentRackEnclosureSlotRelationship struct {
	EquipmentRackEnclosureSlotRelationshipInterface interface{}
}

func (s EquipmentRackEnclosureSlotRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.EquipmentRackEnclosureSlotRelationshipInterface)
}

func (s *EquipmentRackEnclosureSlotRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledEquipmentRackEnclosureSlot *EquipmentRackEnclosureSlot = &EquipmentRackEnclosureSlot{}
	err = json.Unmarshal(src, unmarshaledEquipmentRackEnclosureSlot)
	if err == nil {
		s.EquipmentRackEnclosureSlotRelationshipInterface = unmarshaledEquipmentRackEnclosureSlot
		return nil
	}
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.EquipmentRackEnclosureSlotRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
