...
type WorkflowTaskDefinitionResponse struct {
	WorkflowTaskDefinitionResponseInterface interface{ GetObjectType() string }
}

func (s WorkflowTaskDefinitionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.WorkflowTaskDefinitionResponseInterface)
}

func (s *WorkflowTaskDefinitionResponse) UnmarshalJSON(src []byte) error {
	var err error
