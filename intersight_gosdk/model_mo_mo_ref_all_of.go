...
func NewMoMoRefAllOf(objectType string) *MoMoRefAllOf {
	this := MoMoRefAllOf{}
...
func (o *MoMoRefAllOf) GetObjectType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *MoMoRefAllOf) GetObjectTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MoMoRefAllOf) SetObjectType(v string) {
	o.ObjectType = v
}
