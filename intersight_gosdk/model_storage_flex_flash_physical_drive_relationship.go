...
type StorageFlexFlashPhysicalDriveRelationship struct {
	StorageFlexFlashPhysicalDriveRelationshipInterface interface{}
}

func (s StorageFlexFlashPhysicalDriveRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.StorageFlexFlashPhysicalDriveRelationshipInterface)
}

func (s *StorageFlexFlashPhysicalDriveRelationship) UnmarshalJSON(src []byte) error {
	var err error
	var unmarshaledMoMoRef *MoMoRef = &MoMoRef{}
	err = json.Unmarshal(src, unmarshaledMoMoRef)
	if err == nil {
		s.StorageFlexFlashPhysicalDriveRelationshipInterface = unmarshaledMoMoRef
		return nil
	}
	var unmarshaledStorageFlexFlashPhysicalDrive *StorageFlexFlashPhysicalDrive = &StorageFlexFlashPhysicalDrive{}
	err = json.Unmarshal(src, unmarshaledStorageFlexFlashPhysicalDrive)
	if err == nil {
		s.StorageFlexFlashPhysicalDriveRelationshipInterface = unmarshaledStorageFlexFlashPhysicalDrive
		return nil
	}
